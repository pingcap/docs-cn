...
分片的大小可以通过 `coprocessor.region-split-size` 进行设置。我们推荐的设置值包括 96MiB、128MiB、256MiB、512MiB、1GiB。随着大小越大，性能会越来越容易发生抖动。不推荐将大小设置超过 1GiB，强烈建议不超过 10GiB。如果你使用了 TiFlash，则分片大小不能超过 256MiB。
