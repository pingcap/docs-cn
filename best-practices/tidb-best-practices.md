...
TiDB 提供完整的分布式事务，事务模型是在 [Google Percolator](https://research.google.com/pubs/pub36726.html) 的基础上做了一些优化。具体的实现可以参考[《Percolator 和 TiDB 事务算法》](https://pingkai.cn/tidbcommunity/blog/f537be2c)这篇文章。本文档只讨论以下几点：
