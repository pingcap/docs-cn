...
+ Server
    ...
    - [Support using`admin show slow` statement to obtain the slow queries](/v3.1/how-to/maintain/identify-abnormal-queries/identify-slow-queries.md#admin-show-slow-command)
