...
参考[部署 TiDB Operator](/v3.1/tidb-in-kubernetes/deploy/tidb-operator.md#安装-tidb-operator)中的操作。

## 第 3 步：在 Kubernetes 集群中部署 TiDB 集群

参考[标准 Kubernetes 上的 TiDB 集群](/v3.1/tidb-in-kubernetes/deploy/general-kubernetes.md#部署-tidb-集群)中的操作。

## 访问数据库和监控面板

参考[查看监控面板](/v3.1/tidb-in-kubernetes/monitor/tidb-in-kubernetes.md#查看监控面板)中的操作。
