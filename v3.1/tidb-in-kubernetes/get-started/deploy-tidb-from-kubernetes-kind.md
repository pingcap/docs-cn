...
category: how-to
aliases: ['/docs/v3.1/tidb-in-kubernetes/get-started/deploy-tidb-from-kubernetes-dind/']
---
...
1. Install Helm and add the official PingCAP chart repository to it. Refer to the steps in [Use Helm](/v3.1/tidb-in-kubernetes/reference/tools/in-kubernetes.md#use-helm).

2. Deploy TiDB Operator. Refer to the steps in [Deploy TiDB Operator](/v3.1/tidb-in-kubernetes/deploy/tidb-operator.md#install-tidb-operator)
