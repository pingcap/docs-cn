...
The following table contains all configuration parameters available for the `tidb-drainer` chart.  Refer to [Use Helm](/v3.1/tidb-in-kubernetes/reference/tools/in-kubernetes.md#use-helm) to learn how to configure these parameters.
