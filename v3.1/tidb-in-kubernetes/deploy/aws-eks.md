...
category: how-to
aliases: ['/docs-cn/v3.1/how-to/deploy/tidb-in-kubernetes/aws-eks/','/docs-cn/v3.1/how-to/deploy/orchestrated/aws-eks/']
---
...
- `tidb-operator` 模块，用于创建 EKS 集群并在 EKS 集群上安装配置 [TiDB Operator](/v3.1/tidb-in-kubernetes/deploy/tidb-operator.md)。
