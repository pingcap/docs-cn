...
category: how-to
aliases: ['/docs-cn/v3.1/how-to/deploy/tidb-in-kubernetes/alibaba-cloud/']
---
...
TiDB 集群会使用 `./my-cluster.yaml` 作为集群的 `values.yaml` 配置文件，修改该文件即可配置 TiDB 集群。支持的配置项可参考 [Kubernetes 上的 TiDB 集群配置](/v3.1/tidb-in-kubernetes/reference/configuration/tidb-cluster.md)。
