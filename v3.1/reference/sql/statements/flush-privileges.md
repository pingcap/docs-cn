...
`FLUSH PRIVILEGES` 语句与 MySQL 完全兼容。如有任何兼容性差异，请在 GitHub 上提交 [issue](/v3.1/report-issue.md)。

## 另请参阅

* [GRANT <privileges>](/v3.1/reference/sql/statements/grant-privileges.md)
* [REVOKE](/v3.1/reference/sql/statements/revoke-privileges.md)
* [Privilege Management](/v3.1/reference/security/privilege-system.md)
