...
For the above three situations, you can resume data replication from TiDB Binlog with a [full import of the deleted table](/v3.1/how-to/migrate/overview.md#full-data-migration-from-mysql).
