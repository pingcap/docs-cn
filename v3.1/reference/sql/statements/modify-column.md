...
The `ALTER TABLE.. MODIFY COLUMN` statement modifies a column on an existing table. The modification can include changing the data type and attributes. To rename at the same time, use the [`CHANGE COLUMN`](/v3.1/reference/sql/statements/change-column.md) statement instead.
...
* [CHANGE COLUMN](/v3.1/reference/sql/statements/change-column.md)
