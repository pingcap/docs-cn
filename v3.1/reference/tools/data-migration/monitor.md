...
If your DM cluster is deployed using DM-Ansible, the [monitoring system](/v3.1/reference/tools/data-migration/deploy.md#step-7-monitor-the-task-and-check-logs) is also deployed at the same time. This document describes the monitoring metrics provided by DM-worker.
