...
目前推荐使用 DM-Ansible 部署 DM 集群，具体部署方法参照 [使用 DM-Ansible 部署 DM 集群](/v3.1/how-to/deploy/data-migration-with-ansible.md)；也可以使用 binary 部署 DM 集群用于体验或者测试，具体部署方法参照[使用 DM binary 部署 DM 集群](/v3.1/how-to/deploy/data-migration-with-binary.md)。
...
为了提前发现数据同步任务的一些配置错误，DM 中增加了[前置检查](/v3.1/reference/tools/data-migration/precheck.md)功能：
