...
This document only describes parameters that are not included in command-line parameters. Check [here](/v3.1/reference/configuration/pd-server/configuration.md) for the command line parameters.
