...
通过 [`SET` 语句](/v3.1/reference/sql/statements/set-variable.md) 可以修改系统变量的值。进行修改时，还要考虑变量可修改的范围，不是所有的变量都能在全局/会话范围内进行修改。具体的可修改范围参考 [MySQL 动态变量文档](https://dev.mysql.com/doc/refman/5.7/en/dynamic-system-variables.html)。
...
参见 [TiDB 专用系统变量](/v3.1/reference/configuration/tidb-server/tidb-specific-variables.md)。
