...
| 8004 | 单个事务过大，原因及解决方法请参考[这里](/v3.1/faq/tidb.md#433-transaction-too-large-是什么原因怎么解决) |
| 8005 | 事务在 TiDB 中遇到了写入冲突，原因及解决方法请参考[这里](/v3.1/faq/tidb.md#九故障排除) |
...
| 9007 | 事务在 TiKV 中遇到了写入冲突，原因及解决方法请参考[这里](/v3.1/faq/tidb.md#九故障排除) |

## 故障诊断

参见[故障诊断文档](/v3.1/how-to/troubleshoot/cluster-setup.md)以及 [FAQ](/v3.1/faq/tidb.md)。
