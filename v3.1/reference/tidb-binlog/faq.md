...
category: FAQ
aliases: ['/docs-cn/v3.1/faq/tidb-binlog/','/docs-cn/v3.1/reference/tools/tidb-binlog/faq/']
---
...
2. 使用 [binlogctl 将老的 Drainer 状态 修改成 offline](/v3.1/reference/tidb-binlog/maintain.md)。
