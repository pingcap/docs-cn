...
1. Use [binlogctl to change the state of this Pump instance to `offline`](/v3.1/reference/tidb-binlog/maintain.md) to discard the data of this Pump instance.
...
- If the checkpoint is not lost, perform the following steps:
    ...
    2. Use [binlogctl to change the state of the old Drainer to `offline`](/v3.1/reference/tidb-binlog/maintain.md).
...
Refer to [TiDB Binlog Cluster Operations](/v3.1/reference/tidb-binlog/maintain.md) to learn the description of the Pump or Drainer state and how to start and exit the process.
...
No. For more details on these SQL operations, refer to [Use SQL statements to manage Pump or Drainer](/v3.1/reference/tidb-binlog/maintain.md#use-sql-statements-to-manage-pump-or-drainer).
