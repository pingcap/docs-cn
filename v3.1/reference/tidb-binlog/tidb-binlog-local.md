...
category: reference
aliases: ['/docs-cn/tools/binlog/tidb-binlog-local/','/docs-cn/v3.1/reference/tools/tidb-binlog/tidb-binlog-local/']
---
...
TiDB Binlog 包含在 tidb-enterprise-tools 安装包中，可[在此下载](/v3.1/reference/tools/download.md)。
