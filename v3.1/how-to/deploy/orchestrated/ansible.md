...
- [Modify component configuration](/v3.1/how-to/upgrade/rolling-updates-with-ansible.md#modify-component-configuration)
- [Scale the TiDB cluster](/v3.1/how-to/scale/with-ansible.md)
- [Upgrade the component version](/v3.1/how-to/upgrade/rolling-updates-with-ansible.md#upgrade-the-component-version)
- [Enable the cluster binlog](/v3.1/reference/tools/tidb-binlog/overview.md)
