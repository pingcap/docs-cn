...
- [`ssl-cert`](/v3.1/reference/configuration/tidb-server/configuration-file.md#ssl-cert): specifies the file path of the SSL certificate
- [`ssl-key`](/v3.1/reference/configuration/tidb-server/configuration-file.md#ssl-key): specifies the private key that matches the certificate
- [`ssl-ca`](/v3.1/reference/configuration/tidb-server/configuration-file.md#ssl-ca): (optional) specifies the file path of the trusted CA certificate
