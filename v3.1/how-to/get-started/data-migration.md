...
For additional information about DM, please consult [Data Migration Overview](/v3.1/reference/tools/data-migration/overview.md) in the TiDB documentation.
...
For additional information about DM, please consult [Data Migration Overview](/v3.1/reference/tools/data-migration/overview.md) in the TiDB documentation or join the [TiDB Community Slack](https://pingcap.com/tidbslack/) channel!
