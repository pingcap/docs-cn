...
category: how-to
aliases: ['/docs-cn/v3.1/how-to/get-started/local-cluster/install-from-docker-compose/']
---
...
> **警告：**
>
> 对于生产环境，不要使用 Docker Compose 进行部署，而应[使用 Ansible 部署 TiDB 集群](/v3.1/how-to/deploy/orchestrated/ansible.md)。
...
更多关于 TiSpark 的信息，参见 [TiSpark 的详细文档](/v3.1/how-to/get-started/tispark.md)。
