...
First, use [`mydumper`](/v3.1/reference/tools/mydumper.md) to export data from MySQL:
...
Before the data import, you need to deploy a TiDB cluster (later than v2.0.9). In this tutorial, TiDB v3.0.4 is used. For the deployment method, refer to [TiDB Introduction](/v3.1/overview.md).
...
For detailed features and usage about TiDB Lightning, refer to [TiDB Lightning Overview](/v3.1/reference/tools/tidb-lightning/overview.md).
