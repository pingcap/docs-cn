...
In the above command, `--db` specifies the name of the database to be backed up. For descriptions of other options, see [Back up all the cluster data](/v3.1/how-to/maintain/backup-and-restore/br.md#back-up-all-the-cluster-data).
