...
+ 操作指南
  ...
  + 配置
    ...
    - [Placement Rules](/v3.1/how-to/configure/placement-rules.md)
  + 安全
    + 安全传输层协议 (TLS)
  ...
  + 迁移
    - [迁移工具使用指南](/v3.1/reference/tools/user-guide.md)
    + 从 MySQL 迁移
      - [以 Amazon Aurora MySQL 为例](/v3.1/how-to/migrate/from-mysql-aurora.md)
...
+ 参考手册
  + SQL
    ...
    + 函数与操作符
      ...
      - [Cast 函数和操作符](/v3.1/reference/sql/functions-and-operators/cast-functions-and-operators.md)
  ...
  + 周边工具
    - [工具使用指南](/v3.1/reference/tools/user-guide.md)
    ...
    + Data Migration
      ...
      + 从与 MySQL 兼容的数据库迁移数据
        - [从 MySQL/Amazon Aurora MySQL 迁移数据](/v3.1/how-to/migrate/from-mysql-aurora.md)
    ...
    + TiDB Lightning
      ...
      - [术语表](/v3.1/reference/tools/tidb-lightning/glossary.md)
...
+ TiDB in Kubernetes
  ...
  + 运维
    ...
    - [备份与恢复](/v3.1/tidb-in-kubernetes/maintain/backup-and-restore.md)
