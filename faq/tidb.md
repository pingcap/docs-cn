...
一般来说，开启 `sync-log` 会让性能损耗 30% 左右。关闭 `sync-log` 时的性能表现，请参见 [TiDB Sysbench 性能测试报告](/benchmark/sysbench-v3.md)。
...
- 大家可以直接参考 [TiDB Sysbench 性能测试报告](/benchmark/sysbench-v3.md)。
