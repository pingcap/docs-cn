...
![access 访问页面](/media/dashboard/slow-queries/dashboard-slow-queries-access.png)
...
![修改列表过滤条件](/media/dashboard/slow-queries/dashboard-slow-queries-list1.png)

### 显示更多列信息

页面顶部**选择列** (**Columns**) 选项中可选择显示更多列，可将鼠标移动到列名右侧的 **(i)** 图标处查看列的说明：

![显示更多列信息](/media/dashboard/slow-queries/dashboard-slow-queries-list2.png)

### 修改列表排序依据

列表默认以**结束运行时间** (**Finish Time**) 逆序排序，点击不同的列标题可以修改排序依据或切换排序顺序：

![修改列表排序依据](/media/dashboard/slow-queries/dashboard-slow-queries-list3.png)
...
![查看执行详情](/media/dashboard/slow-queries/dashboard-slow-queries-detail1.png)

点击**展开** (**Expand**) 链接可以展开相应项的完整内容，点击**复制** (**Copy**) 链接可以复制完整内容到剪贴板。

点击标签页标题可切换显示不同分类的 SQL 执行信息：

![显示不同分类执行信息](/media/dashboard/slow-queries/dashboard-slow-queries-detail2.png)
