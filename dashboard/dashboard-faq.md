...
本文汇总了使用 TiDB Dashboard 过程中的常见问题与解决办法。若无法找到对应问题，或者根据指引操作后问题仍然存在，请从 {{{ .company }}} 官方或 TiDB 社区[获取支持](/support.md)。
...
如果执行完上述步骤后依然提示 NgMonitoring 未启动，请从 {{{ .company }}} 官方或 TiDB 社区[获取支持](/support.md)。
