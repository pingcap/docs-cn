...
+ TiDB
    ...
    - 修复 TiDB 记录历史统计信息时，`stats_meta` 表的历史统计信息可能没有被记录的问题 [#49334](https://github.com/pingcap/tidb/issues/49334) @[hi-rustin](https://github.com/hi-rustin)
    - 修复多值索引被误选为 `IndexJoin` 的 Probe 端导致查询结果出错的问题 [#50382](https://github.com/pingcap/tidb/issues/50382) @[AilinKid](https://github.com/AilinKid)
    ...
    - 修复 analyze 统计的 `processed_rows` 可能超过表的总行数的问题 [#50632](https://github.com/pingcap/tidb/issues/50632) @[hawkingrei](https://github.com/hawkingrei)
    <!-- tw:@Oreoxmt (5) -->
...
+ Tools
    ...
    + TiCDC
        <!-- tw:@Oreoxmt (4) -->
        - 修复开启 sync-point 时，sink 模块遇到错误后无法正确重启的问题 [#10091](https://github.com/pingcap/tiflow/issues/10091) @[hicqu](https://github.com/hicqu)
        ...
        - 修复 sync-point 表可能被错误同步的问题 [#10576](https://github.com/pingcap/tiflow/issues/10576) @[asddongmen](https://github.com/asddongmen)
