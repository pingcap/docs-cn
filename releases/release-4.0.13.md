...
+ TiDB
    ...
    - 修复在默认列值时 `NO_ZERO_IN_DATE` SQL 模式无效的问题 [#24185](https://github.com/pingcap/tidb/pull/24185)
    - 修复 BIT 类型列与整型列进行 `UNION` 并集运算时，查询结果出错的问题 [#24026](https://github.com/pingcap/tidb/pull/24026)
    - 修复不正确比较 BINARY 类型与 CHAR 类型时 `TableDual` 计划出错的问题 [#23917](https://github.com/pingcap/tidb/pull/23917)
    ...
    - 修复 `HashJoin` 算子执行未正确处理排序规则的问题 [#23812](https://github.com/pingcap/tidb/pull/23812)
    ...
    ?- 修复 `session.group_concat_max_len` 被设置为 `group_concat` 时执行出错的问题 [#23257](https://github.com/pingcap/tidb/pull/23257)
    ...
    - 修复 `concat` 函数处理排序规则错误的问题 [#24300](https://github.com/pingcap/tidb/pull/24300)
    ...
    - 修复 Grafana 面板中的 Coprocessor Cache 不显示数据的问题 [#22617](https://github.com/pingcap/tidb/pull/22617)
...
+ TiCDC
    ...
    - 修复 TiCDC changefeed 卡住导致 TiKV GC safe point 不推进的问题 [#1756](https://github.com/pingcap/ticdc/pull/1756)
