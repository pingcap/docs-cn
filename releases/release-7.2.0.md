...
* TiFlash 支持 pipeline 执行模型（实验特性） [#6518](https://github.com/pingcap/tiflash/issues/6518) @[SeaRise](https://github.com/SeaRise) **tw@qiancai** <!--1394-->
    ...
    更多信息，请参考[用户文档](/system-variables.md#tidb_enable_tiflash_pipeline_model)。
