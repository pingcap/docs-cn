...
+ TiDB-Binlog
    - Fix the synchronization abortion issue when binlog data for the primary key column of unsigned int type is negative [#573](https://github.com/pingcap/tidb-binlog/pull/573)
    ...
    - Add the `syncer.ignore-table` configuration item to support filtering out tables that do not require synchronization [#520](https://github.com/pingcap/tidb-binlog/pull/520)
