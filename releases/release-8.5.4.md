...
- 将 TiKV 配置项 [`max-manifest-file-size`](https://docs.pingcap.com/zh/tidb/v8.5/tikv-configuration-file#max-manifest-file-size) 的默认值从 `128MiB` 修改为 `256MiB`，以提升磁盘空间的利用率 [#18996](https://github.com/tikv/tikv/issues/18996) @[glorv](https://github.com/glorv)
