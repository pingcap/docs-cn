...
- TiCDC Changefeed 新增以下配置项：
    - [`sql-mode`](https://docs.pingcap.com/zh/tidb/v6.5/ticdc-changefeed-config)：你可以设置 TiCDC 同步数据时解析 DDL 语句所使用的 [SQL 模式](/ticdc/ticdc-ddl.md#sql-模式) [#9876](https://github.com/pingcap/tiflow/issues/9876) @[asddongmen](https://github.com/asddongmen)
