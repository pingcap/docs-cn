...
- TiCDC Changefeed 新增以下配置项：
    ...
    - [`changefeed-error-stuck-duration`](https://docs.pingcap.com/zh/tidb/v6.5/ticdc-changefeed-config)：你可以控制 changefeed 发生内部错误和异常时，允许自动重试的时间 [#9875](https://github.com/pingcap/tiflow/issues/9875) @[asddongmen](https://github.com/asddongmen)
