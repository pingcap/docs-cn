...
+ Tools
    ...
    + Backup & Restore (BR)
        ...
        - 新增支持 [`FLASHBACK CLUSTER TO TSO`](/sql-statements/sql-statement-flashback-cluster.md) 语法 [#48372](https://github.com/pingcap/tidb/issues/48372) @[BornChanger](https://github.com/BornChanger)
