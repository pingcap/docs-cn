...
* 在系统表 [`INFORMATION_SCHEMA.PROCESSLIST`](/information-schema/information-schema-processlist.md) 和 [`INFORMATION_SCHEMA.CLUSTER_PROCESSLIST`](/information-schema-processlist.md#cluster_processlist) 中新增 `SESSION_ALIAS` 字段用于显示当前连接的别名。
