...
+ DDL
    ...
    - 根据[线上负载与 Add Index 相互影响测试](https://pingcap.com/docs-cn/stable/benchmark/add-index-with-load)，调小 Add Index 后台工作线程的默认参数以避免对线上负载造成较大影响 [#11875](https://github.com/pingcap/tidb/pull/11875)
