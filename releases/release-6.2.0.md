...
* TiDB Dashboard 支持可视化执行计划
    ...
    [用户文档](), ([#1224](https://github.com/pingcap/tidb-dashboard/issues/1224), @[time-and-fate](https://github.com/time-and-fate))
...
+ Tools
    ...
    + TiDB Lightning
        ...
        - 增加更多可重试错误，包括 EOF、Read index not ready、Coprocessor 超时等 ([#36674](https://github.com/pingcap/tidb/issues/36674), @[D3Hunter](https://github.com/D3Hunter)), ([#36566](https://github.com/pingcap/tidb/issues/36566), @[D3Hunter](https://github.com/D3Hunter))
...
+ TiKV
    ...
    - (dup) 避免在悲观事务中报出 `Write Conflict` 错误 ([#11612](https://github.com/tikv/tikv/issues/11612), @[sticnarf](https://github.com/sticnarf))
    - (dup) 修复了在悲观事务中使用 Async Commit 导致重复提交记录的问题 ([#12615](https://github.com/tikv/tikv/issues/12615), @[sticnarf](https://github.com/sticnarf))
    ...
    - 修复了 TiKV 持续重连 PD 的问题 ([#12506](https://github.com/tikv/tikv/issues/12506), @[Connor1996](https://github.com/Connor1996)) ([#12827](https://github.com/tikv/tikv/issues/12827), @[Connor1996](https://github.com/Connor1996))
    - (dup) 修复了对空字符串进行类型转换导致 TiKV panic 的问题 ([#12673](https://github.com/tikv/tikv/issues/12673), @[wshwsh12](https://github.com/wshwsh12))
    - (dup) 修复了 `DATETIME` 类型的数据包含小数部分和 `Z` 后缀导致检查报错的问题 ([#12739](https://github.com/tikv/tikv/issues/12739), @[gengliqi](https://github.com/gengliqi))
    ...
    - (dup) 修复同时分裂和销毁一个 peer 时可能导致 panic 的问题 ([#12825](https://github.com/tikv/tikv/issues/12825), @[BusyJay](https://github.com/BusyJay))
    - (dup) 修复在 Region merge 时 source peer 通过 snapshot 追日志时可能导致 panic 的问题 ([#12663](https://github.com/tikv/tikv/issues/12663), @[BusyJay](https://github.com/BusyJay))
    - (dup) 修复 `max_sample_size` 为 `0` 时 ANALYZE 可能导致 panic 的问题 ([#11192](https://github.com/tikv/tikv/issues/11192), @[LykxSassinator](https://github.com/LykxSassinator))
