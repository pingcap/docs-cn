...
<<<<<<< HEAD
aliases: ['/docs-cn/v2.1/releases/release-2.1.2/','/docs-cn/v2.1/releases/2.1.2/']
=======
...
+ TiDB Binlog
    ...
    - TiDB 支持写 [Kafka 版本的 TiDB Binlog](https://github.com/pingcap/docs-cn/blob/master/v2.1/tidb-binlog/tidb-binlog-kafka-deployment.md)
