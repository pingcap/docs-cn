...
- 支持事务中的 DML 语句批量提交事务，通过配置项 `enable-batch-dml` 开启 [#9882](https://github.com/pingcap/tidb/pull/9882)
...
- 新增 `txn-entry-count-limit` 配置项修改最大事务语句条数及新增 `txn-total-size-limit` 配置项修改最大事务大小 [#9952](https://github.com/pingcap/tidb/pull/9952)
