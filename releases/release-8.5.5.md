...
+ TiDB <!--tw@lilin90: the following 15 notes-->
    ...
    - fix missing rebase auto increment not executed if BR restore failed [#60804](https://github.com/pingcap/tidb/issues/60804) @[joechenrh](https://github.com/joechenrh)
    ...
    - fix incorrect check to determing whether to load table info for tables contain foreign key [#60044]([infoschema v2 loads all the tables when starts · Issue #60044 · pingcap/tidb](https://github.com/pingcap/tidb/issues/60044)) @[JQWong7]([JQWong7 - Overview](https://github.com/JQWong7))
- fix incorrect initialization for foreign key related fields when copying table info [#60044]([infoschema v2 loads all the tables when starts · Issue #60044 · pingcap/tidb](https://github.com/pingcap/tidb/issues/60044)) @[JQWong7]([JQWong7 - Overview](https://github.com/JQWong7))
    ...
    - 修复在启用全局排序 (Global Sort) 时执行 `IMPORT INTO`，读取文件导致死循环的问题 [#61177](https://github.com/pingcap/tidb/issues/61177) @[CbcWestwolf](https://github.com/CbcWestwolf)
    - 修复处理 `IMPORT INTO` 时处理生成列出现 panic 的问题 [#64657](https://github.com/pingcap/tidb/issues/64657) @[D3Hunter](https://github.com/D3Hunter)
    - 修复在一个语句中有多个 `AS OF TIMESTAMP` 表达式时可能误报错的问题 [#65090](https://github.com/pingcap/tidb/issues/65090) @[you06](https://github.com/you06)
