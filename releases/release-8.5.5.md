...
+ TiDB <!--tw@lilin90: the following 15 notes-->
    ...
    - fix incorrect check to determing whether to load table info for tables contain foreign key [#60444](https://github.com/pingcap/tidb/issues/60444) @[JQWong7](https://github.com/JQWong7)
