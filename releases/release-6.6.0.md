...
+ TiDB
    ...
    - 修复了 TiDB 构造 key 范围时对 `NULL` 值处理不当，导致读取到预期外数据的行为 [#40158](https://github.com/pingcap/tidb/issues/40158) @[tiancaiamao](https://github.com/tiancaiamao)
    ...
    <!-- transaction 1-->
    - 修复了过期的 region 缓存可能残留导致的内存泄漏和性能下降问题 [#40461](https://github.com/pingcap/tidb/issues/40461) @[sticnarf](https://github.com/sticnarf)
...
+ TiKV
    ...
    - 修复 TiKV 在 CPU 核数小于 1 时无法启动的问题  [#13586] [#13752] [#14017](https://github.com/tikv/tikv/issues/13586) @[andreid-db](https://github.com/andreid-db)
...
+ Tools
    ...
    + TiCDC
        ...
        - 修复 changefeed 在 TiKV、TiCDC 节点扩缩容特殊场景下卡住的问题 [#8197](https://github.com/pingcap/tiflow/issues/8197)
    ...
    + TiDB Data Migration (DM)
        <!-- 4 -->
        - 修复 `binlog-schema delete` 命令执行失败的问题 [#7373](https://github.com/pingcap/tiflow/issues/7373) @[liumengya94]
        - 修复当最后一个 binlog 是被 skip 的 DDL 时，checkpoint 不推进的问题 [#8175](https://github.com/pingcap/tiflow/issues/8175) @[D3Hunter]
