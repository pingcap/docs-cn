...
aliases: ['/zh/tidb/dev/release-8.5.3/','/zh/tidb/v8.5/release-8.5.3','/zh/tidb/v5.4/release-8.5.3','/zh/tidb/v6.1/release-8.5.3','/zh/tidb/v6.5/release-8.5.3','/zh/tidb/v7.1/release-8.5.3','/zh/tidb/v7.5/release-8.5.3','/zh/tidb/v8.1/release-8.5.3']
---
...
- TiKV 配置项 [`raftstore.inspect-kvdb-interval`](https://docs.pingcap.com/zh/tidb/v8.5/tikv-configuration-file#inspect-kvdb-interval-从-v812-版本开始引入) 默认值从 `2s` 修改为 `100ms`，以提升 KVDB 和 RaftDB 分盘部署场景下 KVDB 磁盘 I/O 抖动检测的灵敏度 [#18463](https://github.com/tikv/tikv/issues/18463) @[LykxSassinator](https://github.com/LykxSassinator)
- 新增以下用于[代价模型](/cost-model.md)内部使用的系统变量，**不建议**修改这些变量的值：[`tidb_opt_hash_agg_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_hash_agg_cost_factor-从-v853-版本开始引入)、[`tidb_opt_hash_join_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_hash_join_cost_factor-从-v853-版本开始引入)、[`tidb_opt_index_join_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_index_join_cost_factor-从-v853-版本开始引入)、[`tidb_opt_index_lookup_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_index_lookup_cost_factor-从-v853-版本开始引入)、[`tidb_opt_index_merge_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_index_merge_cost_factor-从-v853-版本开始引入)、[`tidb_opt_index_reader_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_index_reader_cost_factor-从-v853-版本开始引入)、[`tidb_opt_index_scan_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_index_scan_cost_factor-从-v853-版本开始引入)、[`tidb_opt_limit_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_limit_cost_factor-从-v853-版本开始引入)、[`tidb_opt_merge_join_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_merge_join_cost_factor-从-v853-版本开始引入)、[`tidb_opt_sort_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_sort_cost_factor-从-v853-版本开始引入)、[`tidb_opt_stream_agg_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_stream_agg_cost_factor-从-v853-版本开始引入)、[`tidb_opt_table_full_scan_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_table_full_scan_cost_factor-从-v853-版本开始引入)、[`tidb_opt_table_range_scan_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_table_range_scan_cost_factor-从-v853-版本开始引入)、[`tidb_opt_table_reader_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_table_reader_cost_factor-从-v853-版本开始引入)、[`tidb_opt_table_rowid_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_table_rowid_cost_factor-从-v853-版本开始引入)、[`tidb_opt_table_tiflash_scan_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_table_tiflash_scan_cost_factor-从-v853-版本开始引入)、[`tidb_opt_topn_cost_factor`](https://docs.pingcap.com/zh/tidb/v8.5/system-variables/#tidb_opt_topn_cost_factor-从-v853-版本开始引入) [#60357](https://github.com/pingcap/tidb/issues/60357) @[terry1purcell](https://github.com/terry1purcell)
- 重新引入对[遥测](https://docs.pingcap.com/zh/tidb/v8.5/telemetry)功能的支持，但其行为已更改为仅将遥测相关信息输出到日志文件，不再通过网络发送给 {{{ .company }}} [#61766](https://github.com/pingcap/tidb/issues/61766) @[Defined2014](https://github.com/Defined2014)
