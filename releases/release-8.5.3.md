...
- TiKV 配置项 [`raftstore.inspect-kvdb-interval`](https://docs.pingcap.com/zh/tidb/v8.5/tikv-configuration-file#inspect-kvdb-interval-从-v812-版本开始引入) 默认值从 `2s` 修改为 `100ms`，以提升 KvDB 和 RaftDB 分盘部署场景下 KvDB 磁盘 I/O 抖动检测的灵敏度 [#18439](https://github.com/tikv/tikv/issues/18439) @[LykxSassinator](https://github.com/LykxSassinator)
