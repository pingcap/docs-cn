...
+ TiDB  <!--tw@ran-huang--前 12 条，tw@qiancai--后 4 条-->
    ...
    - 修复 Sort 算子在 Spill 过程中可能导致 TiDB 崩溃的问题 [#47538](https://github.com/pingcap/tidb/issues/47538) @[windtalker](https://github.com/windtalker)
    ...
    - 修复 `RENAME TABLE` 操作导致表中出现重复列的问题 [#47064](https://github.com/pingcap/tidb/issues/47064) @[jiyfhust](https://github.com/jiyfhust)
