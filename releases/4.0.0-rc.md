---
title: TiDB 4.0.0-rc Release Notes
category: Releases
---

# TiDB 4.0.0-rc Release Notes

发版日期：2020 年 04 月 08 日

TiDB 版本：4.0.0-rc

TiDB Ansible 版本：4.0.0-rc
...
+ TiDB Ansible
    ...
    - 优化 CPU epollexclusive 检查失败时提示信息，包括：通过升级内核版本解决，且提示支持的最小内核版本 [#1230](https://github.com/pingcap/tidb-ansible/pull/1230)
    - 优化 Dashboard 初始化的方式，修复升级到 4.0 版本失败的问题 [#1237](https://github.com/pingcap/tidb-ansible/pull/1237)
    - 优化 TiFlash 目录创建的方式 [#1239](https://github.com/pingcap/tidb-ansible/pull/1239)
