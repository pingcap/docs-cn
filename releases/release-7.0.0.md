...
| TiFlash | [`mark_cache_size`](/tiflash/tiflash-configuration.md) |  修改  | TiFlash 中 mark cache 的内存上限，默认为 1G |
| TiFlash | [`minmax_index_cache_size`](/tiflash/tiflash-configuration.md) |  修改  | TiFlash 中 minmax index cache 的内存上限，默认为 1G |
