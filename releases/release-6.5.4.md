...
+ TiDB
    ...
    - 修复在使用 binary protocol 连接 TiDB 且大量地执行 `PREPARE` 和 `EXECUTE` 语句的场景下导致内存泄漏、duration 持续升高的问题 [#44612](https://github.com/pingcap/tidb/issues/44612) @[wshwsh12](https://github.com/wshwsh12)
