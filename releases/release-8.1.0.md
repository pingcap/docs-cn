...
| TiKV | [`raft-engine.batch-compression-threshold`](/tikv-configuration-file.md#batch-compression-threshold) | 修改 | 为了降低写 RaftLog 日志的 IOPS 开销并提高压缩率，默认值由 `"8KiB"` 变更为 `"4KiB"`。 |
