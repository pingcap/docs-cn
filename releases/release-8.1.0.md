...
| 变量名  | 修改类型 | 描述 |
|--------|------------------------------|------|
| [`tidb_enable_telemetry`](/system-variables.md#tidb_enable_telemetry-从-v402-版本开始引入-从-v810-版本开始废弃) | 废弃 | 从 TiDB v8.1.0 开始，TiDB 移除了遥测功能，该变量已不再生效。保留该变量用于与之前版本兼容。 |
...
| 配置文件           | 配置项                | 修改类型 | 描述                                 |
|----------------|--------------------|------|------------------------------------|
| TiDB| [`enable-telemetry`](/tidb-configuration-file.md#enable-telemetry-从-v402-版本开始引入-从-v810-版本开始废弃) | 废弃 | 从 v8.1.0 开始，TiDB 移除了遥测功能，该配置项已不再生效。保留该配置项仅用于与之前版本兼容。 |
