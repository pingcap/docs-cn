...
+ Tools
    ...
    + TiCDC <!--tw@hfxsd: 1 note-->
        ...
        - 当下游为 TiDB 且授予 `SUPER` 权限时，TiCDC 支持从下游数据库查询 `ADD INDEX DDL` 的执行状态，以避免某些情况下因重试执行 DDL 超时而导致数据同步失败。[#10682](https://github.com/pingcap/tiflow/issues/10682) @[CharlesCheung96](https://github.com/CharlesCheung96)
...
+ TiDB
    ...
    - 修复查询 `INFORMATION_SCHEMA.CLUSTER_SLOW_QUERY` 表可能导致 TiDB panic 的问题 [#54324](https://github.com/pingcap/tidb/issues/54324) @[tiancaiamao](https://github.com/tiancaiamao) <!--tw@hfxsd: the following 5 notes-->
...
+ Tools
    ...
    + Backup & Restore (BR) <!--tw@Oreoxmt: 3 notes-->
        ...
        - 修复当 PITR 日志备份失败并且停止 PITR 任务后，PD 中与 PITR 相关的 safepoint 未被正确清除的问题 [#17316](https://github.com/tikv/tikv/issues/17316) @[Leavrth](https://github.com/Leavrth)
    ...
    + TiDB Lightning <!--tw@lilin90: 2 notes-->
        ...
        - 修复使用 TiDB Lightning 导入数据时，TiKV 重启报错的问题 [#15912](https://github.com/tikv/tikv/issues/15912) @[lance6716](https://github.com/lance6716)