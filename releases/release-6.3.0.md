...
* 支持下推 [窗口函数](/tiflash/tiflash-supported-pushdown-calculations.md) 到 TiFlash [#5579](https://github.com/pingcap/tiflash/issues/5579) @[SeaRise](https://github.com/SeaRise)
