...
aliases: ['/docs-cn/stable/releases/release-3.0.3/','/docs-cn/v4.0/releases/release-3.0.3/','/docs-cn/stable/releases/3.0.3/']
---
...
+ SQL 优化器
    ...
    - 修复 Index join 的 join key 中使用前缀索引或者使用 unsigned 的索引列等于负数时结果不正确的问 [#11759](https://github.com/pingcap/tidb/pull/11759)
