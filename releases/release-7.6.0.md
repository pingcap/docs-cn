...
+ TiDB
    ...
    - 修复在具有 PADDING SPACE 的列上使用 `LIKE` 运算符进行索引范围扫描时，查询结果可能出错的问题 [#4882](https://github.com/pingcap/tidb/issues/48821) @[time-and-fate](https://github.com/time-and-fate)
...
+ TiFlash
    ...
    - 修复了 `GREATEST` 或 `LEATEST` 函数在包含常量字符串参数时，可能发生的随机无效内存访问问题 [#8604](https://github.com/pingcap/tiflash/issues/8604) @[windtalker](https://github.com/windtalker)
