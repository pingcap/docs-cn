...
+ TiKV
    ...
    - 当 [`storage.flow-control.enable`](/tikv-configuration-file.md#enable) 的值为 `true` 时，[`storage.flow-control.hard-pending-compaction-bytes-limit`](/tikv-configuration-file.md#hard-pending-compaction-bytes-limit) 会覆盖 [`rocksdb.(defaultcf|writecf|lockcf).hard-pending-compaction-bytes-limit`](/tikv-configuration-file.md#hard-pending-compaction-bytes-limit-1) 的配置
