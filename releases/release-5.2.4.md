...
aliases: ['/zh/tidb/dev/release-5.2.4/','/zh/tidb/v5.2/release-5.2.4','/zh/tidb/v5.4/release-5.2.4','/zh/tidb/v6.1/release-5.2.4','/zh/tidb/v6.5/release-5.2.4','/zh/tidb/v7.1/release-5.2.4','/zh/tidb/v7.5/release-5.2.4','/zh/tidb/v8.1/release-5.2.4']
---
...
+ TiKV
    ...
    - 新增 [`raft-log-compact-sync-interval`](https://docs-archive.pingcap.com/zh/tidb/v5.2/tikv-configuration-file#raft-log-compact-sync-interval-从-v524-版本开始引入) 配置项，用于压缩非必要的 Raft 日志的时间间隔，默认值为 `"2s"` [#11404](https://github.com/tikv/tikv/issues/11404)
