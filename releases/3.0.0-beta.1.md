...
TiDB-Ansible version: 3.0.0-beta

## Overview

On March 26, 2019, TiDB 3.0.0 Beta.1 is released. The corresponding TiDB-Ansible version is 3.0.0 Beta. Compared with TiDB 3.0.0 Beta, this release has greatly improved the stability, usability, features, the SQL optimizer, statistics, and the execution engine.
