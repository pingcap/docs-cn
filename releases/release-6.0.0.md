...
+ TiDB
    ...
    - 当通过 `flashback` 或者 `recover` 恢复一张表之后，这张表的放置规则信息将会被清除 [#31668](https://github.com/pingcap/tidb/issues/31668)
    - 添加一个性能概览监控板，在一个监控板中的典型关键路径上显示核心性能指标，并使 TiDB 上的指标分析更加容易 [#31676](https://github.com/pingcap/tidb/issues/31676)
    - 支持 `LOAD DATA LOCAL INFILE` 语句中的 `REPLACE` 关键字 [#24515](https://github.com/pingcap/tidb/issues/24515)
    - 支持 Range 分区表上对 IN 表达式进行分区裁剪 [#26739](https://github.com/pingcap/tidb/issues/26739)
    - 消除 MPP 聚合查询中可能冗余的 Exchange 操作 [#31762](https://github.com/pingcap/tidb/issues/31762)
    - 允许在 TRUNCATE/DROP PARTITION 语句中使用重复的分区名 [#31681](https://github.com/pingcap/tidb/issues/31681)
    - 当没有指定 follower 时读取 information_schema.placement_policies 默认显示 follower 为 2 [#31702](https://github.com/pingcap/tidb/issues/31702)
    - 禁止创建索引时指定列前缀长度为 0 [#31972](https://github.com/pingcap/tidb/issues/31972)
    - ​​禁止分区名以空格结尾 [#31535](https://github.com/pingcap/tidb/issues/31535)
    - 支持新的开关可让悲观锁模式下打开自动事务提交 [#31135](https://github.com/pingcap/tidb/issues/31135)
    - 使重命名表时如果遇到错误返回的错误信息更加合理 [#29893](https://github.com/pingcap/tidb/issues/29893)
    - 支持新的系统变量 sysdate_is_now 打开后 sysdate 函数将会使用 now 函数的结果 [#31872](https://github.com/pingcap/tidb/issues/31872)
    - 支持变量 `tidb_last_ddl_info`，用于获取当前会话中的最后一个 DDL 的信息 [#32402](https://github.com/pingcap/tidb/issues/32402)
    - 给 `admin show ddl jobs` 语句的执行结果添加 `​​CREATE_TIME` 信息 [#23494](https://github.com/pingcap/tidb/issues/23494)
    - 支持新的内置函数 charset [#3931](https://github.com/pingcap/tidb/issues/3931)
    - 自动捕获的黑名单支持使用用户名来进行过滤 [#32558](https://github.com/pingcap/tidb/issues/32558)
    - 根据当前的 time_zone 对 admin show ddl jobs 的时间显示进行调整 [#26642](https://github.com/pingcap/tidb/issues/26642)
    - 支持下推 dayname monthname 函数到 TiFlash [#32594](https://github.com/pingcap/tidb/issues/32594)
    - 支持下推 regexp 函数到 TiFlash [#32637](https://github.com/pingcap/tidb/issues/32637)
    - 支持对 UnionScan 的执行情况进行追踪 [#32631](https://github.com/pingcap/tidb/issues/32631)
    - 执行 SHOW TABLE STATUS 根据当前的 time_zone 对结果进行调节 [#26642](https://github.com/pingcap/tidb/issues/26642)
    - 支持下推 greatest, least 函数到 TiFlash [#32787](https://github.com/pingcap/tidb/issues/32787)
    ...
    - 使 explain 中输出原有的分区名而不做小写转换 [#32719](https://github.com/pingcap/tidb/issues/32719)
    - 支持对 RANGE COLUMNS 分区表在 IN 条件和字符串类型上进行分区裁剪 [#32626](https://github.com/pingcap/tidb/issues/32626)
    - 移除废弃的的系统变量 `tidb_mem_quota_hashjoin`, `tidb_mem_quota_mergejoin`, `tidb_mem_quota_sort`, `tidb_mem_quota_topn`, `tidb_mem_quota_indexlookupreader`, `tidb_mem_quota_indexlookupjoin` [#32286](https://github.com/pingcap/tidb/issues/32286)
    - 当设置系统变量为 NULL 时返回错误提示 [#32850](https://github.com/pingcap/tidb/issues/32850)
    - 移除非 MPP 模式的 broadcast join [#31465](https://github.com/pingcap/tidb/issues/31465)
    - 移除废弃的系统变量 tidb-enable-streaming [#32679](https://github.com/pingcap/tidb/issues/32679)
    - 支持下推 `dayofmonth`，`lastday` 函数到 TiFlash [#33012](https://github.com/pingcap/tidb/issues/33012)
    - 支持下推 `is_true`，`is_false`, `is_true_with_null` 函数到 TiFlash [#33047](https://github.com/pingcap/tidb/issues/33047)
    - 支持在分区表上执行 MPP 计划 [#32347](https://github.com/pingcap/tidb/issues/32347)
    - 支持 instance 级别的系统变量 [#32887](https://github.com/pingcap/tidb/issues/32887)
    ...
    - 支持对 CTE 进行谓词下推 [#28163](https://github.com/pingcap/tidb/issues/28163)
    - 将 `Statement Summary` 和 `Capture Plan Baselines` 的配置设置成只在全局基础上可用 [#30557](https://github.com/pingcap/tidb/issues/30557)

+ TiKV

    - 支持日志归档，让日志格式与 TiDB/PD 统一 [#11651](https://github.com/tikv/tikv/issues/11651)
    - Raft 在心跳时更新租期 [#11579](https://github.com/tikv/tikv/issues/11579)
    ...
    - 在处理读请求时更新 Raftstore 的租期，防止延迟抖动 [#11579](https://github.com/tikv/tikv/issues/11579)
    ...
    - 支持 Bit column 下推 [#30738](https://github.com/pingcap/tidb/issues/30738)
    ...
    - 支持动态调整 scheduler pool 的线程数 [#12067](https://github.com/tikv/tikv/issues/12067)
...
+ Tools
    ...
    + TiDB Data Migration (DM)
        ...
        - support start task with inconsistent upstream table schemas in optimistic shard mode [#3629](https://github.com/pingcap/tiflow/issues/3629)
        - support create a task in `stopped` state [#4484](https://github.com/pingcap/tiflow/issues/4484)
    ...
    + TiDB Lightning
        ...
        - Add more retryable error type [#31376](https://github.com/pingcap/tidb/issues/31376)
...
+ TiDB
    ...
    - 修复了使用 `index lookup join` 方式执行查询时可能导致 `invalid transaction` 错误的 data race [#30468](https://github.com/pingcap/tidb/issues/30468)
    - 修复了当授予大于等于 2 个权限时 `show grants` 返回不正确的结果的问题  [#30855](https://github.com/pingcap/tidb/issues/30855)
    - 删除 noop 变量的验证，如 `rpl_semi_sync_master_wait_point`，以防它是一个空字符串，以解决升级的问题 [#31538](https://github.com/pingcap/tidb/issues/31538)
    ...
    - 修复 greatest 和 least 函数处理 collation 不正确可能导致结果错误的问题 [#31789](https://github.com/pingcap/tidb/issues/31789)
    ...
    - 修复创建 list column 分区表时出现重复值报错的问题 [#31784](https://github.com/pingcap/tidb/issues/31784)
    - 修复 `select for update union select` 语句使用错误快照导致结果可能错误的问题 [#31530](https://github.com/pingcap/tidb/issues/31530)
    - 修复备份恢复后 region 可能不均衡的问题 [#31034](https://github.com/pingcap/tidb/issues/31034)
    - 修复 Coercibility 和 Collation 函数对 JSON 类型推导出错的问题 [#31541](https://github.com/pingcap/tidb/issues/31541)
    - 修复当设置 TiFlash 副本数为 0 时 PD 规则没有被删除的问题 [#32190](https://github.com/pingcap/tidb/issues/32190)
    - 修改数据索引不一致的错误信息帮助更易定位问题 [#26833](https://github.com/pingcap/tidb/issues/26833)
    - 修复了 `alter column set default` 语句在特殊情况下可能会错误地更新列信息 [#31074](https://github.com/pingcap/tidb/issues/31074)
    - 修复一些内置函数处理 JSON 类型时出现类型错误的问题 [#32281](https://github.com/pingcap/tidb/issues/32281)
    - 修复 date_format 对 ‘\n’ 字符处理错误的问题 [#32232](https://github.com/pingcap/tidb/issues/32232)
    ...
    - 修复使用 ChunkRPC 导出数据时可能造成 TiDB OOM 的问题 [#31981](https://github.com/pingcap/tidb/issues/31981)
    - 修复动态模式下访问分区表时 Limit 在子查询中不能生效的问题 [#32516](https://github.com/pingcap/tidb/issues/32516)
    - 修复 `INFORMATION_SCHEMA.COLUMNS` 表中 `bit` 类型默认值格式显示问题 [#32655](https://github.com/pingcap/tidb/issues/32655)
    ...
    - 修复在事务中使用动态模式读取分区表结果有误的问题 [#29851](https://github.com/pingcap/tidb/issues/29851)
    ...
    - 修复用 `select … from pt partition(p)` 显式读取分区并使用 IndexJoin 计划时可能出现结果错误的问题 [#32007](https://github.com/pingcap/tidb/issues/32007)
    - 修复重命名列和修改列类型并发执行时出错的问题 [#31075](https://github.com/pingcap/tidb/issues/31075)
    - 修复错误的 MPP 计划的网络代价公式 [#30103](https://github.com/pingcap/tidb/issues/30103)
    - 修复 `KILL TIDB` 在空闲链接上无法立即生效的问题 [#24031](https://github.com/pingcap/tidb/issues/24031)
    - 修复使用包含过滤条件的 UnionScan 读取生成列时可能出现结果错误的问题 [#33038](https://github.com/pingcap/tidb/issues/33038)
