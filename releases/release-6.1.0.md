...
- TiCDC 支持拆分同步链路内的大事务，从而避免 TiCDC OOM 问题
...
+ Tools
    ...
    + TiCDC
        ...
        - TiCDC 支持在同步链路内对大事务进行拆分，降低了大事务对 TiCDC 复制延迟的影响，从而避免大事务导致的 TiCDC 节点 OOM 问题 [#5280](https://github.com/pingcap/tiflow/issues/5280)
