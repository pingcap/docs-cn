...
aliases: ['/docs-cn/dev/releases/release-2.0.1/','/docs-cn/dev/releases/201/']
summary: TiDB 2.0.1 版本对 MySQL 兼容性和系统稳定性做出了改进。TiDB新增了实时更新`Add Index`进度到DDL任务信息中的功能，添加了Session变量`tidb_auto_analyze_ratio`控制统计信息自动更新阈值的功能。修复了事务提交失败时可能未清理所有残留状态的问题，以及其他Bug和兼容性问题。PD新增了`Scatter Range`调度和learner相关的metrics，修复了多个问题。TiKV修复了多个问题，优化了慢查询的日志，减少了`thread_yield`的调用次数。
---
