...
+ TiDB
    ...
    - 修复 `WEEKEND` 函数在 SQLMODE 为 `ALLOW_INVALID_DATES` 时结果与 MySQL 不兼容的 问题[#16170](https://github.com/pingcap/tidb/pull/16170)
    ...
    - 修复哈希分区表在建表时由于分配内存之前未及时检查分区数量导致当指定非常大的分区数量例如： 9999999999999 时，导致 TiDB OOM 的问题 [#16218](https://github.com/pingcap/tidb/pull/16218)
