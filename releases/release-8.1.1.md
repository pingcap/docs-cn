...
aliases: ['/zh/tidb/dev/release-8.1.1/','/zh/tidb/v8.1/release-8.1.1','/zh/tidb/v5.4/release-8.1.1','/zh/tidb/v6.1/release-8.1.1','/zh/tidb/v6.5/release-8.1.1','/zh/tidb/v7.1/release-8.1.1','/zh/tidb/v7.5/release-8.1.1']
---

# TiDB 8.1.1 Release Notes

发版日期：2024 年 8 月 27 日
...
在 v8.1.1 中，`TiDB-community-toolkit` [二进制软件包](/binary-package.md)移除了 `arbiter`。
