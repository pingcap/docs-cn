...
+ TiDB <!-- **tw:@oreoxmt** 2 -->
    ...
    - 当使用非二进制排序规则并且查询条件中包含 `LIKE` 时，优化器可以产生 IndexRangeScan 以提高执行效率 [#48181](https://github.com/pingcap/tidb/issues/48181) @[time-and-fate](https://github.com/time-and-fate)
...
+ Tools
    ...
    + TiCDC <!-- **tw:@ran-huang** 5 -->
        ...
        - 优化 TiCDC 节点同步到 TiDB 时的内存消耗 [#9935](https://github.com/pingcap/tiflow/issues/9935) @[3AceShowHand](https://github.com/3AceShowHand)
        ...
        - 通过增加并行，优化了 TiCDC 同步到对象存储的性能 [#10098](https://github.com/pingcap/tiflow/issues/10098) @[CharlesCheung96](https://github.com/CharlesCheung96)
