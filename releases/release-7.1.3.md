...
- TiCDC Changefeed 新增以下配置项：
    - [`sql-mode`](https://docs.pingcap.com/zh/tidb/v7.1/ticdc-changefeed-config)：你可以设置 TiCDC 同步数据时解析 DDL 语句所使用的 [SQL 模式](https://docs.pingcap.com/zh/tidb/v7.1/ticdc-ddl#sql-模式) [#9876](https://github.com/pingcap/tiflow/issues/9876) @[asddongmen](https://github.com/asddongmen)
    - [`encoding-worker-num`](https://docs.pingcap.com/zh/tidb/v7.1/ticdc-changefeed-config) 和 [`flush-worker-num`](https://docs.pingcap.com/zh/tidb/v7.1/ticdc-changefeed-config)：你可以根据不同的机器规格，设置 redo 模块不同的并发参数 [#10048](https://github.com/pingcap/tiflow/issues/10048) @[CharlesCheung96](https://github.com/CharlesCheung96)
    - [`compression`](https://docs.pingcap.com/zh/tidb/v7.1/ticdc-changefeed-config)：你可以设置 redo log 文件的压缩行为 [#10176](https://github.com/pingcap/tiflow/issues/10176) @[sdojjy](https://github.com/sdojjy)
    - [`sink.cloud-storage-config`](https://docs.pingcap.com/zh/tidb/v7.1/ticdc-changefeed-config)：你可以设置同步数据到对象存储时自动清理历史数据的功能 [#10109](https://github.com/pingcap/tiflow/issues/10109) @[CharlesCheung96](https://github.com/CharlesCheung96)
