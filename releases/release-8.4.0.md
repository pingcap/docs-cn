...
<tbody>
  ...
  <tr>
    ...
    <td> Runaway Queries 支持更多触发条件，并能够切换资源组</td>
  ...
  <tr>
    ...
    <td> 持久化内存表到 Workload Repository（实验特性）</td>
