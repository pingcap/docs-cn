---
title: TiDB 3.1.0 RC Release Notes
category: Releases
---
...
+ TiDB
    ...
    - 支持 `RECOVER` 语法恢复被 truncate table 的数据 [#15460](https://github.com/pingcap/tidb/pull/15460)
...
+ TiKV
    ...
    - 优化持有锁的时间， 的性能 [#7202](https://github.com/tikv/tikv/pull/7202)
...
+ PD
    ...
    - 修复 Placement Rule 被具有相同 start & end key 的 Placement Rule 覆盖的问题 [#2222](https://github.com/pingcap/pd/pull/2222)
