...
+ Tools
    ...
    + TiCDC
        ...
        - 修复同步数据时由于 `UPDATE` 和 `UPDATE` 语句乱序可能导致 `Duplicate entry` 错误的问题 [#8597](https://github.com/pingcap/tiflow/issues/8597) @[sdojjy](https://github.com/sojjy)
        ...
        (dup: release-6.5.1.md > 错误修复> Tools> TiCDC)- 修复下游为 TiDB 或 MySQL 时，无主键且非空唯一索引所在列指定了 CHARACTER SET 同步时可能会出现数据不一致的问题 [#8420](https://github.com/pingcap/tiflow/issues/8420) @[zhaoxinyu](https://github.com/zhaoxinyu)
