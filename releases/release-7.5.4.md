...
+ TiKV **tw@qiancai 1**
    ...
    - 修复当大量事务在等待某个 key 上的锁且该 key 被频繁更新时，有时可能因死锁检测压力过大而导致 TiKV OOM 的问题 [#17394](https://github.com/tikv/tikv/issues/17394) @[MyonKeminta](https://github.com/MyonKeminta)
+ PD **tw@lilin90 3**
