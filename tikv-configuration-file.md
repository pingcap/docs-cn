---
title: TiKV 配置文件描述
aliases: ['/docs-cn/v3.1/tikv-configuration-file/','/docs-cn/v3.1/reference/configuration/tikv-server/configuration-file/']
---
...
>>>>>>> adcb4b39... Refine sections in tikv-configuration-file.md (#5234)
