...
| 参数名                | 说明                                                            |
|:-------------------|:--------------------------------------------------------------|
| `output_out_value` | `BOOLEAN` 类型，是否输出行数据更改前的值。默认值为 `true`。关闭后，Update 事件不会输出 "p" 字段的数据。 |

`sink.debezium` 参数说明如下：

| 参数名                | 说明                                                                 |
|:-------------------|:-------------------------------------------------------------------|
| `output_out_value` | `BOOLEAN` 类型，是否输出行数据更改前的值。默认值为 `true`。关闭后，Update 事件不会输出 "before" 字段的数据。 |
