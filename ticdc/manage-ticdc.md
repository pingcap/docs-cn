...
本部分介绍如何使用 TiUP 来升级 TiCDC 集群。在以下例子中，假设需要将 TiCDC 组件和整个 TiDB 集群升级到 v5.3.2。
...
> **警告：**
>
> 在 v5.3.0 和 v5.4.0 版本，灾难场景的最终一致性复制功能存在[critical bug #6189](https://github.com/pingcap/tiflow/issues/6189)，不推荐使用。该 bug 已在 v6.1.1 及以上版本修复，建议使用 v6.1.1 及以上版本。
