...
- 注意：后续版本中该配置项将会被废弃并强制设置成 `true`，建议保持该配置项为默认值以避免下游分区表可能丢数据的问题 [#11979](https://github.com/pingcap/tiflow/issues/11979)。使用示例详见[数据变更记录](/ticdc/ticdc-sink-to-cloud-storage.md#数据变更记录)。
