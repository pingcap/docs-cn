...
# 文件路径的日期分隔类型。可选类型有 `none`、`year`、`month` 和 `day`。在 v6.5.0 和 v6.5.1 中，默认值为 `none`，即不使用日期分隔；在从 v6.5.2 起的 v6.5.x 版本中，默认值为 `day`，即按天分隔。详见 <https://docs.pingcap.com/zh/tidb/v6.5/ticdc-sink-to-cloud-storage#数据变更记录>。
