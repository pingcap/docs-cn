...
category: how-to
<<<<<<< HEAD
aliases: ['/docs-cn/v3.0/tidb-in-kubernetes/maintain/backup-and-store/']
=======
aliases: ['/docs-cn/dev/tidb-in-kubernetes/maintain/backup-and-restore/']
>>>>>>> 8bbc321... tidb-in-kubernetes: fix an alias (#2433)
---

# 基于 Helm Charts 实现的 TiDB 集群备份与恢复

本文详细描述了如何对 Kubernetes 上的 TiDB 集群进行数据备份和数据恢复。本文使用的备份和恢复方式是基于 Helm Charts 实现的。
