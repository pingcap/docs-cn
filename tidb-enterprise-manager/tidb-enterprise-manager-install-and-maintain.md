...
## 指定 TiDB Enterprise Manager 中控机登录 TiDB 资源机的帐户和密钥
...
## 升级 TiDB Enterprise Manager v1.0.0 至 v1.0.1
...
1. 备份 TiDB Enterprise Manager 元信息。
    ...
    # 将当前 TiDB Enterprise Manager 系统 <cluster-name> 的元数据备份到中控机的 <target-path>
