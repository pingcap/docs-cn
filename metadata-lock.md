...
在 v6.5.0 及之后的版本中，TiDB 默认开启元数据锁特性。当集群从旧版本升级到 v6.5.0 及之后的版本后，会自动打开元数据锁功能。如果需要关闭元数据锁，可以使用系统变量 [`tidb_enable_metadata_lock`](/system-variables.md#tidb_enable_metadata_lock-从-v630-版本开始引入) 关闭元数据锁特性。
