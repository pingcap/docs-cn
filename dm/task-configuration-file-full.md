...
strict-optimistic-shard-mode: false # 仅在乐观协调模式下生效，限制乐观协调模式的行为，默认值为 false。在 v7.2.0 中引入，详见 https://docs-archive.pingcap.com/tidb/v7.2/feature-shard-merge-optimistic/
