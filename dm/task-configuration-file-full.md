...
<<<<<<< HEAD
    # 可选配置：提取各分库分表的源信息，并写入下游用户自建的列，用于标识合表中各行数据的来源。如果配置该项，需要提前在下游手动创建合表，具体可参考 “table routing 文档” <https://docs.pingcap.com/zh/tidb/v7.1/dm-key-features#table-routing>。
=======
...
>>>>>>> 0c3dcbf786 (Fix an outdated DM table routing link (#18056))
