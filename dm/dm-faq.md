...
为了便于排查问题，用户收集到下游 TiDB 相关 general log 后可以在 [TiDB Community slack channel](https://slack.tidb.io/invite?team=tidb-community&channel=everyone&ref=docs)联系专家进行排查。收集 general log 的方式如下：
