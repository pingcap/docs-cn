...
---
title: TiDB 最佳实践
aliases: ['/docs-cn/stable/tidb-best-practices/','/docs-cn/v4.0/tidb-best-practices/']
---
...
看业务的查询需求以及具体的语句，可以参考[系统变量和语法](/system-variables.md)这篇文档。可以通过 SET 语句控制 SQL 执行的并发度，另外通过 Hint 控制 Join 物理算子选择。
