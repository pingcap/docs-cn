...
aliases: ['/docs-cn/stable/offline-deployment-using-ansible/','/docs-cn/v4.0/offline-deployment-using-ansible/','/docs-cn/stable/how-to/deploy/orchestrated/offline-ansible/','/zh/tidb/dev/offline-deployment-using-ansible/','/docs-cn/dev/offline-deployment-using-ansible/','/docs-cn/dev/how-to/deploy/orchestrated/offline-ansible/']
---
