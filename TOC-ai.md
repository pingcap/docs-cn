...
- 向量搜索 [!BETA](/media/tidb-cloud/blank_transparent_placeholder.png)
  ...
  - 文本搜索
    - [使用 SQL 进行全文搜索](/ai/vector-search-full-text-search-sql.md)
    - [使用 Python 进行全文搜索](/ai/vector-search-full-text-search-python.md)
    - [混合搜索](/ai/vector-search-hybrid-search.md)
  - 参考指南
    - [向量数据类型](/ai/vector-search-data-types.md)
    - [向量函数和操作符](/ai/vector-search-functions-and-operators.md)
    - [向量索引](/ai/vector-search-index.md)
  - [优化搜索性能](/ai/vector-search-improve-performance.md)
  - [使用限制](/ai/vector-search-limitations.md)
