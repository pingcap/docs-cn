...
这里存放的是 [TiDB 中文文档](https://docs.pingcap.com/zh/tidb/stable)的源文件。[TiDB 英文文档](https://docs.pingcap.com/tidb/stable)的源文件则存放于 [pingcap/docs](https://github.com/pingcap/docs)。
