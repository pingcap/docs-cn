...
TiDB 是一个可以无限水平扩展和高可用的 NewSQL 数据库，本文档用于帮助技术人员（特别是运维人员）理解 TiDB 的水平扩展和高可用特性。
...
## 部署 & 运维
 ...
 - [Binary 部署（推荐）](op-guide/binary-deployment.md)
 - [Docker 部署](op-guide/docker-deployment.md)
