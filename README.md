...
这里存放的是 [PingCAP 官网 TiDB 中文文档](https://docs.pingcap.com/zh/tidb/dev)的源文件。[官网英文文档](https://docs.pingcap.com/tidb/dev)的源文件则存放于 [pingcap/docs](https://github.com/pingcap/docs)。
