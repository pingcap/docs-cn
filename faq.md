...
当 TiKV `--store` 路径更改或数据文件夹移动后，用之前参数重新启动时就会报这个错误。请尝试用 pdctl 的 [store 删除](https://github.com/pingcap/pd/tree/master/pdctl#store-delete-)功能，删除之前的 store 后重新启动 TiKV 即可。
