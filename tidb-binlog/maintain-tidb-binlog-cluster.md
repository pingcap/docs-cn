...
aliases: ['/docs-cn/stable/tidb-binlog/maintain-tidb-binlog-cluster/','/docs-cn/v4.0/tidb-binlog/maintain-tidb-binlog-cluster/','/docs-cn/stable/reference/tidb-binlog/maintain/']
---
...
- 查看 TiDB 是否开启 binlog, 0 代表 OFF，1 代表 ON 
