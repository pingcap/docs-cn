...
> **注意：**
>
> - TiDB Binlog 与 TiDB v5.0 版本开始引入的一些特性不兼容，无法一起使用，详情参照[注意事项](#注意事项)。
> - 从 TiDB v7.5.0 版本开始，TiDB Binlog 组件的数据同步功能将不再获得技术支持，建议使用 [TiCDC](/ticdc/ticdc-overview.md) 作为数据同步的替代方案。
> - 尽管在 TiDB v7.5.0 版本中仍为 TiDB Binlog 组件的实时备份和恢复提供技术支持，但该组件将在未来版本中完全废弃，建议尽早使用 [PITR](/br/br-pitr-guide.md) 作为数据恢复的替代方案。
