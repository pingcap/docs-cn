...
查看数据格式的具体定义，参见 [`secondary_binlog.proto`](https://github.com/pingcap/tidb/blob/release-7.2/tidb-binlog/proto/proto/secondary_binlog.proto)。
...
Driver 项目地址：[Binlog Slave Driver](https://github.com/pingcap/tidb/tree/release-7.2/tidb-binlog/driver)。
