...
<<<<<<< HEAD
查看数据格式的具体定义，参见 [binlog.proto](https://github.com/pingcap/tidb-tools/blob/release-5.0/tidb-binlog/proto/proto/binlog.proto)。
=======
...
Driver 项目地址：[Binlog Slave Driver](https://github.com/pingcap/tidb-tools/tree/release-5.0/tidb-binlog/driver)。
