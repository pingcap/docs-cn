...
1. 使用 [binlogctl 将该 Pump 状态修改为 `offline`](/reference/tidb-binlog/maintain.md)（丢失这个 Pump 的数据）
...
2. 使用 [binlogctl 将老的 Drainer 状态修改成 `offline`](/reference/tidb-binlog/maintain.md)。
