...
- Determines whether to clone a specific version of a package
    ...
    - Execute the `tiup mirror clone <target-dir> --tidb v5.4.0` command to clone the v5.4.0 version of the TiDB component.
    - Run the `tiup mirror clone <target-dir> --tidb v5.4.0 --tikv all` command to clone the v5.4.0 version of the TiDB component and all versions of the TiKV component.
    - Run the `tiup mirror clone <target-dir> v5.4.0` command to clone the v5.4.0 version of all components in a cluster.
