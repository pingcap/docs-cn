...
4. 限定只克隆组件的特定版本
    ...
    - 只想克隆 TiDB 的 v8.3.0 版本，则执行 `tiup mirror clone <target-dir> --tidb v8.3.0`
    - 只想克隆 TiDB 的 v8.3.0 版本，以及 TiKV 的所有版本，则执行 `tiup mirror clone <target-dir> --tidb v8.3.0 --tikv all`
    - 克隆一个集群的所有组件的 v8.3.0 版本，则执行 `tiup mirror clone <target-dir> v8.3.0`
