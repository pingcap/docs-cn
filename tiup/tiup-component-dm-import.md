...
> **注意：**
>
> - 不支持导入 1.0 集群中的 DM Portal 组件
> - 导入前请先停止原集群
> - 对于需要升级到 2.0 的数据迁移任务，请不要执行 `stop-task`
> - 仅支持导入到 v2.0.0-rc.2 或更高版本
> - `import` 命令用于将 DM 1.0 集群导入到全新的 2.0 集群。如果需要将数据迁移任务导入到已有的 2.0 集群，请参考 [TiDB Data Migration 1.0.x 到 2.0.x 手动升级](https://docs.pingcap.com/zh/tidb-data-migration/stable/manually-upgrade-dm-1.0-to-2.0)
