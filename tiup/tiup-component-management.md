...
Example 3: Use TiUP to install TiKV v7.0.0.

{{< copyable "shell-regular" >}}

```shell
tiup install tikv:v7.0.0
```
...
Example 1: Uninstall TiDB v7.0.0.

{{< copyable "shell-regular" >}}

```shell
tiup uninstall tidb:v7.0.0
```
