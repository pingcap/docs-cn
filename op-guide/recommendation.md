...
| :-- | :-: | :-: | :-: | :-: | :-: |
| TiDB| 8核+ | 32 GB+| SAS, 200 GB+ |千兆网卡 | 1|
| PD | 4核+| 8 GB+| SAS, 200 GB+| 千兆网卡|- |
...
| 组件 | CPU | 内存 | 硬盘类型 | 单块硬盘大小 | 网络 | 实例数量(最低要求) |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| TiDB | 16核+ |  64 GB+  | SAS | 500 GB+ | 2块+ 万兆网卡| 2|
| PD | 8核+ | 16 GB+ | SSD | 200 GB+| 2块+ 万兆网卡| 3|
| TiKV|  32核+  |  128 GB+  | SSD | 200~800 GB | 2块+ 万兆网卡| 3|
| 监控 | 16核+ | 32 GB+ | SAS | 200 GB+| 2块+ 千兆网卡| 1|
||||||服务器总计|9|
