...
在大量数据的场景下，可能会出现 Region 数量过多，从而带来更多的资源开销和导致[性能回退](/best-practices/massive-regions-best-practices.md#性能问题)的问题。Region 默认的大小约为 96 MiB，将其调大可以减少 Region 个数。从 v6.1.0 开始，TiDB 支持设置自定义的 Region 大小。
