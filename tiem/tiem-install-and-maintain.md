...
> **注意：**
>
> 如果您现在安装的是 TiEM 1.0.0 版本，本小节暂不适用，请参见[兼容性升级 TiEM 1.0.1](#兼容性升级-tiem-101)升级到 TiEM 1.0.1 版本。
...
由于 TiEM 1.0.1 与 1.0.0 版本存在一些不兼容，不能直接通过[升级 TiEM](#升级-tiem)进行升级，故在此特别提供了兼容性升级步骤。
...
2. 做升级 TiEM 之前的准备。
    ...
    执行命令备份数据等升级的兼容性准备，请注意，在此只后不要再通过 TiEM 界面做其它操作直到升级完成，以避免最新的数据没有被备份导致升级后数据丢失。
