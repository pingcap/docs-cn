...
title: 慢查询日志
category: how-to
aliases: ['/docs-cn/dev/how-to/maintain/identify-abnormal-queries/identify-slow-queries.md','/docs-cn/sql/slow-query/','/docs-cn/dev/how-to/maintain/identify-slow-queries/']
---
