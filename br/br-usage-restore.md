...
|用 `BR 6.1` 备份 `TiDB 6.1`| 不兼容 | 兼容(已知问题 [#36379](https://github.com/pingcap/tidb/issues/36379)) | 兼容 | 兼容 |
|用 `BR 6.2` 备份 `TiDB 6.2`| 不兼容 | 兼容(已知问题 [#36379](https://github.com/pingcap/tidb/issues/36379)) | 兼容 | 兼容 |
