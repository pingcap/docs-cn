...
v6.3 对 PITR 产生的备份文件做了一些改动，例如新的压缩方法和小文件的合并，使得无法向前兼容。
| 恢复版本（横向）\ 备份版本（纵向）   | 用 PiTR v6.2 恢复 TiDB v6.2 | 用 PiTR v6.3 恢复 TiDB v6.3 |
|  ----  |  ----  | ---- |
|用 PiTR v6.2 备份 TiDB v6.2| 兼容 | 兼容 |
|用 PiTR v6.3 备份 TiDB v6.3| 不兼容 |兼容 |
