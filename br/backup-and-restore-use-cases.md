...
使用 PITR 功能，需要部署 v6.2.0 或以上版本的 TiDB 集群，并且更新 br 命令行工具到与 TiDB 集群相同的版本，本文假设使用的是 v6.5.8 版本。
...
- 安装：
    ...
    ```shell
    tiup install br:v6.5.8
    ```

- 升级：

    ```shell
    tiup update br:v6.5.8
    ```
...
>>>>>>> 5a9282cd4d (br: TiDB 7.1+ checkpoint restore requires s3:DeleteObject permission (#17075))
