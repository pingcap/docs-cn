...
aliases: ['/zh/tidb/stable/backup-and-restore-use-cases-for-maintain/','/zh/tidb/v6.5/backup-storage-S3']
---
...
使用 PITR 功能，需要部署 v6.2.0 或以上版本的 TiDB 集群，并且更新 br 命令行工具到与 TiDB 集群相同的版本，本文假设使用的是 v6.5.12 版本。
