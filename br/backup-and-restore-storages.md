...
BR 在 8.4 版本后支持在仅开启 IMDSv2 的 AWS EC2 实例上获取 IAM role 权限。在使用早版本的 BR 时，需要设置实例为同时支持 IMDSV1 和 IMDSV2. (AWS 在 2024 年中改变了默认行为，新创建的实例默认设置仅支持 IMDSv2, https://aws.amazon.com/about-aws/whats-new/2024/03/set-imdsv2-default-new-instance-launches/)
