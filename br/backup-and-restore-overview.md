...
本节列出了 TiDB v6.5.0 版本到 v8.5.0 之间所有长期支持版本（包括 v6.5.0、v7.1.0、v7.5.0、v8.1.0、v8.5.0）的 BR 兼容性矩阵。

> **注意：**
>
> 已知问题：在 7.2.0 版本中，部分系统表字段改为大小写敏感，可能导致跨版本备份恢复失败。详见 [Issue #43717](https://github.com/pingcap/tidb/issues/43717)。
>
> 可以在备份/恢复中添加以下后缀尽可能恢复所有系统表（仅跳过有格式修改的系统表）：
...
| 备份版本 | 兼容的恢复版本 | 不兼容的恢复版本 |
|:---------|:------------|:--------------|
| 6.5.0    | 7.1.0       | 7.5.0 及以上   |
| 7.1.0    | -           | 7.5.0 及以上   |
| 7.5.0    | 7.5.0 及以上 | -             |
| 8.1.0    | 8.1.0 及以上 | -             |
