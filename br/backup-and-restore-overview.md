...
> **注意：**
>
> 已知问题：从 v7.2.0 版本开始，新建集群的部分系统表字段改为大小写敏感，但 v7.2.0 之前版本，或者是 v7.2.0 版本以下的集群在线升级到 v7.2.0 及以上版本，对应的系统表字段大小写不敏感。 带系统表的备份和恢复如果发生在2类集群之间，就会失败。详见 [Issue #43717](https://github.com/pingcap/tidb/issues/43717)。
