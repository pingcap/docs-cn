...
#### TiDB v6.5.0 版本到 v7.5.0 之间的 BR 版本兼容性矩阵

本节列出了 TiDB v6.5.0 版本到 v7.5.0 之间所有[长期支持版本 (LTS)](/releases/versioning.md#长期支持版本)（包括 v6.5.0、v7.1.0、v7.5.0）的 BR 兼容性矩阵。这个矩阵中的 BR 版本与对应的 TiDB Server 的大版本一致。
