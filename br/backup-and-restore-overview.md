...
|  ----  |  ----  | ---- | ---- | ---- | ---- |
| TiDB v6.0、v6.1、v6.2、v6.3 及 v6.4 快照备份 | 兼容（已知问题，如果备份数据中包含空库可能导致报错，参考 [#36379](https://github.com/pingcap/tidb/issues/36379)） | 兼容 | 兼容 | 兼容 | 兼容（需使用 v6.6 及以上版本的 BR） |
| TiDB v6.3,v6.4,v6.5 日志备份| 不兼容 | 不兼容 | 不兼容 | 兼容 | 兼容 |
