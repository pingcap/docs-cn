...
TiDB v6.5.0 版本到 v8.5.0 之间所有长期支持版本（6.5.0、7.1.0、7.5.0、8.1.0、8.5.0）的 BR 兼容性矩阵：

已知问题：部分系统表字段在 7.2.0版本改为了大小写敏感版本，会导致跨版本备份恢复失败，参考 [#43717] (https://github.com/pingcap/tidb/issues/43717)

| 备份类型                       | 备份版本  |  恢复版本   | 结果   |
|-------------------------------|---------------------------------|--------------------------------|-------------|
| 全量备份                        | 6.5.0   | 7.1.0            | 兼容  |
|                               | 6.5.0    | 7.5.0 及以上版本  | ❌ 不兼容   |
|                               | 7.1.0    | 7.5.0 及以上版本  | ❌ 不兼容   |
|                               | 7.5.0    | 7.5.0 及以上版本  | 兼容  |
|                               | 8.1.0    | 8.1.0 及以上版本  | 兼容  |
| 全量备份（只备份用户数据）         | 所有版本  | 所有版本          | 兼容  |
| 日志备份                       | 6.5.0     | 7.1.0           | 兼容   |
|                               | 6.5.0    | 7.5.0 及以上版本  | ❌ 不兼容   |
|                               | 7.1.0    | 7.5.0 及以上版本  | ❌ 不兼容   |
|                               | 7.5.0    | 7.5.0 及以上版本  | 兼容  |
|                               | 8.1.0    | 8.5.0 及以上版本  | 兼容  |
| 日志备份（只备份用户数据）         | 所有版本  | 所有版本          | 兼容  |
