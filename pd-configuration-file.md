...
### `switch-witness-interval` <span class="version-mark">从 v6.6.0 版本开始引入</span>

+ 控制对同一个 Region 做切换为 [Witness](/glossary.md#witness) 和切换为 Non-Witness 操作的间隔，即对于一个新切换为 Non-Witness 的 Region 在一段时间内不会被切换为 Witness。
+ 默认值：1h
