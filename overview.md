...
- [使用 Ansible 部署](/online-deployment-using-ansible.md)：如果用于生产环境，推荐使用 TiDB Ansible 部署 TiDB 集群。
- [使用 Ansible 离线部署](/offline-deployment-using-ansible.md)：如果部署环境无法访问网络，可使用 TiDB Ansible 进行离线部署。
