...
从 v6.1.0 起，TiDB Grafana 组件默认内置了 Performance Overview 面板。兼容 v4.x 和 v5.x 版本。如果你的 TiDB 版本低于 v6.1.0，需要手工导入 [`performance_overview.json`](https://github.com/pingcap/tidb/blob/master/metrics/grafana/performance_overview.json)
