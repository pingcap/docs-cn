...
> 
> 如果只是希望测试 TiDB 或体验 TiDB 特性，可参考[如何快速体验 TiDB 集群](/how-to/get-started/quick-start-with-tidb.md)或者[使用 Docker Compose 在单机上快速部署 TiDB 集群](/how-to/get-started/deploy-tidb-from-docker-compose.md)。
