...
aliases: ['/docs-cn/v2.1/online-deployment-using-ansible/','/docs-cn/v2.1/how-to/deploy/orchestrated/ansible/']
---
...
以 `tidb` 用户登录中控机，请务必按以下方式通过 `pip` 安装 TiDB Ansible 及其相关依赖的指定版本，否则会有兼容问题。目前，release-2.0、release-2.1 及最新开发版本兼容 Ansible 2.4 ~ 2.7.11 (2.4 ≤ Ansible ≤ 2.7.11)。
...
1. 在中控机器上安装 TiDB Ansible 及其依赖。
    ...
    TiDB Ansible 及相关依赖的版本信息记录在 `tidb-ansible/requirements.txt` 文件中。
