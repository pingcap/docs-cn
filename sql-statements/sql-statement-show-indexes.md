...
aliases: ['/docs-cn/dev/sql-statements/sql-statement-show-indexes/','/docs-cn/dev/reference/sql/statements/show-indexes/','/docs-cn/dev/sql-statement-show-index/','/docs-cn/dev/sql-statement-show-keys/']
---
