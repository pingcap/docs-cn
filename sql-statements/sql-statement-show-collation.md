...
aliases: ['/docs-cn/v2.1/sql-statements/sql-statement-show-collation/','/docs-cn/v2.1/reference/sql/statements/show-collation/']
---
...
`SHOW COLLATION` 语句与 MySQL 完全兼容。但是 TiDB 中字符集可能有与 MySQL 不同的默认排序规则，详情见[与 MySQL 兼容性对比](/mysql-compatibility.md)。
