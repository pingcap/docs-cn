...
+ 执行 `ANALYZE TABLE` 时，TiDB 可能不包含最近提交的更改。对行进行批量更改后，在执行 `ANALYZE TABLE` 之前你可能需要先执行 `sleep(1)`，这样统计信息更新才能反映这些更改。见 [#16570](https://github.com/pingcap/tidb/issues/16570)。
