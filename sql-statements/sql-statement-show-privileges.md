...
aliases: ['/docs-cn/stable/sql-statements/sql-statement-show-privileges/','/docs-cn/v4.0/sql-statements/sql-statement-show-privileges/','/docs-cn/stable/reference/sql/statements/show-privileges/']
---
