...
aliases: ['/docs-cn/stable/sql-statements/sql-statement-rename-table/','/docs-cn/v4.0/sql-statements/sql-statement-rename-table/','/docs-cn/stable/reference/sql/statements/rename-table/']
---
