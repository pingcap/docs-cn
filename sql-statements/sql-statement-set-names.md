...
aliases: ['/docs-cn/stable/sql-statements/sql-statement-set-names/','/docs-cn/v4.0/sql-statements/sql-statement-set-names/','/docs-cn/stable/reference/sql/statements/set-names/','/zh/tidb/stable/sql-statement-set-names/']
---
