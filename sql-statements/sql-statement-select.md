...
aliases: ['/docs-cn/stable/sql-statements/sql-statement-select/','/docs-cn/v4.0/sql-statements/sql-statement-select/','/docs-cn/stable/reference/sql/statements/select/']
---
