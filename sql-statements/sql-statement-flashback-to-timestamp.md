...
> **警告：**
>
> 在 TiDB v7.1.0 中使用该功能可能会出现 FLASHBACK 完成后部分 Region 无法恢复的问题。请尽量避免在 v7.1.0 中使用该功能。详情可见此 [issue](https://github.com/pingcap/tidb/issues/44292)。
>
> 如果已经出现该问题，可以使用 [TiDB 快照备份与恢复](/br/br-snapshot-guide.md#tidb-快照备份与恢复使用指南)功能进行数据恢复。
