...
aliases: ['/docs-cn/stable/sql-statements/sql-statement-show-table-regions/','/docs-cn/v4.0/sql-statements/sql-statement-show-table-regions/','/docs-cn/stable/reference/sql/statements/show-table-regions/']
---
