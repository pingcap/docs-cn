...
aliases: ['/docs-cn/v2.1/sql-statements/sql-statement-split-region/','/docs-cn/v2.1/reference/sql/statements/split-region/']
---
...
和 `SPLIT REGION` 语句相关的 session 变量有 `tidb_wait_split_region_finish` 和 `tidb_wait_split_region_timeout`，具体可参考 [TiDB 专用系统变量和语法](/tidb-specific-system-variables.md)。
