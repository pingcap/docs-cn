...
aliases: ['/zh/tidb/v7.1/sql-statement-flashback-to-timestamp']
---
...
TiDB v6.5.6 和 v7.1.3 开始引入了 `FLASHBACK CLUSTER TO TSO` 的语法，支持使用时间戳 [TSO](/tso.md) 更加精确地指定恢复时间点，实现更加灵活的数据恢复。

> **警告：**
>
> 请检查指定的时间戳或者 TSO 的有效性，避免指定可能超过 PD 当前分配最大时间戳的未来时间，否则，可能破坏并发处理线性一致性以及事务隔离级别，导致严重的数据正确性的问题。
>
