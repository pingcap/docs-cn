---
title: ADMIN
aliases: ['/docs-cn/v3.0/sql-statements/sql-statement-admin/','/docs-cn/v3.0/reference/sql/statements/admin/','/docs-cn/sql/admin/']
---
...
>>>>>>> 17b04227... .github: check connectivity of external links via GitHub action (#4464)
