...
3）除了日志，通过 admin show slow 命令查看，详情请参考[admin show slow 命令](https://pingcap.com/docs-cn/sql/slow-query/#admin-show-slow-%E5%91%BD%E4%BB%A4)。
...
#### 4.1.5 在 loader 过程中, TiDB 可以对外提供服务吗？
该操作进行逻辑插入，TiDB 仍可对外提供服务，但不要执行相关DDL操作。
