...
* Error Number: 8138
    ...
    事务试图写入的行值有误，请参考[数据索引一致性检查](/data-inconsistency-errors.md#error-8138)。

* Error Number: 8139

    事务试图写入的行和索引的 handle 值不一致，请参考[数据索引一致性检查](/data-inconsistency-errors.md#error-8139)。

* Error Number: 8140

    事务试图写入的行和索引的值不一致，请参考[数据索引一致性检查](/data-inconsistency-errors.md#error-8140)。

* Error Number: 8141

    事务写入时，对 key 的存在性断言报错，请参考[数据索引一致性检查](/data-inconsistency-errors.md#error-8141)。
