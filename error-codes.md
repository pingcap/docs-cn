---
title: 错误码与故障诊断
aliases: ['/docs-cn/stable/error-codes/','/docs-cn/v4.0/error-codes/','/docs-cn/stable/reference/error-codes/','/docs-cn/v4.0/reference/error-codes/']
---
...
<<<<<<< HEAD
    写入的单条键值对过大。TiDB 默认支持最大 6MB 的单个键值对，超过该限制可适当调整 [`txn-entry-size-limit`](/tidb-configuration-file.md#txn-entry-size-limit-从-v4010-版本开始引入) 配置项以放宽限制。
=======
