...
> **警告：**
>
> 1. 升级 TiDB 前，请务必检查你的操作系统版本符合[操作系统及平台要求](/hardware-and-software-requirements.md#操作系统及平台要求)。如需将运行在 CentOS Linux 7 上的集群升级到 TiDB 8.5 版本，请选择升级至 TiDB 8.5.1 或以上版本，避免集群不可用的风险。详情参考 [TiDB 8.5.1 Release Notes](/releases/release-8.5.1.md)。
