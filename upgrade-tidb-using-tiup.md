...
> **警告：**
>
> 1. 如需将运行在 CentOS Linux 7 上的集群升级到 TiDB 8.5 版本，请选择升级至 TiDB 8.5.1 或以上版本。在 v8.5.0 版本中，TiDB 移除了对 CentOS Linux 7 的支持，如果将运行在 CentOS Linux 7 上的 TiDB 集群升级到 v8.5.0 版本，将存在导致集群不可用的风险。升级 TiDB 前，请务必确保你的操作系统版本符合[操作系统及平台要求](/hardware-and-software-requirements.md#操作系统及平台要求)。
