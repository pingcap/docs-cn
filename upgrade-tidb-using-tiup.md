...
- 将 6.3.0 之前的 TiFlash 升级至 6.3.0 及之后的版本时，需要特别注意：在 Linux AMD64 架构的硬件平台下部署 TiFlash 时，CPU 必须支持 AVX2 指令集。具体请参考 [6.3.0 版本 Release Note](/releases/release-6.3.0.md#其他)。
