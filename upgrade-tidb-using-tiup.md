...
> + After the upgrade, you want to use v5.4's default parameter values for the unmodified configuration items.
...
For example, if you want to upgrade the cluster to v5.4.0:
