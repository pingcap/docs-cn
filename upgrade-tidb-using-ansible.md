...
aliases: ['/docs-cn/v3.0/upgrade-tidb-using-ansible/','/docs-cn/v3.0/how-to/upgrade/from-previous-version/','/docs-cn/op-guide/tidb-v3.0-upgrade-guide/','/docs-cn/v3.0/how-to/upgrade/to-tidb-3.0','/docs-cn/v2.1/how-to/upgrade/to-tidb-3.0/','/docs-cn/v3.0/how-to/upgrade/rolling-updates-with-ansible/']
---

# TiDB 3.0 升级操作指南

本文档适用于从 TiDB 2.0 或 2.1 版本升级至 TiDB 3.0 版本以及 TiDB 3.0 低版本升级至 TiDB 3.0 高版本。目前，TiDB 3.0 版本兼容 [TiDB Binlog Cluster 版本](/tidb-binlog/tidb-binlog-overview.md)。
...
下载 TiDB 3.0 版本对应 tag 的 tidb-ansible  [**下载 TiDB Ansible**](/online-deployment-using-ansible.md#第-3-步在中控机器上下载-tidb-ansible)，默认的文件夹名称为 `tidb-ansible`。
