...
- [Physical Import Mode 必要条件及限制](/tidb-lightning/tidb-lightning-sst-requirements.md)
- [Logical Import Mode 必要条件及限制](/tidb-lightning/tidb-lightning-sql-requirements.md)
