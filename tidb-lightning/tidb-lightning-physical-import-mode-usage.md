...
# 冲突数据处理方式
# `duplicate-resolution` 参数从 v8.0.0 开始已被废弃，并将在未来版本中被移除。
...
# 详情参考 <https://docs.pingcap.com/zh/tidb/stable/tidb-lightning-physical-import-mode-usage#旧版冲突检测从-v800-开始已被废弃>。
