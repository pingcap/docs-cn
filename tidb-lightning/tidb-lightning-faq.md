...
category: faq
aliases: ['/docs/dev/faq/tidb-lightning/']
---
...
TiDB Lightning only supports the SQL dump generated by [Mydumper](/mydumper-overview.md) or [CSV files](/tidb-lightning/migrate-from-csv-using-tidb-lightning.md) stored in the local file system.
