...
aliases: ['/docs-cn/stable/tidb-lightning/tidb-lightning-faq/','/docs-cn/v4.0/tidb-lightning/tidb-lightning-faq/','/docs-cn/stable/faq/tidb-lightning/','/docs-cn/stable/troubleshoot-tidb-lightning/','/docs-cn/v4.0/troubleshoot-tidb-lightning/','/docs-cn/stable/how-to/troubleshoot/tidb-lightning/','/docs-cn/stable/reference/tools/error-case-handling/lightning-misuse-handling/','/docs-cn/stable/tidb-lightning/tidb-lightning-misuse-handling/','/zh/tidb/v4.0/troubleshoot-tidb-lightning/','/zh/tidb/stable/troubleshoot-tidb-lightning/']
---
...
报错原因是遍历本地排序的文件时出现异常，可能在 TiDB Lightning 打开的文件数量超过系统的上限时发生报错。在 Linux 系统中，可以使用 `ulimit -n` 命令确认此值是否过小。建议在 TiDB Lightning 导入期间将此设置调整为 `1000000`（即 `ulimit -n 1000000`）。
