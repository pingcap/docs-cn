...
- Add the `syncer.ignore-table` configuration item in TiDB-Binlog Drainer to support filtering tables not to be synchronized [#526](https://github.com/pingcap/tidb-binlog/pull/526)
