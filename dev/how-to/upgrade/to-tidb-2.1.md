...
> **Note:**
>
> TiDB 2.1 is not compatible with the Kafka version of TiDB-Binlog. If your current TiDB cluster has already been using the [Kafka version of TiDB-Binlog](/dev/reference/tools/tidb-binlog/tidb-binlog-kafka.md), you need to [upgrade it to the cluster version of TiDB-Binlog](/tools/tidb-binlog-cluster.md#tidb-binlog-upgrade).
