...
First, use [`mydumper`](/dev/reference/tools/mydumper.md) to export data from MySQL:
...
Before the data import, you need to deploy a TiDB cluster (later than v2.0.9). In this tutorial, TiDB v3.0.4 is used. For the deployment method, refer to [TiDB Introduction](/dev/overview.md).
...
For detailed features and usage about TiDB Lightning, refer to [TiDB Lightning Overview](/dev/reference/tools/tidb-lightning/overview.md).
