...
First, check the [slow query log](/dev/how-to/maintain/identify-abnormal-queries/identify-slow-queries.md) and see if it is because of some inappropriate SQL statement.
