...
本文介绍了 TiDB 集群中各组件的报警规则，包括 TiDB、TiKV、PD、TiDB Binlog、Node_exporter 和 Blackbox_exporter。每条报警规则根据严重级别进行分类：紧急级别、重要级别或者警告级别。
...
本节介绍了 Blackbox_exporter TCP、ICMP 和 HTTP 的报警规则。
