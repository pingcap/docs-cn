...
For the role naming format and rule, see [TiDB User Account Management](/dev/reference/security/user-account-management.md).
...
The operation of granting a privilege to a role is the same with that of granting a privilege to a user. For details, see [TiDB Privilege Management](/dev/reference/security/privilege-system.md).
...
For details, see [TiDB Privilege Management](/dev/reference/security/privilege-system.md).
...
In addition to four system [privilege tables](/dev/reference/security/privilege-system.md#privilege-table), the RBAC system introduces two new system privilege tables:
...
- [TiDB Privilege Management](/dev/reference/security/privilege-system.md)
