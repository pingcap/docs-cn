...
|:------------|:--------------|:-------------|---------:|
| ☑ 已定义   | ☑ 已定义     | ☑ 已定义    | [`S`: 1 bit] [`I`: 4 bits] [`D`: 7 bits] [`T`: 8 bits] [`P`: 44 bits] |
| ☐ 空     | ☑ 已定义     | ☑ 已定义    | [`S`: 1 bit] [`D`: 7 bits] [`T`: 8 bits] [`P`: 48 bits] |
| ☑ 已定义   | ☐ 空       | ☑ 已定义    | [`S`: 1 bit] [`I`: 4 bits] [`T`: 8 bits] [`P`: 51 bits] |
| ☑ 已定义   | ☑ 已定义     | ☐ 空      | [`S`: 1 bit] [`I`: 4 bits] [`D`: 7 bits] [`P`: 52 bits] |
| ☐ 空     | ☐ 空       | ☑ 已定义    | [`S`: 1 bit] [`T`: 8 bits] [`P`: 55 bits] |
| ☐ 空     | ☑ 已定义     | ☐ 空      | [`S`: 1 bit] [`D`: 7 bits] [`P`: 56 bits] |
| ☑ 已定义   | ☐ 空       | ☐ 空      | [`S`: 1 bit] [`I`: 4 bits] [`P`: 59 bits] |
