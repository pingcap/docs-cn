...
- To satisfy the replication Requirement #1-iv, configure the [binlog filtering rules](/dev/reference/tools/data-migration/features/overview.md#binlog-event-filter) as follows:
...
- To satisfy the replication Requirement #2-ii, configure the [binlog filtering rule](/dev/reference/tools/data-migration/features/overview.md#binlog-event-filter) as follows:
