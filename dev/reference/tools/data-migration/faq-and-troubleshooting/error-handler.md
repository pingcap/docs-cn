...
| `code=11006` |  DM 内置的 parser 解析不兼容的 DDL 时出错              |  可参考 [Data Migration 故障诊断-处理不兼容的 DDL 语句](/dev/reference/tools/data-migration/faq-and-troubleshooting/faq.md#处理不兼容的-ddl-语句) 提供的解决方案 |
