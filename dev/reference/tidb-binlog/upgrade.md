...
This document introduces how to upgrade TiDB Binlog that is deployed with Ansible and deployed manually to the latest [cluster](/dev/reference/tidb-binlog/overview.md) version. There is also a section on how to upgrade TiDB Binlog from an earlier incompatible version (Kafka/Local version) to the latest version.
