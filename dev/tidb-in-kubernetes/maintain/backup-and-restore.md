...
Incremental backup uses [TiDB Binlog](/dev/reference/tidb-binlog/overview.md) to collect binlog data from TiDB and provide near real-time backup and replication to downstream platforms.
