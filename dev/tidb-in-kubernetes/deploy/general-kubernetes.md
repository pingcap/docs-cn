...
Modify the configuratiuon above according to your needs. For more configuration details, refer to the [TiDB Cluster Configuration Document](/dev/tidb-in-kubernetes/reference/configuration/tidb-cluster.md).
