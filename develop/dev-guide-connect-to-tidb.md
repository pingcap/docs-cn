...
- 如需从边缘环境通过 HTTP 连接到 {{{ .starter }}} 或 {{{ .essential }}} 实例，可以使用 [TiDB Cloud Serverless Driver](/develop/serverless-driver.md)。需要注意的是，Serverless Driver 目前处于公测阶段，仅适用于 {{{ .starter }}} 或 {{{ .essential }}} 实例。
