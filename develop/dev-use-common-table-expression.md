...
在前面的小节当中我们已经介绍了如何使用[视图](/develop/dev-use-views.md)简化查询，也介绍了如何使用[临时表](/develop/dev-use-temporary-tables.md)来缓存中间查询结果。
...
我们可以将[临时表](/develop/dev-use-temporary-tables.md)小节当中的例子改为以下 SQL 语句：
