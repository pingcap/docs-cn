...
aliases: ['/zh/tidb/stable/java-app-best-practices/','/zh/tidb/dev/java-app-best-practices/','/docs-cn/dev/best-practices/java-app-best-practices/','/docs-cn/dev/reference/best-practices/java-app/','/docs-cn/dev/reference/best-practices/using-tidb-in-java/']
---
...
- 方式二：使用 Cursor Fetch，首先需[设置 `FetchSize`](https://makejavafaster.blogspot.com/2015/06/jdbc-fetch-size-performance.html) 为正整数，且在 JDBC URL 中配置 `useCursorFetch = true`。
