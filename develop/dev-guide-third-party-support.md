...
<table>
   ...
   <tbody>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-golang-sql-driver">使用 Go-MySQL-Driver 连接到 TiDB</a></td>
      </tr>
      <tr>
         <td>Java</td>
         ...
         <td>
            <ul>
               <li><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-choose-driver-or-orm#java-drivers" data-href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-choose-driver-or-orm#java-drivers">pingcap/mysql-connector-j</a></li>
               <li><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-choose-driver-or-orm#tidb-loadbalance" data-href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-choose-driver-or-orm#tidb-loadbalance">pingcap/tidb-loadbalance</a></li>
            </ul>
         </td>
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-java-jdbc">使用 JDBC 连接到 TiDB</a></td>
      </tr>
   </tbody>
</table>
...
<table>
   ...
   <tbody>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-golang-gorm">使用 GORM 连接到 TiDB</a></td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-java-hibernate">使用 Hibernate 连接到 TiDB</a></td>
      </tr>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-java-mybatis">使用 MyBatis 连接到 TiDB</a></td>
      </tr>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-java-spring-boot">使用 Spring Boot 连接到 TiDB</a></td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-ruby-rails">使用 Rails 框架和 ActiveRecord ORM 连接到 TiDB</a></td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-nodejs-prisma">使用 Prisma 连接到 TiDB</a></td>
      </tr>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-nodejs-typeorm">使用 TypeORM 连接到 TiDB</a></td>
      </tr>
      <tr>
         ...
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-python-django">使用 Django 连接到 TiDB</a></td>
      </tr>
      <tr>
         ...
         <td>Full</td>
         <td>N/A</td>
         <td><a href="https://docs.pingcap.com/zh/tidb/v6.5/dev-guide-sample-application-python-sqlalchemy">使用 SQLAlchemy 连接到 TiDB</a></td>
      </tr>
   </tbody>
</table>
