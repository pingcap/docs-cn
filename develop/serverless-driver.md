...
你可以使用 serverless driver 查询 {{{ .starter }}} 或 {{{ .essential }}} 实例中的数据，或执行交互式事务。

### 查询

要从 {{{ .starter }}} 或 {{{ .essential }}} 实例查询数据，你需要先创建连接。然后可以使用该连接执行原生 SQL 查询。例如：
...
| 名称         | 类型     | 默认值         | 描述                                                                                                                                                                                                                                                                                                                                                  |
|--------------|----------|---------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `username`   | string   | N/A           | {{{ .starter }}} 或 {{{ .essential }}} 实例的用户名。                                                                                                                                                                                                                                                                                                                                       |
| `password`   | string   | N/A           | {{{ .starter }}} 或 {{{ .essential }}} 实例的密码。                                                                                                                                                                                                                                                                                                                                         |
| `host`       | string   | N/A           | {{{ .starter }}} 或 {{{ .essential }}} 实例的主机名。                                                                                                                                                                                                                                                                                                                                       |
| `database`   | string   | `test`        | {{{ .starter }}} 或 {{{ .essential }}} 实例的数据库。                                                                                                                                                                                                                                                                                                                                       |
...
- 对于 {{{ .starter }}} 实例，按 [{{{ .starter }}} 计费模式](https://www.pingcap.com/tidb-cloud-starter-pricing-details/)计费。
- 对于 {{{ .essential }}} 实例，按 [{{{ .essential }}} 计费模式](https://www.pingcap.com/tidb-cloud-essential-pricing-details/)计费。
