...
- 查看 [性能注意事项](#性能注意事项)。
- 如果你的删除无需事务性，可使用[非事务批量删除](#非事务批量删除)，来提高性能。
...
> **注意：**
>
> TiDB 从 v6.1.0 版本开始支持[非事务 DML 语句](/non-transactional-dml.md)特性。在更低版本上无法使用此特性。

### 非事务批量删除使用前提

请先行**仔细**阅读[非事务 DML 语句](/non-transactional-dml.md)一章。非事务批量删除，本质是以牺牲事务的原子性、隔离性为代价，增强批量数据处理场景下的性能和易用性。
