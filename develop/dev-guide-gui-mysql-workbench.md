...
7. 点击 **Test Connection** 以验证与你目标 {{{ .starter }}} 或 Essential 实例的连接。
...
如果在开发的过程中遇到问题，可以在 [AskTUG 论坛](https://pingkai.cn/tidbcommunity/forum/?utm_source=docs-cn-dev-guide) 上提问，或从 {{{ .company }}} 官方或 TiDB 社区[获取支持](/support.md)。
