...
> **注意：**
>
> Hibernate 当前[不支持嵌套事务](https://stackoverflow.com/questions/37927208/nested-transaction-in-spring-app-with-jpa-postgres)，TiDB v6.2.0 版本才开始支持[Savepoint](/sql-statements/sql-statement-savepoint.md)。
