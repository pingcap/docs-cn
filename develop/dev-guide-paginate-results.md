...
```sql
SELECT * FROM ratings WHERE book_id = 268996 AND user_id >= 92104804
UNION ALL
SELECT * FROM ratings WHERE  book_id > 268996 AND book_id < 140982742
UNION ALL
SELECT * FROM ratings WHERE  book_id = 140982742 AND user_id <= 374645100
