...
本章内容将会用 [bookshop](/develop/dev-bookshop-schema-design.md) 数据库中的 `books` 表作为示例。
...
- 请使用有意义的二级索引名，我们推荐你遵循公司或组织的表命名规范。如果你的公司或组织没有相应的命名规范，可参考[索引命名规范](/develop/dev-object-naming-guidelines.md#索引命名规范)。
