...
# 集成 TiDB 向量搜索与 Jina AI Embeddings API <!--Corresponding EN commit: 37c45d52207b46f0d84339da42eb3b4f6f247129-->

本教程将指导你如何使用 [Jina AI](https://jina.ai/) 生成文本 embedding，将其存储到 TiDB 中，并基于 embedding 实现相似文本搜索。

> **注意：**
>
> - 向量搜索功能目前为公开预览版，可能会在未提前通知的情况下发生变更。如果你发现 bug，可以在 GitHub 上提交 [issue](https://github.com/pingcap/tidb/issues)。
