...
# 集成 TiDB 向量搜索与 SQLAlchemy <!--Corresponding EN commit: 37c45d52207b46f0d84339da42eb3b4f6f247129-->

本教程将指导你如何使用 [SQLAlchemy](https://www.sqlalchemy.org/) 与 [TiDB 向量搜索](/ai/concepts/vector-search-overview.md) 进行交互，存储嵌入向量，并执行向量搜索查询。

> **注意：**
>
> - 向量搜索功能目前为公开预览版，可能会在无提前通知的情况下发生变更。如果你发现了 bug，可以在 GitHub 上提交 [issue](https://github.com/pingcap/tidb/issues)。
