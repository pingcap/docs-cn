...
This document introduces the basic configuration of DM worker, which provisions DM-worker's deployment in most scenarios. Refer to [DM-worker Advanced Configuration File](/reference/tools/data-migration/configure/dm-worker-configuration-file-full.md) to see more parameters in detail.
