...
完整配置项参考 [DM-worker 完整配置说明](/v3.1/reference/tools/data-migration/configure/dm-worker-configuration-file-full.md)。
...
> **注意：**
>
> 以上配置为部署 DM-worker 的基础配置，一般情况下使用基础配置即可，更多配置项参考 [DM-worker 完整配置说明](/v3.1/reference/tools/data-migration/configure/dm-worker-configuration-file-full.md)。
