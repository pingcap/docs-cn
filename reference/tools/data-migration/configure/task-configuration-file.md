...
DM also implements [an advanced task configuration file](/reference/tools/data-migration/configure/task-configuration-file-full.md) which provides greater flexibility and more control over DM.
...
For basic applications, you only need to modify the black and white lists filtering rule. Refer to the comments about `black-white-list` in the [template](#task-configuration-file-template-basic) or [Black & white table lists](/reference/tools/data-migration/features/overview.md#black--white-table-lists) to see more details.
