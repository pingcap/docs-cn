...
- 运维操作
  ...
  - 备份与恢复
    - [TiDB 备份恢复功能介绍](/br/br-overview.md)
    - [TiDB 备份恢复架构设计](/br/br-architecture.md)
    - [备份存储支持](/br/backup-and-restore-storages.md)
    + [使用 br 进行备份与恢复](/br/br-use-guide/br-use-overview.md)
      - [使用 br 进行（全量）快照备份与恢复](/br/br-use-guide/br-snapshot-guide.md)
      - [使用 br 进行 PITR](/br/br-use-guide/br-pitr-guide.md)
      - [备份与恢复场景使用示例](/br/br-use-guide/br-usage.md)
    - [br cli 命令手册](/br/br-manual/use-br-command-line.md)
    - 参考指南
      - BR 特性设计
