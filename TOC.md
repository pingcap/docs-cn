...
- 参考指南
  ...
  - SQL
    ...
    - 数据类型
      ...
      - [向量数据类型](https://docs.pingcap.com/zh/ai/vector-search-data-types/)
    - 函数与操作符
      ...
      - [向量函数和运算符](https://docs.pingcap.com/zh/ai/vector-search-functions-and-operators/)
      - JSON 函数
    ...
    - [向量索引](https://docs.pingcap.com/zh/ai/vector-search-index/)
    - [约束](/constraints.md)
