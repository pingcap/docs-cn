...
- 应用开发
  - [概览](/develop/dev-overview.md)
  - 快速开始
    - [使用 TiDB Cloud (DevTier) 构建 TiDB 集群](/develop/dev-build-cluster-in-cloud.md)
    - [使用 TiDB 的增删改查 SQL](/develop/dev-tidb-crud-sql.md)
    - TiDB 的简单 CRUD 应用程序
      - [Java](/develop/dev-sample-application-java.md)
  - 示例程序
    - [使用 Spring Boot 构建 TiDB 应用程序](/develop/dev-sample-application-spring-boot.md)
  - 连接到 TiDB
    - [选择驱动或 ORM 框架](/develop/dev-choose-driver-or-orm.md)
    - [连接到 TiDB](/develop/dev-connect-to-tidb.md)
    - [连接池与连接参数](/develop/dev-connection-parameters.md)
  - 数据库模式设计
    - [概览](/develop/dev-schema-design-overview.md)
    - [创建数据库](/develop/dev-create-database.md)
    - [创建表](/develop/dev-create-table.md)
    - [创建二级索引](/develop/dev-create-secondary-indexes.md)
  - 数据写入
    - [插入数据](/develop/dev-insert-data.md)
    - [更新数据](/develop/dev-update-data.md)
    - [删除数据](/develop/dev-delete-data.md)
    - [预处理语句](/develop/dev-prepared-statement.md)
  - 数据读取
    - [单表读取](/develop/dev-get-data-from-single-table.md)
    - [多表连接查询](/develop/dev-join-tables.md)
    - [子查询](/develop/dev-use-subqueries.md)
    - [查询结果分页](/develop/dev-paginate-results.md)
    - [视图](/develop/dev-use-views.md)
    - [临时表](/develop/dev-use-temporary-tables.md)
    - [公共表表达式](/develop/dev-use-common-table-expression.md)
    - 读取副本数据
      - [Follower Read](/develop/dev-use-follower-read.md)
      - [Stale Read](/develop/dev-use-stale-read.md)
    - [HTAP 查询](/develop/dev-hybrid-oltp-and-olap-queries.md)
  - 事务
    - [概览](/develop/dev-transaction-overview.md)
    - [乐观事务和悲观事务](/develop/dev-optimistic-and-pessimistic-transaction.md)
    - [事务限制](/develop/dev-transaction-restraints.md)
    - [事务错误处理](/develop/dev-transaction-troubleshoot.md)
  - 优化 SQL 性能
    - [概览](/develop/dev-optimize-sql-overview.md)
    - [SQL 性能调优](/develop/dev-optimize-sql.md)
    - [性能调优最佳实践](/develop/dev-optimize-sql-best-practices.md)
    - 其他优化
      - [避免隐式类型转换](/develop/dev-implicit-type-conversion.md)
      - [唯一序列号生成方案](/develop/dev-unique-serial-number-generation.md)
  - 故障诊断
    - [概览](/develop/dev-troubleshoot-overview.md)
    - 其他故障或限制
      - [结果集不稳定](/develop/dev-unstable-result-set.md)
      - [超时](/develop/dev-timeouts-in-tidb.md)
  - 引用文档
    - SQL
      - [Bookshop 示例应用](/develop/dev-bookshop-schema-design.md)
    - 规范
      - [命名规范](/develop/dev-object-naming-guidelines.md)
      - [SQL 开发规范](/develop/dev-sql-development-specification.md)
- 部署标准集群
