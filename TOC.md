...
+ 参考手册
  ...
  + SQL
    ...
    - [字符集](dev/reference/sql/character-set-support.md)
  + 配置
    + tidb-server
      - [MySQL 系统变量](dev/reference/configuration/tidb-server/variable.md)
      - [TiDB 特定系统变量](dev/reference/configuration/tidb-server/tidb-specific.md)
