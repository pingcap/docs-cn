...
- 参考指南
  ...
  - SQL
    ...
    - SQL 语句
      ...
      - [`FALSHBACK CLUSTER TO TIMESTAMP`](/sql-statements/sql-statement-flashback-cluster-to-timestamp.md)
      - [`FALSHBACK DATABASE TO TIMESTAMP`](/sql-statements/sql-statement-flashback-database-to-timestamp.md)
      - [`FLASHBACK TABLE`](/sql-statements/sql-statement-flashback-table.md)
      - [`FALSHBACK TABLE TO TIMESTAMP`](/sql-statements/sql-statement-flashback-table-to-timestamp.md)
