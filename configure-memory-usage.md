...
- Sort、MergeJoin、HashJoin 落盘是从 v4.0.0 版本开始引入的，从 v5.2.0 版本开始引入了参数 `tidb_executor_concurrency == 1` 的 HashAgg 算子的落盘，从 v7.6.0 版本开始引入了参数 `tidb_executor_concurrency > 1` 的 HashAgg 算子的落盘。
