...
字符串函数: substr, replace, concat, concat_ws, left, right
日期函数: date_format, timestampdiff, from_unixtime, unix_timestamp, str_to_date, date_add, date_sub, datediff, year, month, day, extract
JSON 函数: json_length
