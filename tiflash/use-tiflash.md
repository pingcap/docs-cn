---
title: 使用 TiFlash
aliases: ['/docs-cn/v3.1/tiflash/use-tiflash/','/docs-cn/v3.1/reference/tiflash/use-tiflash/']
---
...
目前 TiFlash 支持了有限的常用表达式下推，支持下推的表达式可参考[该文件](https://github.com/pingcap/tidb/blob/v3.1.0/expression/expression.go#L558)。
...
>>>>>>> 5e9a6fc8... Update use-tiflash.md (#5434)
