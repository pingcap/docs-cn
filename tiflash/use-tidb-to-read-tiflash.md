...
> - TiDB 6.3.0 到 6.5.x 之间的版本，如果 TiFlash 副本被允许使用，你可以通过变量 [tidb_enable_tiflash_read_for_write_stmt](/system-variables.md#tidb_enable_tiflash_read_for_write_stmt-从-v630-版本开始引入) 控制是否允许 TiDB 在处理非只读 SQL 语句时使用 TiFlash 副本。
