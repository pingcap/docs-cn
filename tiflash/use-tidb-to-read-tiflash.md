...
> - TiDB 6.5.0 到 7.0.0 之间的版本，如果 TiFlash 副本被允许使用，TiDB 将通过变量[tidb_enable_tiflash_read_for_write_stmt](/system-variables.md#tidb_enable_tiflash_read_for_write_stmt-从-v630-版本开始引入) 控制是否允许处理非只读 SQL 语句时使用 TiFlash 副本。
