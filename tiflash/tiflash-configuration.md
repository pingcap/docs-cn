...
[storage]
    ...
    ## * format_version = 7 v8.4.0 和 v8.5.0 的默认文件格式（从 v8.4.0 开始引入），该格式用于支持向量索引的构建与存储。
    ## * format_version = 8 v9.0.0 及以后版本的默认文件格式（从 v9.0.0 开始引入），该格式支持新的字符串序列化方案，可提升字符串的读写性能。
    # format_version = 8
