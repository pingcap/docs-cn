...
某些 OLAP 对查询结果精度可以容忍一定误差。如果对查询性能有更高要求，可以在 session 级别或 global 级别开启 FastScan 功能，你可以通过修改变量 [`tiflash_fastscan`](/system-variables.md#tiflash_fastscan-new-in-v630) 的值来选择是否启用 FastScan 功能。
