...
- v7.2.0 和 v7.3.0：TiFlash Pipeline Model 为实验特性，使用 [`tidb_enable_tiflash_pipeline_model`](https://docs-archive.pingcap.com/zh/tidb/v7.2/system-variables/#tidb_enable_tiflash_pipeline_model-从-v720-版本开始引入) 控制。
