...
<!-- This TOC is the source of https://pingkai.cn/docs/tidb/stable, NOT the source of https://docs.pingcap.com -->
...
- 应用开发
  ...
  - 向量搜索
    ...
    - 集成
      ...
      - 嵌入模型/服务
        - [Jina AI](/ai/integrations/vector-search-integrate-with-jinaai-embedding.md)
      - ORM 库
        ...
        - [Django](/ai/integrations/vector-search-integrate-with-django-orm.md)
    - [优化搜索性能](/ai/reference/vector-search-improve-performance.md)
    - [使用限制](/ai/reference/vector-search-limitations.md)
  - 事务
...
- 数据同步
  ...
  - 数据集成场景
    ...
    - 与 Confluent Cloud、Snowflake、ksqlDB、SQL Server 进行数据集成
      - [Confluent Cloud](/ticdc/integrate-confluent-using-ticdc.md#输出增量数据到-confluent-cloud)
      - [Snowflake](/ticdc/integrate-confluent-using-ticdc.md#与-snowflake-进行数据集成)
      - [ksqlDB](/ticdc/integrate-confluent-using-ticdc.md#与-ksqldb-进行数据集成)
      - [SQL Server](/ticdc/integrate-confluent-using-ticdc.md#与-sql-server-进行数据集成)
