...
title: TiDB 集群监控 API
category: how-to
aliases: ['/docs-cn/stable/how-to/monitor/tidb-monitoring-api/']
---
...
- 如果使用其他方式部署 TiDB 集群，在使用 metrics 接口前，需先[部署 Prometheus 和 Grafana](/monitor-deploy.md)。

成功部署 Prometheus 和 Grafana 之后，[配置 Grafana](/monitor-deploy.md)。
