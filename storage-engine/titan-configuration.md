...
4. 对于 8.5 及以后的版本，更新 TiKV 节点的配置，关闭 Titan。
   > **警告：**
   >
   > 不建议对 8.5 之前的版本做如下操作，这个操作在旧版本中有可能造成 TiKV crash。 8.5 之前的版本，应保留步骤 1 中的设置来达到关闭 Titan 的目的，步骤 1 中的设置和下面的设置，在数据迁移完成后，不会有性能上的差异。
