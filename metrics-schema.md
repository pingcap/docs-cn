...
aliases: ['/docs-cn/dev/reference/system-databases/metrics-schema/','/zh/tidb/dev/system-table-metrics-schema/','/docs-cn/dev/system-tables/system-table-metrics-schema/']
---
