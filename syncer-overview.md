---
title: Syncer 使用文档
aliases: ['/docs-cn/stable/syncer-overview/','/docs-cn/v4.0/syncer-overview/','/docs-cn/stable/reference/tools/syncer/','/zh/tidb/stable/syncer-overview','/zh/tidb/dev/syncer-overview']
---
