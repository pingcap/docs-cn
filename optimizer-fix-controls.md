...
从 TiDB v6.5.7 开始，提供了 [`tidb_opt_fix_control`](/system-variables.md#tidb_opt_fix_control-从-v657-版本开始引入) 系统变量来更细粒度地控制优化器的行为。
...
### [`44389`](https://github.com/pingcap/tidb/issues/44389) <span class="version-mark">从 v6.5.7 版本开始引入</span>
...
### [`44855`](https://github.com/pingcap/tidb/issues/44855) <span class="version-mark">从 v6.5.7 版本开始引入</span>
