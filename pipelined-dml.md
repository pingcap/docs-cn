...
- 仅适用于 TiDB X：TiDB X 不支持 Pipelined DML，不能通过设置 [`tidb_dml_type`](/system-variables.md#tidb_dml_type-从-v800-版本开始引入) 为 `"bulk"` 或使用 [`SET_VAR`](/optimizer-hints.md#set_varvar_namevar_value) hint 启用该功能。
