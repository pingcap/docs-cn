...
> - 如果要启用 [Fast Online DDL](/tidb-distributed-execution-framework#启用前提) 对添加索引等 DDL 操作进行加速。 推荐在 TiDB 中准备额外的 SSD 磁盘空间 (建议 100 GB)，配置方式详见[设置 TiDB 节点的临时空间](/check-before-deployment.md)。
