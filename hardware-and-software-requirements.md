...
| TiFlash | 32 核+ | 64 GB+ | 1 SSD + n HDD，共 200 GB+ | 千兆网卡 | 1 |
...
| TiFlash | 48 核+ | 128 GB+ | 1 NVMe SSD + n HDD | 万兆网卡（2 块最佳） | 2 |
...
> - TiFlash 推荐用一个 SSD 来缓冲 TiKV 同步数据的实时写入，该盘性能不低于 TiKV 所使用的硬盘，容量建议不小于总容量的 10%，否则它可能成为这个节点的能承载的数据量的瓶颈。而其他硬盘可以选择部署多块 HDD 或者 SSD，更好的硬盘会带来更好的性能。
