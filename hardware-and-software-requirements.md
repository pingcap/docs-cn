...
+ 在以下操作系统以及对应的 CPU 架构组合上，你可以编译、构建和部署 TiDB，可使用 OLTP 和 OLAP 以及数据工具的基本功能。但是 TiDB **不保障企业级生产质量要求**：
    ...
    | 操作系统                                                                             | 支持的 CPU 架构                   |
    +:=====================================================================================+:==================================+
    | macOS Catalina 及以上的版本（自 v6.1.2 起，仅支持 macOS 12 (Monterey) 及以上的版本） | - x86_64                          |
    |                                                                                      | - ARM 64                          |
    +--------------------------------------------------------------------------------------+-----------------------------------+
...
+:==================================+:==========================================================+
| Golang                            | - TiDB v6.1.0、v6.1.1 及 v6.1.2：Golang 1.18 及以上版本   |
|                                   | - TiDB v6.1.3：Golang 1.19.3 及以上版本                   |
+-----------------------------------+-----------------------------------------------------------+
