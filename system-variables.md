...
- 类型：整数型
- 默认值：`4`
- 范围：`[0, 4294967295]`。在 v8.2.0 之前版本中，最小值为 `1`。当设置为 `0` 时，TiDB 会根据集群规模自适应并发度。
...
- 类型：整数型
- 默认值：`1`
- 范围：`[0, 4294967295]`，v7.5.0 及之前版本最大值为 `256`。在 v8.2.0 之前版本中，最小值为 `1`。当设置为 `0` 时，TiDB 会根据集群规模自适应并发度。
