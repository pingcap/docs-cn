...
- 拥有 `RESTRICTED_VARIABLES_ADMIN` 或 `SUPER` 的用户可以修改该变量。如果用户开启了[安全增强模式 (Security Enhanced Mode)](https://docs.pingcap.com/zh/tidb/stable/system-variables#tidb_enable_enhanced_security)，则只有 `RESTRICTED_VARIABLES_ADMIN` 的用户才能修改该变量。
