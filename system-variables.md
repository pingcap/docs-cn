...
- 从 v8.5.7 开始，该变量的默认值从 `1` 变更为 `3`。如果你的集群是从更早版本升级而来，升级后该变量的值保持不变。
...
- 从 v8.5.7 开始，该变量的默认值从 `1` 变更为 `2`。如果你的集群是从更早版本升级而来，升级后该变量的值保持不变。
...
- 从 v8.5.7 开始，该变量的默认值从 `1` 变更为 `4`。如果你的集群是从更早版本升级而来，升级后该变量的值保持不变。
