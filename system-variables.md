...
```sql
mysql> select @@tidb_opt_range_max_size;
+----------------------------+
...
mysql> explain select * from t use index (idx) where a in (10,20,30) and b in (40,50,60);
+-------------------------------+---------+-----------+--------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| id                            | estRows | task      | access object            | operator info                                                                                                                                                               |
+-------------------------------+---------+-----------+--------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
mysql> set @@tidb_opt_range_max_size = 1500;
Query OK, 0 rows affected (0.00 sec)
...
mysql> set @@tidb_opt_range_max_size = 100;
Query OK, 0 rows affected (0.00 sec)
