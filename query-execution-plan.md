...
title: 理解 TiDB 执行计划
category: reference
aliases: ['/docs-cn/v3.0/reference/performance/understanding-the-query-execution-plan/','/docs-cn/sql/understanding-the-query-execution-plan/']
---
...
使用 [bikeshare example database](https://github.com/pingcap/docs/blob/release-3.0/import-example-data.md):
