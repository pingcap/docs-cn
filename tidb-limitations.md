...
* Columns 最大限制可通过 [`table-column-count-limit`](/tidb-configuration-file.md#table-column-count-limit-从-v500-rc-版本开始引入) 修改。
* Indexs 最大限制可通过 [`index-limit`](/tidb-configuration-file.md#index-limit-从-v500-rc-版本开始引入) 修改。
