...
TiDB 扩展了以下内置函数和运算符的功能，因此这些函数和运算符也支持[向量数据类型](/vector-search-data-types.md)。
...
| [`<=>`](https://dev.mysql.com/doc/refman/8.0/en/comparison-operators.html#operator_equal-to)             | 空值安全相等比较符                           |
