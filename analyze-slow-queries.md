...
慢日志中的各个字段的说明可以参考慢查询日志中的[字段含义说明](/identify-slow-queries#%E5%AD%97%E6%AE%B5%E5%90%AB%E4%B9%89%E8%AF%B4%E6%98%8E)
...
这里我们假设 TiDB 的执行计划很优（不优的情况在[分析优化器问题](/analyze-slow-queries.md#分析优化器问题)这一节说明），但是执行上很慢；
