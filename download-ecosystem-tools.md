...
> **注意：**
>
> 下载链接中的 `{version}` 为 TiDB Lightning 的版本号。例如，`v5.3.4` 版本的下载链接为 `https://download.pingcap.org/tidb-toolkit-v5.3.4-linux-amd64.tar.gz`。
...
> **注意：**
>
> 下载链接中的 `{version}` 为 BR 的版本号。例如，`v5.3.4` 版本的下载链接为 `https://download.pingcap.org/tidb-toolkit-v5.3.4-linux-amd64.tar.gz`。
...
> **注意：**
>
> 下载链接中的 `{version}` 为 DM 的版本号。例如，`v5.3.4` 版本的下载链接为 `https://download.pingcap.org/dm-v5.3.4-linux-amd64.tar.gz`。可以通过 [DM Release](https://github.com/pingcap/tiflow/releases) 查看当前已发布版本。
...
> **注意：**
>
> - 下载链接中的 `{version}` 为 Dumpling 的版本号。例如，`v5.3.4` 版本的下载链接为 `https://download.pingcap.org/tidb-toolkit-v5.3.4-linux-amd64.tar.gz`。可以通过 [TiDB Release](https://github.com/pingcap/tidb/releases) 查看当前已发布版本。
...
> **注意：**
>
> 下载链接中的 `{version}` 为 TiDB 的版本号。例如，`v5.3.4` 版本的下载链接为 `https://download.pingcap.org/tidb-toolkit-v5.3.4-linux-amd64.tar.gz`。可以通过 [TiDB Releases](https://github.com/pingcap/tidb/releases) 查看当前已发布版本。
