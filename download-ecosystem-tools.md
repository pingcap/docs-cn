---
title: TiDB 工具下载
aliases: ['/docs-cn/v2.1/download-ecosystem-tools/','/docs-cn/v2.1/reference/tools/download/']
---
...
> **注意：**
>
> 下载链接中的 `{version}` 为 TiDB Lightning 的版本号。例如，`v2.1.15` 版本的下载链接为 `https://download.pingcap.org/tidb-toolkit-v2.1.15-linux-amd64.tar.gz`。
