...
使用 `CREATE RESOURCE GROUP` 创建资源组需要拥有 `SUPER` 或者 `RESOURCE_GROUP_ADMIN` 权限。

### ALTER RESOURCE GROUP

使用 `ALTER RESOURCE GROUP` 创建资源组需要拥有 `SUPER` 或者 `RESOURCE_GROUP_ADMIN` 权限。

### DROP RESOURCE GROUP

使用 `DROP RESOURCE GROUP` 创建资源组需要拥有 `SUPER` 或者 `RESOURCE_GROUP_ADMIN` 权限。
