...
* `RESTRICTED_REPLICA_WRITER_ADMIN` 允许权限拥有者在 TiDB 集群开启了只读模式的情况下不受影响地执行写入或更新操作，详见 [tidb_restricted_read_only 配置项](/system-variables.md#tidb_restricted_read_only)。
