...
| 8004 | A single transaction is too large. | See [here](/v3.0/faq/tidb.md#the-error-message-transaction-too-large-is-displayed) for the cause and solution.  |
| 8005 | Transactions in TiDB encounter write conflicts. | See [here](/v3.0/faq/tidb.md#troubleshoot) for the cause and solution. |
...
| 9500 | A single transaction is too large. | See [here](/v3.0/faq/tidb.md#the-error-message-transaction-too-large-is-displayed) for the solution. |
| 9007 | Transactions in TiKV encounter write conflicts. | See [here](/v3.0/faq/tidb.md#troubleshoot) for the cause and solution. |
