...
|-sf/-st|\<unix_socket> get listening sockets from a Unix socket|在启动后，在 pidlist中发送 FINISH 信号给 pid 。收到此信号的进程将等待所有会话在退出之前完成，即优雅停止服务。此选项必须最后指定，后跟任意数量的 pid，SIGTTOU 和 SIGUSR1 都被发送。|
