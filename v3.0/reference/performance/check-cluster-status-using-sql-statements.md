...
- [`TIDB_INDEXES`](/v3.0/reference/system-databases/information-schema.md#tidb-indexes-table)
- [`ANALYZE_STATUS`](/v3.0/reference/system-databases/information-schema.md#analyze-status-table)
- [`TIDB_HOT_REGIONS`](/v3.0/reference/system-databases/information-schema.md#tidb-hot-regions-table)
- [`TIKV_STORE_STATUS`](/v3.0/reference/system-databases/information-schema.md#tikv-store-status-table)
- [`TIKV_REGION_STATUS`](/v3.0/reference/system-databases/information-schema.md#tikv-region-status-table)
- [`TIKV_REGION_PEERS`](/v3.0/reference/system-databases/information-schema.md#tikv-region-peers-table)
...
- The feature of `SHOW ANALYZE STATUS` is the same with that of [the `ANALYZE_STATUS` table](/v3.0/reference/system-databases/information-schema.md#analyze-status-table).
