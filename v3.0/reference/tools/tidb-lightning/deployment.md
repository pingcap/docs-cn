...
使用 [`mydumper`](/v3.0/reference/tools/mydumper.md) 从 MySQL 导出数据，如下：
...
在[工具下载](/v3.0/reference/tools/download.md#tidb-lightning)页面下载 TiDB Lightning 安装包（需选择与 TiDB 集群相同的版本）。
