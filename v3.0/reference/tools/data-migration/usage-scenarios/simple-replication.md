...
- To satisfy replication Requirements #1-i, #1-ii and #1-iii, configure the [table routing rules](/v3.0/reference/tools/data-migration/features/overview.md#table-routing) as follows:
...
- To satisfy the replication Requirement #2-i, configure the [table routing rules](/v3.0/reference/tools/data-migration/features/overview.md#table-routing) as follows:
...
- To satisfy the replication Requirement #3, configure the [black and white lists](/v3.0/reference/tools/data-migration/features/overview.md#black-and-white-table-lists) as follows:
...
The complete replication task configuration is shown below. For more details, see [configuration explanations](/v3.0/reference/tools/data-migration/configure/task-configuration-file.md).
