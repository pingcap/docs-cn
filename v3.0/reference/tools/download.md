...
如需下载最新版本的 [TiDB-Binlog](/reference/tidb-binlog-overview.md) 或 [Lightning](/reference/tools/tidb-lightning/overview.md)，直接下载 TiDB 安装包即可，因为 TiDB-Binlog 和 Lightning 均包含在 TiDB 安装包中。
