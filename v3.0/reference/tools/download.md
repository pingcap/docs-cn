...
If you want to download the 3.0 version of [TiDB Binlog](/v3.0/reference/tools/tidb-binlog/overview.md), directly download the TiDB package, because TiDB Binlog is included in the TiDB package.
...
If you want to download the 3.0 version of [TiDB Lightning](/v3.0/reference/tools/tidb-lightning/overview.md), click the download link in the following table.
...
If you want to download the 1.0 GA version of [DM](/v3.0/reference/tools/data-migration/overview.md), click the download link in the following table.
...
If you want to download the latest version of [DM](/v3.0/reference/tools/data-migration/overview.md), click the download link in the following table. You can also check the [DM Release](https://github.com/pingcap/dm/releases) page.
...
If you want to download the latest version of [Syncer](/v3.0/reference/tools/syncer.md), [Loader](/v3.0/reference/tools/loader.md), or [Mydumper](/v3.0/reference/tools/mydumper.md), directly download the tidb-enterprise-tools package, because all these tools are included in this package.
...
- Loader
- Mydumper
- [binlogctl](/v3.0/reference/tools/tidb-binlog/overview.md#binlogctl-guide)
- ddl_checker
