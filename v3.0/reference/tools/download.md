...
If you want to download the latest version of [TiDB Binlog](/v3.0/reference/tidb-binlog/overview.md), directly download the TiDB package, because TiDB Binlog is included in the TiDB package.
