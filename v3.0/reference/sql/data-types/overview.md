...
TiDB supports all the data types in MySQL except the `SPATIAL` type.  This includes all the [numeric types](/v3.0/reference/sql/data-types/numeric.md), [string types](/v3.0/reference/sql/data-types/string.md), [date & time types](/v3.0/reference/sql/data-types/date-and-time.md), and [the JSON type](/v3.0/reference/sql/data-types/json.md).
