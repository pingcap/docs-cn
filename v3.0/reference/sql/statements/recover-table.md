...
For the above three situations, you can resume data replication from TiDB Binlog with a [full import of the deleted table](/v3.0/how-to/migrate/overview.md#full-data-migration-from-mysql).
