...
1. Use [binlogctl to change the state of this Pump instance to `offline`](/v3.0/reference/tidb-binlog/maintain.md) to discard the data of this Pump instance.
...
- If the checkpoint is not lost, perform the following steps:
    ...
    2. Use [binlogctl to change the state of the old Drainer to `offline`](/v3.0/reference/tidb-binlog/maintain.md).
