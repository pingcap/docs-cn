...
- 稳定性方面，显著提升了大规模集群的稳定性，集群支持 200+ 存储节点，400+TB 存储容量长期稳定运行。
- 易用性方面有显著的提升，降低用户运维成本，例如：标准化慢查询日志，制定日志文件输出规范，新增 `EXPLAIN ANALYZE` ，SQL Trace功能方便排查问题等。
- 性能方面，3.0 性能与 2.1 相比，TPC-C 性能提升约 4.5倍，Sysbench 性能提升约 1.8 倍，TPC-H 50G 性能提升约 5% ~120%。
...
+ Server
    ...
    - 新增 SQL 语句管理 Binlog 服务功能，包括查询状态，开启 Binlog，维护发送Binlog 策略
