...
+ SQL 执行引擎
    ...
    - 修复 Dump Pseudo Statistics 时，由于部分信息为 `nil` 导致 panic 的问题 [#11 460](https://github.com/pingcap/tidb/pull/11460)
...
+ DDL
    ...
    - 修复以下问题：
        ...
        - 修复 `ALTER TABLE … MODIFY COLUMN` 指定多次字符集和排序规则时，行为与 MySQL 不兼容的问题 [#11492](https://github.com/pingcap/tidb/pull/11492)
