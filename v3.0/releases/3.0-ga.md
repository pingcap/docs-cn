...
- Performance. TiDB 3.0 has approximately 4.5 times of performance improvements with TPC-C and 1.5 times with Sysbench. Thanks to the implementation of Views, TPC-H 50G Q5 and Q15 have both yielded normal results.
