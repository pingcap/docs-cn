...
+ Server
    ...
    - Support certificate-based authentication ([User document](/v3.0/reference/security/cert-based-authentication.md)) [#13955](https://github.com/pingcap/tidb/pull/13955)
+ Transaction
