...
- [使用 TiDB Operator 部署](/how-to/deploy/tidb-in-kubernetes/tidb-operator.md)：使用 TiDB Operator 在 Kubernetes 集群上部署生产就绪的 TiDB 集群，支持[部署到 AWS EKS](/how-to/deploy/tidb-in-kubernetes/aws-eks.md)、[部署到谷歌云 GKE (beta)](/how-to/deploy/tidb-in-kubernetes/gcp-gke.md)、[部署到阿里云 ACK](/how-to/deploy/tidb-in-kubernetes/alibaba-cloud.md) 等。
