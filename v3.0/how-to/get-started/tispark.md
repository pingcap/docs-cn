...
To make it easy to [try TiSpark](/v3.0/reference/tispark.md), the TiDB cluster installed using TiDB Ansible integrates Spark, TiSpark jar package and TiSpark sample data by default.
