---
title: TiDB 配置文件描述
aliases: ['/docs-cn/v2.1/tidb-configuration-file/','/docs-cn/v2.1/reference/configuration/tidb-server/configuration-file/']
---
...
>>>>>>> 076a8152... Update parameter type description (#5323)
