...
+ 默认值：
	+ 新部署的 v4.0.x 集群，该配置默认值为 1073741824
	+ 从 v3.0.x 升级至 v4.0.0 ~ v4.0.8 的集群，该配置默认值为 1073741824
	+ 从 v3.0.x 升级至 v4.0.9 及以上版本的集群，该配置保持 v3.0 中默认值（34359738368）
	+ 从 v4.0.9 以下（不含）版本升级至 v4.0.9 及以上版本，该配置保持升级前默认值
