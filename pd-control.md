...
>> store limit all engine tikv 5 remove-peer     // 设置所有的 tikv 删除 peer 的速度上限为每分钟 5 个
>> store limit all engine tiflash 5 remove-peer  // 设置所有的 tiflash 删除 peer 的速度上限为每分钟 5 个
```
