...
TiDB 在 V2.1.8 之后更改了慢日志格式，V2.1.8 之前的版本请看[这个文档](<https://github.com/pingcap/docs-cn/blob/master/v2.1/sql/slow-query.md>)。注：V2.1.8 版本中慢日志里面的字段信息比较少，部分下面提到的字段是新版本 3.0.0 加入的。
