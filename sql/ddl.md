...
[CREATE INDEX](#create-index-语法) 语句的作用是为一个已经存在的表创建一个索引。在功能上，[CREATE INDEX](#create-index-语法) 对应于 [ALTER TABLE](#alter-table-语法) 语句的创建索引功能。与 MySQL 一样 [CREATE INDEX](#create-index-语法) 不能创建主键索引。
...
* ***index_col_name*** 的 *ASC* 和 *DESC* 选项行为与 MySQL 一致，仅支持语法解析。详见 MySQL 的 [CREATE INDEX Syntax](https://dev.mysql.com/doc/refman/5.7/en/create-index.html) 章节。
