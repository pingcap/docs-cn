---
title: 位函数和操作符
aliases: ['/docs-cn/v2.1/functions-and-operators/bit-functions-and-operators/','/docs-cn/v2.1/reference/sql/functions-and-operators/bit-functions-and-operators/']
---
