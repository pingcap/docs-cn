---
title: 其他函数
aliases: ['/docs-cn/v3.0/functions-and-operators/miscellaneous-functions/','/docs-cn/v3.0/reference/sql/functions-and-operators/miscellaneous-functions/','/docs-cn/sql/miscellaneous-functions/']
---
