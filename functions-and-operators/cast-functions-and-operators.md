---
title: Cast 函数和操作符
aliases: ['/docs-cn/v3.0/functions-and-operators/cast-functions-and-operators/','/docs-cn/v3.0/reference/sql/functions-and-operators/cast-functions-and-operators/','/docs-cn/sql/cast-functions-and-operators/']
---
