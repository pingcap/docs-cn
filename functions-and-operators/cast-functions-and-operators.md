---
title: Cast 函数和操作符
aliases: ['/docs-cn/v3.1/functions-and-operators/cast-functions-and-operators/','/docs-cn/v3.1/reference/sql/functions-and-operators/cast-functions-and-operators/']
---
