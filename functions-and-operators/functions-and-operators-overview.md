---
title: 函数和操作符概述
aliases: ['/docs-cn/v3.0/functions-and-operators/functions-and-operators-overview/','/docs-cn/v3.0/reference/sql/functions-and-operators/reference/','/docs-cn/sql/functions-and-operators-reference/']
---
