---
title: GROUP BY 聚合函数
aliases: ['/docs-cn/v2.1/functions-and-operators/aggregate-group-by-functions/','/docs-cn/v2.1/reference/sql/functions-and-operators/aggregate-group-by-functions/']
---
