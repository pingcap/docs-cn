---
title: 数值函数与操作符
aliases: ['/docs-cn/v2.1/functions-and-operators/numeric-functions-and-operators/','/docs-cn/v2.1/reference/sql/functions-and-operators/numeric-functions-and-operators/']
---
