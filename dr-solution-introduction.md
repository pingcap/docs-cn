...
在上面的架构中包含了两个 TiDB 集群，Cluster1 为主用集群，运行在 Region 1，包含 3 个副本，承担读写业务。Cluster2 作为灾备集群，运行在 Region 2。当 Cluster1 出现灾难时，Cluster2 继续对外提供服务。两个集群之间通过 TiCDC 进行数据改变的同步。这种架构，我们简称为 “1:1” 解决方案。
