...
常规的升级集群请参考 [升级文档](https://github.com/pingcap/docs-cn/blob/master/tiup/tiup-cluster.md#%E5%8D%87%E7%BA%A7%E6%93%8D%E4%BD%9C)，但是在某些场景下（例如 Debug)，可能需要用一个临时的包替换正在运行的组件，此时可以用 patch 命令：
