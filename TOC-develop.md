...
- 连接到 TiDB
  ...
  - TiDB Cloud Serverless 驱动程序 ![PREVIEW](/media/tidb-cloud/blank_transparent_placeholder.png)
...
- [向量搜索](/develop/dev-guide-vector-search.md) ![PREVIEW](/media/tidb-cloud/blank_transparent_placeholder.png)
- 事务处理
