...
aliases: ['/docs-cn/v2.1/transaction-isolation-levels/','/docs-cn/v2.1/reference/transactions/transaction-isolation/']
---
...
> **注意：**
>
> 在 TiDB 2.1 中，事务的自动重试功能默认开启。关于该项功能对隔离级别的影响以及如何开启该项功能，请参考[事务重试](/optimistic-transaction.md#重试机制)。
