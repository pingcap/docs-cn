...
- 含有唯一性约束中“假设该 key 不存在”语义的悲观锁可以通过设置系统变量  [`tidb_constraint_check_in_place_pessimistic`](/system-variables.md#tidb_constraint_check_in_place_pessimistic) 控制是否跳过，详见[约束](/constraints.md#悲观事务)。
