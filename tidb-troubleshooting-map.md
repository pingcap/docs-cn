...
- 6.1.1 [TiDB Binlog](/tidb-binlog/tidb-binlog-overview.md)（从 v8.3.0 开始被废弃）是将 TiDB 的修改同步给下游 TiDB 或者 MySQL 的工具，见 [TiDB Binlog on GitHub](https://github.com/pingcap/tidb-binlog)。
