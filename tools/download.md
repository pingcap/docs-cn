...
如需下载最新版本的 [TiDB-Binlog](../tools/tidb-binlog-cluster.md) 或 [Lightning](../tools/lightning/overview-architecture.md)，直接下载 TiDB 安装包即可，因为 TiDB-Binlog 和 Lightning 均包含在 TiDB 安装包中。
...
如需下载最新版本的 [Syncer](../tools/syncer.md)，[Loader](../tools/loader.md) 或 [mydumper](../tools/mydumper.md)，直接下载 tidb-enterprise-tools 安装包即可，因为这些工具均包含在此安装包中。
