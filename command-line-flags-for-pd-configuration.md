---
title: PD 配置参数
aliases: ['/docs-cn/v3.0/command-line-flags-for-pd-configuration/','/docs-cn/v3.0/reference/configuration/pd-server/configuration/','/docs-cn/op-guide/pd-configuration/']
---
