...
![TiDB Connector for Spark architecture](../media/tispark-architecture.png)
...
+ The TiDB Connector for Spark runs in any Spark mode such as YARN, Mesos, and Standalone.


## Recommended configuration

### Deployment of TiKV and the TiDB Connector for Spark clusters
