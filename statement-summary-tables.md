...
- `SUM_UNPACKED_BYTES_SENT_TIFLASH_TOTAL`：SQL 语句向 TiFlash 发送的总字节数
- `SUM_UNPACKED_BYTES_RECEIVED_TIFLASH_TOTAL`：SQL 语句从 TiFlash 接收的总字节数
- `SUM_UNPACKED_BYTES_SENT_TIFLASH_CROSS_ZONE`：SQL 语句向跨可用区 TiFlash 发送的字节数
- `SUM_UNPACKED_BYTES_RECEIVED_TIFLASH_CROSS_ZONE`：SQL 语句从跨可用区 TiFlash 接收的字节数
