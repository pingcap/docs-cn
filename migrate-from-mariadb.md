...
TiDB 也不支持 `utf8mb4_uca1400_ai_ci`，该排序规则为最近的 MariaDB 版本默认使用的排序规则。请使用 `utf8mb4_0900_ai_ci`。这两个排序规则的区别在于，其使用的 [Unicode Collation Algorithm (UCA)](http://www.unicode.org/reports/tr10/) 版本不同：`utf8mb4_0900_ai_ci` 使用的是 UCA 9.0.0，而 `utf8mb4_uca1400_ai_ci` 使用的是 UCA 14.0.0。
