...
> 由于 TiKV、TiFlash 和 TiDB Binlog 组件的下线是异步的并且下线过程耗时较长，所以 TiUP 对 TiKV，TiFlash 和 TiDB Binlog 组件做了特殊处理，详情请参考 [下线特殊处理](/tiup/tiup-component-cluster-scale-in.md#下线特殊处理)。
