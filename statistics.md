...
|  系统变量名 | 默认值 | 功能描述 |
| --------- | ----- | --------- |
| [`tidb_auto_analyze_concurrency`](/system-variables.md#tidb_auto_analyze_concurrency-从-v840-版本开始引入) | `1` | TiDB 集群中自动统计信息收集操作的并发度 |
...
| [`tidb_max_auto_analyze_time`](/system-variables.md#tidb_max_auto_analyze_time-从-v610-版本开始引入) | `43200`，即 12 小时 | 自动 ANALYZE 的最大执行时间，单位为秒 |
