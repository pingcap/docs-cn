...
>
> - 当触发 GlobalStats 更新时，如果 [`tidb_skip_missing_partition_stats`](/system-variables.md#tidb_skip_missing_partition_stats-从-v730-版本开始引入) 打开：
> 
>     - 某些分区缺失全部或者部分列的统计信息，在生成 GlobalStats 的时候会把这些缺失的统计信息跳过。
>
