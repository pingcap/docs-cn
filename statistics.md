...
在 v5.0 之前，查询语句执行时，TiDB 会以 [`feedback-probability`](/tidb-configuration-file.md#feedback-probability) 的概率收集反馈信息，并将其用于更新直方图和 Count-Min Sketch。**在 v5.0 中，该功能默认关闭，暂不建议开启此功能。**
