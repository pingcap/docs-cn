...
+ 调整 PD 中热点均衡调度器使用 v1 或 v2 版本算法。详情参阅 [`scheduler config balance-hot-region-scheduler`](/pd-control.md#scheduler-config-balance-hot-region-scheduler)。（v6.2 实验特性）
