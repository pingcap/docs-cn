...
+ [Range INTERVAL 分区](/partitioned-table.md#range-interval-partitioning) （v6.3.0 实验特性）
+ [PARTITION BY RANGE COLUMNS (column_list)](/partitioned-table.md#range-columns-分区) （v6.3.0 实验特性）
