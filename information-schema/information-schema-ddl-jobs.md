---
title: DDL_JOBS
summary: 了解 information_schema 表 `DDL_JOBS`。Empty
---

# DDL_JOBS

`DDL_JOBS` 表为 [`ADMIN SHOW DDL JOBS`](/sql-statements/sql-statement-admin-show-ddl.md) 命令提供了一个 `INFORMATION_SCHEMA` 接口。它提供了 TiDB 集群中 DDL 操作的当前状态和简短历史记录。
