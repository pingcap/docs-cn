...
aliases: ['/docs-cn/dev/reference/system-databases/inspection-result/','/zh/tidb/dev/system-table-inspection-result/','/docs-cn/dev/system-tables/system-table-inspection-result/']
---
