...
aliases: ['/docs-cn/dev/reference/system-databases/metrics-summary/','/zh/tidb/dev/system-table-metrics-summary/','/docs-cn/dev/system-tables/system-table-metrics-summary/']
---
