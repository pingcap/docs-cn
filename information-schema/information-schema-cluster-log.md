...
aliases: ['/docs-cn/stable/system-tables/system-table-cluster-log/','/docs-cn/v4.0/system-tables/system-table-cluster-log/','/docs-cn/stable/reference/system-databases/cluster-log/','/zh/tidb/stable/system-table-cluster-log/','/docs-cn/stable/information-schema/information-schema-cluster-log/','/zh/tidb/v4.0/system-table-cluster-log/']
---
