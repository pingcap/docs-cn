...
## 从 v6.x 或 v7.x 升级至 v7.3，并且设置了 `storage.format_version = 5`，或者升级至 v7.4
...
从 v7.4 开始，TiFlash 的 DTFile 默认版本为 V3。

在 TiFlash 升级到 v7.3 并且使用了 V3 版本的 DTFile 或者升级到 v7.4后，如需回退到之前的 TiFlash 版本，可以通过 DTTool 离线将 DTFile 重新写回 V2 版本，详见 [DTTool 迁移工具](/tiflash/tiflash-command-line-flags.md#dttool-migrate)。