...
[^6]: 从 v8.3.0 开始，[TiDB Binlog](/tidb-binlog/tidb-binlog-overview.md) 被废弃，并计划在未来版本中移除。如需进行增量数据同步，请使用 [TiCDC](/ticdc/ticdc-overview.md)。如有 Point-in-Time Recovery (PITR) 场景的需求，请使用 [PITR](/br/br-pitr-guide.md)。
