...
本文列出了 TiDB 功能在各版本的支持变化情况。请注意，实验功能的支持可能会在最终版本发布前发生变化。
...
| [JSON 函数](/functions-and-operators/json-functions.md)                                             | 实验功能 | 实验功能 | 实验功能 | 实验功能 |
...
| [表达式索引](/sql-statements/sql-statement-create-index.md#表达式索引)                     | 实验功能 | 实验功能 | 实验功能 | 实验功能 |
...
| [用户自定义变量](/user-defined-variables.md)                                                     | 实验功能 | 实验功能 | 实验功能 | 实验功能 |
| **高级 SQL 功能**                                                                                | **5.2**      | **5.1**      | **5.0**      | **4.0**      |
| [执行计划缓存](/sql-prepare-plan-cache.md)                                                   | 实验功能 | 实验功能 | 实验功能 | 实验功能 |
| [执行计划管理 (SPM)](/sql-plan-management.md)                                                     | Y            | Y            | Y            | Y            |
| [下推计算结果缓存 (Coprocessor Cache)](/coprocessor-cache.md)                                                               | Y            | Y            | Y            | 实验功能 |
...
| [Index Merge Join](/explain-index-merge.md)                                                              | 实验功能 | 实验功能 | 实验功能 | 实验功能 |
| **数据定义语言 (DDL)**                                                                       | **5.2**      | **5.1**      | **5.0**      | **4.0**      |
| `CREATE`，`DROP`，`ALTER`，`RENAME`，`TRUNCATE`                                                    | Y            | Y            | Y            | Y            |
| [生成列](/generated-columns.md)                                                               | 实验功能 | 实验功能 | 实验功能 | 实验功能 |
| [试图](/views.md)                                                                                       | Y            | Y            | Y            | Y            |
...
| [扩展统计信息（多列）](/statistics.md)                                                 | 实验功能 | 实验功能 | 实验功能 | N            |
| [统计反馈](/statistics.md#自动更新)                                                   | 实验功能 | 实验功能 | 实验功能 | 实验功能 |
| [快速分析](/system-variables.md#tidb_enable_fast_analyze)                                            | 实验功能 | 实验功能 | 实验功能 | 实验功能 |
| **安全**                                                                                             | **5.2**      | **5.1**      | **5.0**      | **4.0**      |
...
| **管理，可视化诊断，工具**                                                                  | **5.2**      | **5.1**      | **5.0**      | **4.0**      |
| [TiDB Dashboard](/dashboard/dashboard-intro.md)                                                          | Y            | Y            | Y            | Y            |
| [SQL 诊断](/information-schema/information-schema-sql-diagnostics.md)                             | 实验功能 | 实验功能 | 实验功能 | 实验功能 |
...
| Top SQL                                                                                                  | Y            | N            | N            | N            |
| [Global Kill](/sql-statements/sql-statement-kill.md)                                                     | 实验功能 | 实验功能 | 实验功能 | 实验功能 |
| [Lock View](/information-schema/information-schema-data-lock-waits.md)                                   | Y            | 实验功能 | 实验功能 | 实验功能 |
