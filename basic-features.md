...
|----------------------------------------------------------------------------------------------------------|:------------:|:------------:|:------------:|:------------:|:------------:|:------------:|
| [数值类型](/data-type-numeric.md)                                                                   | Y           | Y            | Y            | Y            | Y            | Y            |
| [日期和时间类型](/data-type-date-and-time.md)                                                       | Y           | Y            | Y            | Y            | Y            | Y            |
| [字符串类型](/data-type-string.md)                                                                     | Y           | Y            | Y            | Y            | Y            | Y            |
| [JSON 类型](/data-type-json.md)                                                                          | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 |
| [控制流程函数](/functions-and-operators/control-flow-functions.md)                             | Y           | Y            | Y            | Y            | Y            | Y            |
| [字符串函数](/functions-and-operators/string-functions.md)                                         | Y           | Y            | Y            | Y            | Y            | Y            |
| [数值函数与操作符](/functions-and-operators/numeric-functions-and-operators.md)           | Y           | Y           | Y            | Y            | Y            | Y            |
| [日期和时间函数](/functions-and-operators/date-and-time-functions.md)                           | Y           | Y            | Y            | Y            | Y            | Y            |
| [位函数和操作符](/functions-and-operators/bit-functions-and-operators.md)                   | Y           | Y            | Y            | Y            | Y            | Y            |
| [Cast 函数和操作符](/functions-and-operators/cast-functions-and-operators.md)                 | Y           | Y            | Y            | Y            | Y            | Y            |
| [加密和压缩函数](/functions-and-operators/encryption-and-compression-functions.md) | Y           | Y            | Y            | Y            | Y            | Y            |
| [信息函数](/functions-and-operators/information-functions.md)                               | Y           | Y            | Y            | Y            | Y            | Y            |
| [JSON 函数](/functions-and-operators/json-functions.md)                                             | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 |
| [聚合函数](/functions-and-operators/aggregate-group-by-functions.md)                        | Y           | Y            | Y            | Y            | Y            | Y            |
| [窗口函数](/functions-and-operators/window-functions.md)                                         | Y           | Y            | Y            | Y            | Y            | Y            |
| [其他函数](/functions-and-operators/miscellaneous-functions.md)                           | Y           | Y            | Y            | Y            | Y            | Y            |
| [操作符](/functions-and-operators/operators.md)                                                       | Y           | Y            | Y            | Y            | Y            | Y            |
| [字符集和排序规则](/character-set-and-collation.md) [^1]                                    | Y           | Y            | Y            | Y            | Y            | Y            |
...
| [窗口函数](/functions-and-operators/window-functions.md)                                         | Y           | Y            | Y            | Y            | Y            | Y            |
| [公共表表达式 (CTE)](/sql-statements/sql-statement-with.md)                                  | Y           | Y            | Y            | Y            | N            | N            |
...
| [Follower Read](/follower-read.md)                                                                      | Y           | Y            | Y            | Y            | Y            | Y            |
...
| [生成列](/generated-columns.md)                                                               | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 |
| [视图](/views.md)                                                                                       | Y           | Y            | Y            | Y            | Y            | Y            |
| [序列](/sql-statements/sql-statement-create-sequence.md)                                            | Y           | Y            | Y            | Y            | Y            | Y            |
...
|----------------------------------------------------------------------------------------------------------|:------------:|:------------:|:------------:|:------------:|:------------:|:------------:|
| [Async commit](/system-variables.md#tidb_enable_async_commit-从-v50-版本开始引入)                                 | Y           | Y            | Y            | Y            | Y            | N            |
| [1PC](/system-variables.md#tidb_enable_1pc-从-v50-版本开始引入)                                                   | Y           | Y            | Y            | Y            | Y            | N            |
| [大事务 (10 GB)](/transaction-overview.md#事务限制)                             | Y           | Y            | Y            | Y            | Y            | Y            |
| [悲观事务](/pessimistic-transaction.md)                                                  | Y           | Y            | Y            | Y            | Y            | Y            |
| [乐观事务](/optimistic-transaction.md)                                                    | Y           | Y            | Y            | Y            | Y            | Y            |
| [可重复读隔离（快照隔离）](/transaction-isolation-levels.md)                       | Y           | Y            | Y            | Y            | Y            | Y            |
| [读已提交隔离](/transaction-isolation-levels.md)                                             | Y           | Y            | Y            | Y            | Y            | Y            |

## 分区

| 分区                                                                                         | 5.4       | 5.3          | 5.2          | 5.1      | 5.0      | 4.0      |
|----------------------------------------------------------------------------------------------------------|:------------:|:------------:|:------------:|:------------:|:------------:|:------------:|
| [Range 分区](/partitioned-table.md)                                                              | Y           | Y            | Y            | Y            | Y            | Y            |
| [Hash 分区](/partitioned-table.md)                                                               | Y           | Y            | Y            | Y            | Y            | Y            |
| [List 分区](/partitioned-table.md)                                                               | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 | N            |
| [List COLUMNS 分区](/partitioned-table.md)                                                       | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 | N            |
| [`EXCHANGE PARTITION`](/partitioned-table.md)                                                            | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 | N            |
| [动态裁剪](/partitioned-table.md#动态裁剪模式)                                            | 实验特性 | 实验特性 | 实验特性 | 实验特性 | N            | N            |
...
|----------------------------------------------------------------------------------------------------------|:------------:|:------------:|:------------:|:------------:|:------------:|:------------:|
| [传输层加密 (TLS)](/enable-tls-between-clients-and-servers.md)                           | Y           | Y            | Y            | Y            | Y            | Y            |
| [静态加密 (TDE)](/encryption-at-rest.md)                                                       | Y           | Y            | Y            | Y            | Y            | Y            |
| [基于角色的访问控制 (RBAC)](/role-based-access-control.md)                                        | Y           | Y            | Y            | Y            | Y            | Y            |
| [证书鉴权](/certificate-authentication.md)                                       | Y           | Y            | Y            | Y            | Y            | Y            |
| `caching_sha2_password` 认证                                                                   | Y           | Y            | Y            | N            | N            | N            |
| [与 MySQL 兼容的 `GRANT` 权限管理](/privilege-management.md)                                              | Y           | Y            | Y            | Y            | Y            | Y            |
| [动态权限](/privilege-management.md#动态权限)                                        | Y           | Y            | Y            | Y            | N            | N            |
| [安全增强模式](/system-variables.md#tidb_enable_enhanced_security)                             | Y           | Y            | Y            | Y            | N            | N            |
| [日志脱敏](/log-redaction.md)                                                                  | Y           | Y            | Y            | Y            | Y            | N            |
...
| [SQL 诊断](/information-schema/information-schema-sql-diagnostics.md)                             | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 |
...
| [慢查询日志](/identify-slow-queries.md)                                                              | Y           | Y            | Y            | Y            | Y            | Y            |
| [TiUP 部署](/tiup/tiup-overview.md)                                                                | Y           | Y            | Y            | Y            | Y            | Y            |
| Ansible 部署                                                                                       | N           | N            | N            | N            | N            | 已废弃   |
| [Kubernetes operator](https://docs.pingcap.com/tidb-in-kubernetes/stable)                                      | Y           | Y            | Y            | Y            | Y            | Y            |
| [内置物理备份](/br/backup-and-restore-use-cases.md)                                          | Y           | Y            | Y            | Y            | Y            | Y            |
