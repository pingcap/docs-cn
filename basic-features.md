...
| [非 Prepare 语句执行计划缓存](/sql-non-prepared-plan-cache.md) |  Y  | E | N | N | N | N | N | N | N | N |
...
| [TiFlash Pipeline 执行模型](/tiflash/tiflash-pipeline-model.md) |  Y  | N | N | N | N | N | N | N | N | N |
| [TiFlash 副本选择策略](/system-variables.md#tiflash_replica_read-从-v730-版本开始引入) |  Y  | N | N | N | N | N | N | N | N | N |
...
| [List 和 List COLUMNS 分区表的默认分区](/partitioned-table.md#默认的-list-分区) |  Y  | N | N | N | N | N | N | N | N | N |
...
| [分区表转换为非分区表](/partitioned-table.md#将分区表转换为非分区表) |  Y  | N | N | N | N | N | N | N | N | N |
| [对现有表进行分区](/partitioned-table.md#对现有表进行分区) |  Y  | N | N | N | N | N | N | N | N | N |
...
| [选择执行分布式框架任务的 TiDB 节点](/system-variables.md#tidb_service_scope-从-v740-版本开始引入) | E | N | N | N | N | N | N | N | N | N |
