...
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| [数值类型](/data-type-numeric.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [日期和时间类型](/data-type-date-and-time.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [字符串类型](/data-type-string.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [JSON 类型](/data-type-json.md) |  Y |  Y |  Y |  Y  | Y | Y | E | E | E | E | E |
| [控制流程函数](/functions-and-operators/control-flow-functions.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [字符串函数](/functions-and-operators/string-functions.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [数值函数与操作符](/functions-and-operators/numeric-functions-and-operators.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [日期和时间函数](/functions-and-operators/date-and-time-functions.md)|  Y  |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [位函数和操作符](/functions-and-operators/bit-functions-and-operators.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [Cast 函数和操作符](/functions-and-operators/cast-functions-and-operators.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [加密和压缩函数](/functions-and-operators/encryption-and-compression-functions.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [信息函数](/functions-and-operators/information-functions.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [JSON 函数](/functions-and-operators/json-functions.md) |  Y |  Y |  Y |  Y  | Y | Y | E | E | E | E | E |
| [聚合函数](/functions-and-operators/aggregate-group-by-functions.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [窗口函数](/functions-and-operators/window-functions.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [其他函数](/functions-and-operators/miscellaneous-functions.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [操作符](/functions-and-operators/operators.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [字符集和排序规则](/character-set-and-collation.md) [^1] |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [用户级别锁](/functions-and-operators/locking-functions.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | N | N | N | N |

## 索引和约束

| 索引和约束 | 8.3 | 8.2 | 8.1 | 7.5 | 7.1 | 6.5 | 6.1 | 5.4 | 5.3 | 5.2 | 5.1 |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| [表达式索引](/sql-statements/sql-statement-create-index.md#表达式索引) [^2] | Y | Y |  Y |  Y  | Y | Y | E | E | E | E | E |
| [列式存储 (TiFlash)](/tiflash/tiflash-overview.md) | Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [使用 FastScan 加速 OLAP 场景下的查询](/tiflash/use-fastscan.md) | Y |  Y |  Y |  Y  | Y | E | N | N | N | N | N |
| [RocksDB 引擎](/storage-engine/rocksdb-overview.md) | Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [Titan 插件](/storage-engine/titan-overview.md) | Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [Titan Level Merge](/storage-engine/titan-configuration.md#level-merge实验功能) | E | E |  E |  E  | E | E | E | E | E | E | E |
| [使用 bucket 提高数据扫描并发度](/tune-region-performance.md#使用-bucket-增加并发) | E |  E |  E |  E  | E | E | E | N | N | N | N |
| [不可见索引](/sql-statements/sql-statement-create-index.md#不可见索引) | Y | Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [复合主键](/constraints.md#主键约束) | Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [`CHECK` 约束](/constraints.md#check-约束) | Y |  Y |  Y |  Y  | N | N | N | N | N | N | N |
| [唯一约束](/constraints.md#唯一约束) | Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [整型主键上的聚簇索引](/clustered-indexes.md) | Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [复合或非整型主键上的聚簇索引](/clustered-indexes.md) | Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
...
| [用户自定义变量](/user-defined-variables.md) | E | E |  E |  E  | E | E | E | E | E | E | E |
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| [Prepare 语句执行计划缓存](/sql-prepared-plan-cache.md) | Y | Y |  Y  |  Y  | Y | Y | Y | Y | Y | E | E |
| [非 Prepare 语句执行计划缓存](/sql-non-prepared-plan-cache.md) | Y |  Y  |  Y  |  Y  | E | N | N | N | N | N | N |
| [执行计划绑定 (SQL Binding)](/sql-plan-management.md#执行计划绑定-sql-binding) | Y |  Y  |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [跨数据库执行计划绑定 (Cross-DB Binding)](/sql-plan-management.md#跨数据库绑定执行计划-cross-db-binding) | Y |  Y  |  Y  |  N  | N | N | N | N | N | N | N |
| [根据历史执行计划创建绑定](/sql-plan-management.md#根据历史执行计划创建绑定) | Y |  Y  |  Y  |  Y  | Y | E | N | N | N | N | N |
| [下推计算结果缓存 (Coprocessor Cache)](/coprocessor-cache.md) | Y |  Y  |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
...
| [MPP 执行引擎](/explain-mpp.md) | Y |  Y  |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [MPP 执行引擎 - compression exchange](/explain-mpp.md#mpp-version-和-exchange-数据压缩) | Y |  Y  |  Y  |  Y  | Y | N | N | N | N | N | N |
| [TiFlash Pipeline 执行模型](/tiflash/tiflash-pipeline-model.md) | Y |  Y  |  Y  |  Y  | N | N | N | N | N | N | N |
| [TiFlash 副本选择策略](/system-variables.md#tiflash_replica_read-从-v730-版本开始引入) | Y |  Y  |  Y  |  Y  | N | N | N | N | N | N | N |
| [索引合并](/explain-index-merge.md) | Y |  Y  |  Y  |  Y  | Y | Y | Y | Y | E | E | E |
| [基于 SQL 的数据放置规则](/placement-rules-in-sql.md) | Y |  Y  |  Y  |  Y  | Y | Y | Y | E | E | N | N |
...
| [更改列类型](/sql-statements/sql-statement-modify-column.md) |  Y  |  Y  |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [临时表](/temporary-tables.md) |  Y  |  Y  |  Y  |  Y  | Y | Y | Y | Y | Y | N | N |
| 并行 DDL |  Y  |  Y  |  Y  |  Y  | Y | Y | N | N | N | N | N |
| [添加索引加速](/system-variables.md#tidb_ddl_enable_fast_reorg-从-v630-版本开始引入) |  Y  |  Y  |  Y  |  Y  | Y | Y | N | N | N | N | N |
...
| [批量 DML 语句的执行方式 (`tidb_dml_type = "bulk"`)](/system-variables.md#tidb_dml_type-从-v800-版本开始引入) | E |  E | E |  E | N | N | N | N | N | N | N | N |

## 分区

| 分区 | 8.3 | 8.2 | 8.1 | 7.5 | 7.1 | 6.5 | 6.1 | 5.4 | 5.3 | 5.2 | 5.1 |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| [Range 分区](/partitioned-table.md#range-分区) |  Y |  Y  |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [Hash 分区](/partitioned-table.md#hash-分区) |  Y |  Y  |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [Key 分区](/partitioned-table.md#key-分区) |  Y |  Y  |  Y  |  Y  | Y | N | N | N | N | N | N |
| [List 分区](/partitioned-table.md#list-分区) |  Y |  Y  |  Y  |  Y  | Y | Y | Y | E | E | E | E |
| [List COLUMNS 分区](/partitioned-table.md#list-columns-分区) |  Y |  Y  |  Y  |  Y  | Y | Y | Y | E | E | E | E |
| [List 和 List COLUMNS 分区表的默认分区](/partitioned-table.md#默认的-list-分区) |  Y |  Y  |  Y  |  Y  | N | N | N | N | N | N | N |
| [`EXCHANGE PARTITION`](/partitioned-table.md) |  Y |  Y  |  Y  |  Y  | Y | Y | E | E | E | E | E |
| [`REORGANIZE PARTITION`](/partitioned-table.md#重组分区) |  Y |  Y  |  Y  |  Y  | Y | N | N | N | N | N | N |
| [`COALESCE PARTITION`](/partitioned-table.md#减少分区数量) |  Y |  Y  |  Y  |  Y  | Y | N | N | N | N | N | N |
| [动态裁剪](/partitioned-table.md#动态裁剪模式) |  Y |  Y  |  Y  |  Y  | Y | Y | Y | E | E | E | E |
| [Range COLUMNS 分区](/partitioned-table.md#range-columns-分区) |  Y |  Y  |  Y  |  Y  | Y | Y | N | N | N | N | N |
| [Range INTERVAL 分区](/partitioned-table.md#range-interval-分区) |  Y |  Y  |  Y  |  Y  | Y | E | N | N | N | N | N |
| [分区表转换为非分区表](/partitioned-table.md#将分区表转换为非分区表) |  Y |  Y  |  Y  |  Y  | N | N | N | N | N | N | N |
| [对现有表进行分区](/partitioned-table.md#对现有表进行分区) |  Y |  Y  |  Y  |  Y  | N | N | N | N | N | N | N |

## 统计信息

| 统计信息 | 8.3 | 8.2 | 8.1 | 7.5  | 7.1 | 6.5 | 6.1 | 5.4 | 5.3 | 5.2 | 5.1 |
|---|:----:|:----:|:----:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| [CM-Sketch](/statistics.md) | 默认关闭| 默认关闭| 默认关闭| 默认关闭 | 默认关闭 | 默认关闭 | 默认关闭 | 默认关闭 | 默认关闭 | Y | Y |
| [直方图](/statistics.md) |  Y  |  Y  |  Y  |  Y   | Y | Y | Y | Y | Y | Y | Y |
| [扩展统计信息](/extended-statistics.md) |  E  |  E  |  E  |  E   | E | E | E | E | E | E | E |
| 统计反馈 |  N  |  N  |  N  |  N   | N | N | 已废弃 | 已废弃 | E | E | E |
| [统计信息自动更新](/statistics.md#自动更新) |  Y  |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y | Y |
| [动态裁剪](/partitioned-table.md#动态裁剪模式) |  Y  |  Y   |  Y   |  Y   | Y | Y | Y | E | E | E | E |
| [收集部分列的统计信息](/statistics.md#收集部分列的统计信息) |  Y   |  E   |  E   |  E   | E | E | E | E | N | N | N |
| [限制统计信息的内存使用量](/statistics.md#统计信息收集的内存限制) |  E   |  E  |  E  |  E   | E | E | E | N | N | N | N |
| [随机采样约 10000 行数据来快速构建统计信息](/system-variables.md#tidb_enable_fast_analyze) | 已废弃 | 已废弃 | 已废弃 | 已废弃 | E | E | E | E | E | E | E |
| [锁定统计信息](/statistics.md#锁定统计信息) |  Y  |  Y  |  Y  |  Y   | E | E | N | N | N | N | N |
| [轻量级统计信息初始化](/statistics.md#加载统计信息) |  Y  |  Y  |  Y  |  Y   | E | N | N | N | N | N | N |
| [显示统计信息收集的进度](/sql-statements/sql-statement-show-analyze-status.md) |  Y  |  Y  |  Y  |  Y   | N | N | N | N | N | N | N |
...
| [`caching_sha2_password` 认证](/system-variables.md#default_authentication_plugin) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | N |
| [`tidb_sm3_password` 认证](/system-variables.md#default_authentication_plugin) |  Y |  Y |  Y |  Y  | Y | Y | N | N | N | N | N |
| [`tidb_auth_token` 认证](/security-compatibility-with-mysql.md#tidb_auth_token) |  Y |  Y |  Y |  Y  | Y | Y | N | N | N | N | N |
| [`authentication_ldap_sasl` 认证](/system-variables.md#default_authentication_plugin) |  Y |  Y |  Y |  Y  | Y | N | N | N | N | N | N |
| [`authentication_ldap_simple` 认证](/system-variables.md#default_authentication_plugin) |  Y |  Y |  Y |  Y  | Y | N | N | N | N | N | N |
| [密码管理](/password-management.md) |  Y |  Y |  Y |  Y  | Y | Y | N | N | N | N | N |
| [与 MySQL 兼容的 `GRANT` 权限管理](/privilege-management.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [动态权限](/privilege-management.md#动态权限) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [安全增强模式](/system-variables.md#tidb_enable_enhanced_security) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [日志脱敏](/log-redaction.md) |  Y |  Y |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
...
| [快速导入 (`IMPORT INTO`)](/sql-statements/sql-statement-import-into.md) | Y | Y | Y | Y | N | N | N | N | N | N | N |
...
| [DM](/dm/dm-overview.md) 支持迁移 MySQL 8.0  | Y | Y | Y | E | E | E | E | N | N | N | N |
...
| [TiDB Dashboard 持续性能分析功能](/dashboard/continuous-profiling.md) | Y | Y | Y | Y | Y | Y | Y | E | E | N | N |
| [TiDB Dashboard Top SQL 功能](/dashboard/top-sql.md) | Y | Y | Y | Y | Y | Y | Y | E | N | N | N |
| [TiDB Dashboard SQL 诊断功能](/information-schema/information-schema-sql-diagnostics.md) | Y | Y | Y | Y | Y | Y | E | E | E | E | E |
| [TiDB Dashboard 集群诊断功能](/dashboard/dashboard-diagnostics-access.md) | Y | Y | Y | Y | Y | Y | E | E | E | E | E |
| [Grafana 中的 TiKV-FastTune 面板](/grafana-tikv-dashboard.md#tikv-fasttune-面板) | E | E | E | E | E | E | E | E | E | E | E |
...
| [Statements summary tables - 持久化 statements summary](/statement-summary-tables.md#持久化-statements-summary) | E | E | E | E | E | N | N | N | N | N | N |
...
| [前台限流](/tikv-configuration-file.md#前台限流) | Y | Y | Y | Y | Y | Y | E | N | N | N | N |
| [后台限流](/tikv-configuration-file.md#后台限流) | E | E | E | E | E | E | N | N | N | N | N |
| [基于 EBS 的备份和恢复](https://docs.pingcap.com/zh/tidb-in-kubernetes/v1.4/volume-snapshot-backup-restore) | Y | Y | Y | Y | Y | Y | N | N | N | N | N |
| [PITR](/br/br-pitr-guide.md) | Y | Y | Y | Y | Y | Y | N | N | N | N | N |
| [全局内存控制](/configure-memory-usage.md#如何配置-tidb-server-实例使用内存的阈值) | Y | Y | Y | Y | Y | Y | N | N | N | N | N |
| [RawKV 跨集群复制](/tikv-configuration-file.md#api-version-从-v610-版本开始引入) | E | E | E | E| E | E | N | N | N | N | N |
| [Green GC](/system-variables.md#tidb_gc_scan_lock_mode-从-v50-版本开始引入) | E | E | E | E | E | E | E | E | E | E | E |
| [资源管控 (Resource Control)](/tidb-resource-control.md) | Y | Y | Y | Y | Y | N | N | N | N | N | N |
| [Runaway Queries 自动管理](/tidb-resource-control.md#管理资源消耗超出预期的查询-runaway-queries) | Y | Y | Y | E | N | N | N | N | N | N | N |
| [后台任务资源管控](/tidb-resource-control.md#管理后台任务) | E | E | E | E | N | N | N | N | N | N | N |
| [TiFlash 存算分离架构与 S3 支持](/tiflash/tiflash-disaggregated-and-s3.md) | Y | Y | Y | Y | E | N | N | N | N | N | N |
| [选择执行分布式执行框架任务的 TiDB 节点](/system-variables.md#tidb_service_scope-从-v740-版本开始引入) | Y | Y | Y | Y | N | N | N | N | N | N | N |
| 通过系统变量 [`tidb_enable_tso_follower_proxy`](/system-variables.md#tidb_enable_tso_follower_proxy-从-v530-版本开始引入) 控制 PD Follower Proxy 功能 | Y | Y | Y | Y | Y | Y | Y | Y | Y | N | N |
| 通过系统变量 [`pd_enable_follower_handle_region`](/system-variables.md#pd_enable_follower_handle_region-从-v760-版本开始引入) 控制 [Active PD Follower](/tune-region-performance.md#通过-active-pd-follower-提升-pd-region-信息查询服务的扩展能力) 功能 | E | E | E | N | N | N | N | N | N | N | N |
| [PD 微服务](/pd-microservices.md) | E | E | E | N | N | N | N | N | N | N | N |
| [TiDB 分布式执行框架](/tidb-distributed-execution-framework.md) | Y | Y | Y | Y | E | N | N | N | N | N | N |
| [全局排序](/tidb-global-sort.md) | Y | Y | Y | E | N | N | N | N | N | N | N |
