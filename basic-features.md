...
| 数据类型，函数，操作符                                                                     | 5.3          | 5.2          | 5.1          | 5.0          | 4.0          |
|----------------------------------------------------------------------------------------------------------|:------------:|:------------:|:------------:|:------------:|:------------:|
| [数值类型](/data-type-numeric.md)                                                                   | Y            | Y            | Y            | Y            | Y            |
| [日期和时间类型](/data-type-date-and-time.md)                                                       | Y            | Y            | Y            | Y            | Y            |
| [字符串类型](/data-type-string.md)                                                                     | Y            | Y            | Y            | Y            | Y            |
| [JSON 类型](/data-type-json.md)                                                                          | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 |
| [控制流程函数](/functions-and-operators/control-flow-functions.md)                             | Y            | Y            | Y            | Y            | Y            |
| [字符串函数](/functions-and-operators/string-functions.md)                                         | Y            | Y            | Y            | Y            | Y            |
| [数值函数与操作符](/functions-and-operators/numeric-functions-and-operators.md)           | Y            | Y            | Y            | Y            | Y            |
| [日期和时间函数](/functions-and-operators/date-and-time-functions.md)                           | Y            | Y            | Y            | Y            | Y            |
| [位函数和操作符](/functions-and-operators/bit-functions-and-operators.md)                   | Y            | Y            | Y            | Y            | Y            |
| [Cast 函数和操作符](/functions-and-operators/cast-functions-and-operators.md)                 | Y            | Y            | Y            | Y            | Y            |
| [加密和压缩函数](/functions-and-operators/encryption-and-compression-functions.md) | Y            | Y            | Y            | Y            | Y            |
| [信息函数](/functions-and-operators/information-functions.md)                               | Y            | Y            | Y            | Y            | Y            |
| [JSON 函数](/functions-and-operators/json-functions.md)                                             | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 |
| [聚合函数](/functions-and-operators/aggregate-group-by-functions.md)                        | Y            | Y            | Y            | Y            | Y            |
...
| 索引和约束                                                                             | 5.3          | 5.2          | 5.1      | 5.0      | 4.0      |
|----------------------------------------------------------------------------------------------------------|:------------:|:------------:|:------------:|:------------:|:------------:|
| [表达式索引](/sql-statements/sql-statement-create-index.md#表达式索引)                     | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 |
| [列式存储 (TiFlash)](/tiflash/tiflash-overview.md)                                               | Y            | Y            | Y            | Y            | Y            |
| [RocksDB 引擎](/storage-engine/rocksdb-overview.md)                                                    | Y            | Y            | Y            | Y            | Y            |
| [Titan 插件](/storage-engine/titan-overview.md)                                                        | Y            | Y            | Y            | Y            | Y            |
| [不可见索引](/sql-statements/sql-statement-add-index.md)                                          | Y            | Y            | Y            | Y            | N            |
| [复合主键](/constraints.md#主键约束)                                                               | Y            | Y            | Y            | Y            | Y            |
| [唯一约束](/constraints.md#唯一约束)                                                                        | Y            | Y            | Y            | Y            | Y            |
| [整型主键上的聚簇索引](/constraints.md)                                              | Y            | Y            | Y            | Y            | Y            |
| [复合或非整型主键上的聚簇索引](/constraints.md)                                       | Y            | Y            | Y            | Y            | N            |
...
| [表级锁 (Table Lock)](/sql-statements/sql-statement-lock-tables-and-unlock-tables.md)           | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 |
...
| [Follower Read](/follower-read.md)                                                                      | Y            | Y            | Y            | Y            | Y            |
| [通过系统变量 tidb_snapshot 读取历史数据](/read-historical-data.md)                                         | Y            | Y            | Y            | Y            | Y            |
| [Optimizer hints](/optimizer-hints.md)                                                                   | Y            | Y            | Y            | Y            | Y            |
| [MPP 执行引擎](/explain-mpp.md)                                                                   | Y            | Y            | Y            | Y            | N            |
| [索引合并](/explain-index-merge.md)                                                              | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 |
...
| 事务                                                                                         | 5.3          | 5.2          | 5.1      | 5.0      | 4.0      |
|----------------------------------------------------------------------------------------------------------|:------------:|:------------:|:------------:|:------------:|:------------:|
| [Async commit](/system-variables.md#tidb_enable_async_commit-从-v50-版本开始引入)                                 | Y            | Y            | Y            | Y            | N            |
| [1PC](/system-variables.md#tidb_enable_1pc-从-v50-版本开始引入)                                                   | Y            | Y            | Y            | Y            | N            |
| [大事务 (10 GB)](/transaction-overview.md#事务限制)                             | Y            | Y            | Y            | Y            | Y            |
| [悲观事务](/pessimistic-transaction.md)                                                  | Y            | Y            | Y            | Y            | Y            |
| [乐观事务](/optimistic-transaction.md)                                                    | Y            | Y            | Y            | Y            | Y            |
| [可重复读隔离（快照隔离）](/transaction-isolation-levels.md)                       | Y            | Y            | Y            | Y            | Y            |
| [读已提交隔离](/transaction-isolation-levels.md)                                             | Y            | Y            | Y            | Y            | Y            |

## 分区

| 分区                                                                                         | 5.3          | 5.2          | 5.1      | 5.0      | 4.0      |
|----------------------------------------------------------------------------------------------------------|:------------:|:------------:|:------------:|:------------:|:------------:|
| [Range 分区](/partitioned-table.md)                                                              | Y            | Y            | Y            | Y            | Y            |
| [Hash 分区](/partitioned-table.md)                                                               | Y            | Y            | Y            | Y            | Y            |
| [List 分区](/partitioned-table.md)                                                               | 实验特性 | 实验特性 | 实验特性 | 实验特性 | N            |
| [List COLUMNS 分区](/partitioned-table.md)                                                       | 实验特性 | 实验特性 | 实验特性 | 实验特性 | N            |
| [`EXCHANGE PARTITION`](/partitioned-table.md)                                                            | 实验特性 | 实验特性 | 实验特性 | 实验特性 | N            |
| [动态裁剪](/partitioned-table.md#动态裁剪模式)                                            | 实验特性 | 实验特性 | 实验特性 | N            | N            |
...
| 安全                                                                                             | 5.3          | 5.2          | 5.1      | 5.0      | 4.0      |
|----------------------------------------------------------------------------------------------------------|:------------:|:------------:|:------------:|:------------:|:------------:|
| [传输层加密 (TLS)](/enable-tls-between-clients-and-servers.md)                           | Y            | Y            | Y            | Y            | Y            |
...
| [日志脱敏](/log-redaction.md)                                                                  | Y            | Y            | Y            | Y            | N            |
...
| mydumper 逻辑导出                                                                                  | 已废弃   | 已废弃   | 已废弃   | 已废弃   | 已废弃   |
| [Dumpling 逻辑导出](/dumpling-overview.md)                                                         | Y            | Y            | Y            | Y            | Y            |
...
| [SQL 诊断](/information-schema/information-schema-sql-diagnostics.md)                             | 实验特性 | 实验特性 | 实验特性 | 实验特性 | 实验特性 |
