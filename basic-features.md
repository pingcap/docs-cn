...
| 数据类型，函数，操作符                                                             | 6.6 | 6.5 | 6.1 |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    |   4.0    |
| ---------------------------------------------------------------------------------- | :------:| :------- | :------: | :------: | :------: | :------: | :------: | :------: | :------: |
...
| 索引和约束                                                             | 6.6 | 6.5 | 6.1 |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    |   4.0    |
| ---------------------------------------------------------------------- | --- | --- | :------: | :------: | :------: | :------: | :------: | :------: | :------: |
...
| [使用 FastScan 加速 OLAP 场景下的查询](/develop/dev-guide-use-fastscan.md) | E | E | N | N | N | N | N | N | N |
...
| [外键约束](/constraints.md#外键约束) | Y | N | N | N | N | N | N | N |
...
| 高级 SQL 功能                                                       |   6.6   |   6.5   |   6.1   |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    | 4.0      |
| ------------------------------------------------------------------- | :------: | :------: | :------: | :------: | :------: | :------: | :------: | -------- | :------: |
| [执行计划缓存](/sql-prepared-plan-cache.md)                          |    Y    |    Y    |    Y    |    Y     |    Y     | E | E | E | E |
| [执行计划管理 (SPM)](/sql-plan-management.md)                       |    Y    |    Y    |    Y    |    Y     |    Y     |    Y     |    Y     |    Y     | Y        |
| [根据历史执行计划创建绑定](/sql-plan-management.md#根据历史执行计划创建绑定) | E | E | N | N | N | N | N | N | N |
...
| 数据定义语言 (DDL)                                           |   6.6   |   6.5   |   6.1   |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    |   4.0    |
| ------------------------------------------------------------ | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: |
...
| [TTL (Time to Live)](/time-to-live.md) |   E   |    E   |    N    |    N     |    N     |    N     |    N     |    N     |    N     |
...
| [并行 DDL](/system-variables.md#tidb_enable_concurrent_ddl-从-v620-版本开始引入)  |   Y   |    Y   |    N    |    N     |    N     |    N     |    N     |    N     |    N     |
...
| 事务                                                         | 6.6  | 6.5  | 6.1  | 5.4  | 5.3  | 5.2  | 5.1  | 5.0  | 4.0  |
| ------------------------------------------------------------ | ---- | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
...
| 统计信息                                                  |   6.6   |   6.5   |   6.1    |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    | 4.0      |
| --------------------------------------------------------- | :------: | :------: | :------: | :------: | :------: | :------: | :------: | -------- | :------: |
...
| 安全                                                         | 6.6  | 6.5  | 6.1  | 5.4  | 5.3  | 5.2  | 5.1  | 5.0  | 4.0  |
| ------------------------------------------------------------ | ---- | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
...
| [TiCDC 支持保存数据到存储服务 (S3/NFS/Azure Blob Storage)](/ticdc/ticdc-sink-to-cloud-storage.md)  |   E   |   E   |   N    |   N    |   N    |   N    |   N    |   N    |   N    |
| [TiCDC 支持在两个 TiDB 集群之间进行双向复制](/ticdc/ticdc-bidirectional-replication.md) | Y | Y | N | N | N | N | N | N | N |

## 管理，可视化和工具

| 管理，可视化和工具                                                          |   6.6   |   6.5    |   6.1    |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    | 4.0      |
|----------------------------------------------------------------------------| :------:| :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: |
