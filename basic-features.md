...
| [不可见索引](/sql-statements/sql-statement-create-index.md#不可见索引) | Y | Y | Y | Y | Y | Y | Y | Y | N |
...
| [`tidb_auth_token` 认证](/security-compatibility-with-mysql.md#tidb_auth_token) | Y | Y | N | N | N | N | N | N | N |
