...
| [字符串类型](/data-type-string.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [JSON 类型](/data-type-json.md) |  Y |  Y  | Y | Y | E | E | E | E | E |
| [控制流程函数](/functions-and-operators/control-flow-functions.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [字符串函数](/functions-and-operators/string-functions.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [数值函数与操作符](/functions-and-operators/numeric-functions-and-operators.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [日期和时间函数](/functions-and-operators/date-and-time-functions.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [位函数和操作符](/functions-and-operators/bit-functions-and-operators.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [Cast 函数和操作符](/functions-and-operators/cast-functions-and-operators.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [加密和压缩函数](/functions-and-operators/encryption-and-compression-functions.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [信息函数](/functions-and-operators/information-functions.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [JSON 函数](/functions-and-operators/json-functions.md) |  Y |  Y  | Y | Y | E | E | E | E | E |
| [聚合函数](/functions-and-operators/aggregate-group-by-functions.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [窗口函数](/functions-and-operators/window-functions.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [其他函数](/functions-and-operators/miscellaneous-functions.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [操作符](/functions-and-operators/operators.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [字符集和排序规则](/character-set-and-collation.md) [^1] |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [用户级别锁](/functions-and-operators/locking-functions.md) |  Y |  Y  | Y | Y | Y | N | N | N | N |

## 索引和约束

| 索引和约束 | 8.1 | 7.5 | 7.1 | 6.5 | 6.1 | 5.4 | 5.3 | 5.2 | 5.1 |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| [表达式索引](/sql-statements/sql-statement-create-index.md#表达式索引) [^2] |  Y |  Y  | Y | Y | E | E | E | E | E |
| [列式存储 (TiFlash)](/tiflash/tiflash-overview.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [使用 FastScan 加速 OLAP 场景下的查询](/tiflash/use-fastscan.md) |  Y |  Y  | Y | E | N | N | N | N | N |
| [RocksDB 引擎](/storage-engine/rocksdb-overview.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [Titan 插件](/storage-engine/titan-overview.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [Titan Level Merge](/storage-engine/titan-configuration.md#level-merge实验功能) |  E |  E  | E | E | E | E | E | E | E |
| [使用 bucket 提高数据扫描并发度](/tune-region-performance.md#使用-bucket-增加并发) |  E |  E  | E | E | E | N | N | N | N |
| [不可见索引](/sql-statements/sql-statement-create-index.md#不可见索引) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [复合主键](/constraints.md#主键约束) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [`CHECK` 约束](/constraints.md#check-约束) |  Y |  Y  | N | N | N | N | N | N | N |
| [唯一约束](/constraints.md#唯一约束) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [整型主键上的聚簇索引](/clustered-indexes.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [复合或非整型主键上的聚簇索引](/clustered-indexes.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [多值索引](/sql-statements/sql-statement-create-index.md#多值索引) |  Y |  Y  | Y | N | N | N | N | N | N |
| [外键约束](/constraints.md#外键约束) |  E |  E  | E | N | N | N | N | N | N |
| [TiFlash 延迟物化](/tiflash/tiflash-late-materialization.md) |  Y |  Y  | Y | N | N | N | N | N | N |
...
| [`EXCEPT` 和 `INTERSECT` 运算符](/functions-and-operators/set-operators.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| `GROUP BY`，`ORDER BY` |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [窗口函数](/functions-and-operators/window-functions.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [公共表表达式 (CTE)](/sql-statements/sql-statement-with.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
...
| [物化列式存储的查询结果](/tiflash/tiflash-results-materialization.md) |  Y |  Y  | Y | E | N | N | N | N | N |

## 高级 SQL 功能

| 高级 SQL 功能 | 8.1 | 7.5 | 7.1 | 6.5 | 6.1 | 5.4 | 5.3 | 5.2 | 5.1 |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| [Prepare 语句执行计划缓存](/sql-prepared-plan-cache.md) |  Y  |  Y  | Y | Y | Y | Y | Y | E | E |
| [非 Prepare 语句执行计划缓存](/sql-non-prepared-plan-cache.md) |  Y  |  Y  | E | N | N | N | N | N | N |
| [执行计划绑定 (SQL Binding)](/sql-plan-management.md#执行计划绑定-sql-binding) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [跨数据库执行计划绑定 (Cross-DB Binding)](/sql-plan-management.md#跨数据库绑定执行计划-cross-db-binding) |  Y  |  N  | N | N | N | N | N | N | N |
| [根据历史执行计划创建绑定](/sql-plan-management.md#根据历史执行计划创建绑定) |  Y  |  Y  | Y | E | N | N | N | N | N |
| [下推计算结果缓存 (Coprocessor Cache)](/coprocessor-cache.md) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [Stale Read](/stale-read.md) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [Follower Read](/follower-read.md) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
...
| [MPP 执行引擎](/explain-mpp.md) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [MPP 执行引擎 - compression exchange](/explain-mpp.md#mpp-version-和-exchange-数据压缩) |  Y  |  Y  | Y | N | N | N | N | N | N |
| [TiFlash Pipeline 执行模型](/tiflash/tiflash-pipeline-model.md) |  Y  |  Y  | N | N | N | N | N | N | N |
| [TiFlash 副本选择策略](/system-variables.md#tiflash_replica_read-从-v730-版本开始引入) |  Y  |  Y  | N | N | N | N | N | N | N |
| [索引合并](/explain-index-merge.md) |  Y  |  Y  | Y | Y | Y | Y | E | E | E |
| [基于 SQL 的数据放置规则](/placement-rules-in-sql.md) |  Y  |  Y  | Y | Y | Y | E | E | N | N |
...
| [更改列类型](/sql-statements/sql-statement-modify-column.md) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [临时表](/temporary-tables.md) |  Y  |  Y  | Y | Y | Y | Y | Y | N | N |
| 并行 DDL |  Y  |  Y  | Y | Y | N | N | N | N | N |
| [添加索引加速](/system-variables.md#tidb_ddl_enable_fast_reorg-从-v630-版本开始引入) |  Y  |  Y  | Y | Y | N | N | N | N | N |
...
| [暂停](/sql-statements/sql-statement-admin-pause-ddl.md)/[恢复](/sql-statements/sql-statement-admin-resume-ddl.md) DDL |  Y  | Y | N | N | N | N | N | N | N |
| [TiDB 加速建表](/accelerated-table-creation.md) | E | N | N | N | N | N | N | N | N |
| [设置 BDR Role 用于 TiCDC 双向同步时同步 DDL](/sql-statements/sql-statement-admin-bdr-role.md#admin-setshowunset-bdr-role) | E | N | N | N | N | N | N | N | N |

## 事务

| 事务 | 8.1 | 7.5 | 7.1 | 6.5 | 6.1 | 5.4 | 5.3 | 5.2 | 5.1 |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| [Async commit](/system-variables.md#tidb_enable_async_commit-从-v50-版本开始引入) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [1PC](/system-variables.md#tidb_enable_1pc-从-v50-版本开始引入) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [大事务 (10 GB)](/transaction-overview.md#事务限制) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [悲观事务](/pessimistic-transaction.md) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [乐观事务](/optimistic-transaction.md) |  Y  |  Y  | Y | Y | Y | Y | Y | Y | Y |
...
| [Key 分区](/partitioned-table.md#key-分区) |  Y  |  Y  | Y | N | N | N | N | N | N |
| [List 分区](/partitioned-table.md#list-分区) |  Y  |  Y  | Y | Y | Y | E | E | E | E |
| [List COLUMNS 分区](/partitioned-table.md#list-columns-分区) |  Y  |  Y  | Y | Y | Y | E | E | E | E |
| [List 和 List COLUMNS 分区表的默认分区](/partitioned-table.md#默认的-list-分区) |  Y  |  Y  | N | N | N | N | N | N | N |
| [`EXCHANGE PARTITION`](/partitioned-table.md) |  Y  |  Y  | Y | Y | E | E | E | E | E |
| [`REORGANIZE PARTITION`](/partitioned-table.md#重组分区) |  Y  |  Y  | Y | N | N | N | N | N | N |
| [`COALESCE PARTITION`](/partitioned-table.md#减少分区数量) |  Y  |  Y  | Y | N | N | N | N | N | N |
| [动态裁剪](/partitioned-table.md#动态裁剪模式) |  Y  |  Y  | Y | Y | Y | E | E | E | E |
| [Range COLUMNS 分区](/partitioned-table.md#range-columns-分区) |  Y  |  Y  | Y | Y | N | N | N | N | N |
| [Range INTERVAL 分区](/partitioned-table.md#range-interval-分区) |  Y  |  Y  | Y | E | N | N | N | N | N |
| [分区表转换为非分区表](/partitioned-table.md#将分区表转换为非分区表) |  Y  |  Y  | N | N | N | N | N | N | N |
| [对现有表进行分区](/partitioned-table.md#对现有表进行分区) |  Y  |  Y  | N | N | N | N | N | N | N |
...
| [基于角色的访问控制 (RBAC)](/role-based-access-control.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [证书鉴权](/certificate-authentication.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [`caching_sha2_password` 认证](/system-variables.md#default_authentication_plugin) |  Y |  Y  | Y | Y | Y | Y | Y | Y | N |
| [`tidb_sm3_password` 认证](/system-variables.md#default_authentication_plugin) |  Y |  Y  | Y | Y | N | N | N | N | N |
| [`tidb_auth_token` 认证](/security-compatibility-with-mysql.md#tidb_auth_token) |  Y |  Y  | Y | Y | N | N | N | N | N |
| [`authentication_ldap_sasl` 认证](/system-variables.md#default_authentication_plugin) |  Y |  Y  | Y | N | N | N | N | N | N |
| [`authentication_ldap_simple` 认证](/system-variables.md#default_authentication_plugin) |  Y |  Y  | Y | N | N | N | N | N | N |
| [密码管理](/password-management.md) |  Y |  Y  | Y | Y | N | N | N | N | N |
| [与 MySQL 兼容的 `GRANT` 权限管理](/privilege-management.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [动态权限](/privilege-management.md#动态权限) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [安全增强模式](/system-variables.md#tidb_enable_enhanced_security) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
| [日志脱敏](/log-redaction.md) |  Y |  Y  | Y | Y | Y | Y | Y | Y | Y |
...
| [快速导入 (`IMPORT INTO`)](/sql-statements/sql-statement-import-into.md) | Y | Y | N | N | N | N | N | N | N |
| mydumper 逻辑导出 | 已废弃 | 已废弃 | 已废弃 | 已废弃 | 已废弃 | 已废弃 | 已废弃 | 已废弃 | 已废弃 |
| [Dumpling 逻辑导出](/dumpling-overview.md) | Y | Y | Y | Y | Y | Y | Y | Y | Y |
| [事务 `LOAD DATA`](/sql-statements/sql-statement-load-data.md) [^5] | Y | Y | Y | Y | Y | Y | Y | Y | Y |
...
| [TiCDC 支持保存数据到存储服务 (Amazon S3/GCS/Azure Blob Storage/NFS)](/ticdc/ticdc-sink-to-cloud-storage.md) | Y | Y | Y | E | N | N | N | N | N |
| [TiCDC 支持在两个 TiDB 集群之间进行双向复制](/ticdc/ticdc-bidirectional-replication.md) | Y | Y | Y | Y | N | N | N | N | N |
| [TiCDC OpenAPI v2](/ticdc/ticdc-open-api-v2.md) | Y | Y | Y | N | N | N | N | N | N |
| [DM](/dm/dm-overview.md) 支持迁移 MySQL 8.0  | Y | E | E | E | E | N | N | N | N |
...
| [TiDB Dashboard 持续性能分析功能](/dashboard/continuous-profiling.md) | Y | Y | Y | Y | Y | E | E | N | N |
| [TiDB Dashboard Top SQL 功能](/dashboard/top-sql.md) | Y | Y | Y | Y | Y | E | N | N | N |
| [TiDB Dashboard SQL 诊断功能](/information-schema/information-schema-sql-diagnostics.md) | Y | Y | Y | Y | E | E | E | E | E |
| [TiDB Dashboard 集群诊断功能](/dashboard/dashboard-diagnostics-access.md) | Y | Y | Y | Y | E | E | E | E | E |
| [Grafana 中的 TiKV-FastTune 面板](/grafana-tikv-dashboard.md#tikv-fasttune-面板) | E | E | E | E | E | E | E | E | E |
...
| [Statements summary tables - 持久化 statements summary](/statement-summary-tables.md#持久化-statements-summary) | E | E | E | N | N | N | N | N | N |
...
| [前台限流](/tikv-configuration-file.md#前台限流) | Y | Y | Y | Y | E | N | N | N | N |
| [后台限流](/tikv-configuration-file.md#后台限流) | E | E | E | E | N | N | N | N | N |
| [基于 EBS 的备份和恢复](https://docs.pingcap.com/zh/tidb-in-kubernetes/v1.4/volume-snapshot-backup-restore) | Y | Y | Y | Y | N | N | N | N | N |
| [PITR](/br/br-pitr-guide.md) | Y | Y | Y | Y | N | N | N | N | N |
| [全局内存控制](/configure-memory-usage.md#如何配置-tidb-server-实例使用内存的阈值) | Y | Y | Y | Y | N | N | N | N | N |
| [RawKV 跨集群复制](/tikv-configuration-file.md#api-version-从-v610-版本开始引入) | E | E| E | E | N | N | N | N | N |
| [Green GC](/system-variables.md#tidb_gc_scan_lock_mode-从-v50-版本开始引入) | E | E | E | E | E | E | E | E | E |
| [资源管控 (Resource Control)](/tidb-resource-control.md) | Y | Y | Y | N | N | N | N | N | N |
| [Runaway Queries 自动管理](/tidb-resource-control.md#管理资源消耗超出预期的查询-runaway-queries) | Y | E | N | N | N | N | N | N | N |
| [后台任务资源管控](/tidb-resource-control.md#管理后台任务) | E | E | N | N | N | N | N | N | N |
| [TiFlash 存算分离架构与 S3 支持](/tiflash/tiflash-disaggregated-and-s3.md) | Y | Y | E | N | N | N | N | N | N |
