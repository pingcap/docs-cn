...
| 数据类型，函数，操作符                                                             | 6.5 | 6.1 |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    |   4.0    |
| ---------------------------------------------------------------------------------- | :------:| :------- | :------: | :------: | :------: | :------: | :------: | :------: |
| [数值类型](/data-type-numeric.md)                                                |   Y  |   Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [日期和时间类型](/data-type-date-and-time.md)                                      |   Y  |  Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [字符串类型](/data-type-string.md)                                               |   Y  |   Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [JSON 类型](/data-type-json.md)                                                  |   Y  | E | E | E | E | E | E | E |
| [控制流程函数](/functions-and-operators/control-flow-functions.md)                 |   Y  |   Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [字符串函数](/functions-and-operators/string-functions.md)                         |   Y  |   Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [数值函数与操作符](/functions-and-operators/numeric-functions-and-operators.md)    |   Y  |   Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [日期和时间函数](/functions-and-operators/date-and-time-functions.md)              |   Y  |   Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [位函数和操作符](/functions-and-operators/bit-functions-and-operators.md)         |   Y   |   Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [Cast 函数和操作符](/functions-and-operators/cast-functions-and-operators.md)      |   Y  |   Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [加密和压缩函数](/functions-and-operators/encryption-and-compression-functions.md) |   Y  |   Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [信息函数](/functions-and-operators/information-functions.md)                      |   Y  |   Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [JSON 函数](/functions-and-operators/json-functions.md)                            |   Y  | E | E | E | E | E | E | E |
| [聚合函数](/functions-and-operators/aggregate-group-by-functions.md)              |   Y  | Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [窗口函数](/functions-and-operators/window-functions.md)                           |   Y  | Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [其他函数](/functions-and-operators/miscellaneous-functions.md)                    |   Y  |  Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [操作符](/functions-and-operators/operators.md)                                    |   Y  |  Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [字符集和排序规则](/character-set-and-collation.md) [^1]                           |   Y  |  Y  |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [用户级别锁](/functions-and-operators/locking-functions.md) |   Y  | Y | N | N | N | N | N | N |

## 索引和约束

| 索引和约束                                                             | 6.5 | 6.1 |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    |   4.0    |
| ---------------------------------------------------------------------- | --- | --- | :------: | :------: | :------: | :------: | :------: | :------: |
...
| [使用 bucket 提高数据扫描并发度](/tune-region-performance.md#使用-bucket-增加并发) | E | E | N | N | N | N | N | N |
| [不可见索引](/sql-statements/sql-statement-add-index.md)               |  Y   |  Y    |    Y     |    Y     |    Y     |    Y     |    Y     |    N     |
| [复合主键](/constraints.md#主键约束)                                   |  Y   |  Y    |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [唯一约束](/constraints.md#唯一约束)                                   |  Y   |  Y    |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [整型主键上的聚簇索引](/constraints.md)                                |  Y   |  Y    |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [复合或非整型主键上的聚簇索引](/constraints.md)                        |  Y   |  Y    |    Y     |    Y     |    Y     |    Y     |    Y     |    N     |
...
| [表级锁 (Table Lock)](/tidb-configuration-file.md#enable-table-lock-从-v400-版本开始引入) | E | E | E | E | E | E | E | E |
| [物化列式存储的查询结果](/tiflash/tiflash-results-materialization.md) | E | N | N | N | N | N | N | N |

## 高级 SQL 功能

| 高级 SQL 功能                                                       |   6.5   |   6.1   |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    | 4.0      |
| ------------------------------------------------------------------- | :------: | :------: | :------: | :------: | :------: | :------: | :------: | -------- |
| [执行计划缓存](/sql-prepared-plan-cache.md)                          |    Y    |    Y    |    Y     |    Y     | E | E | E | E |
| [执行计划管理 (SPM)](/sql-plan-management.md)                       |    Y    |    Y    |    Y     |    Y     |    Y     |    Y     |    Y     | Y        |
| [根据历史执行计划创建绑定](/sql-plan-management.md#根据历史执行计划创建绑定) | E | N | N | N | N | N | N | N |
| [下推计算结果缓存 (Coprocessor Cache)](/coprocessor-cache.md)       |    Y    |    Y    |    Y     |    Y     |    Y     |    Y     |    Y     | E |
...
| [索引合并](/explain-index-merge.md)                                 |    Y    |    Y    |    Y     | E | E | E | E | E |
| [基于 SQL 的数据放置规则](/placement-rules-in-sql.md)                |    Y    |    Y    | E | E |    N     |    N     |    N     | N        |
| [Cascades Planner](/system-variables.md#tidb_enable_cascades_planner) | E | E | E | E | E | E | E | E |

## 数据定义语言 (DDL)

| 数据定义语言 (DDL)                                           |   6.5   |   6.1   |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    |   4.0    |
| ------------------------------------------------------------ | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: |
| `CREATE`，`DROP`，`ALTER`，`RENAME`，`TRUNCATE`              |    Y   |    Y    |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     |
| [生成列](/generated-columns.md)                              | E | E | E | E | E | E | E | E |
...
| 事务                                                         | 6.5  | 6.1  | 5.4  | 5.3  | 5.2  | 5.1  | 5.0  | 4.0  |
| ------------------------------------------------------------ | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
...
| 分区                                             | 6.5 | 6.1 | 5.4          |   5.3    |   5.2    |   5.1    |   5.0    | 4.0 |
| ------------------------------------------------------------ | :--: | :--: | ------------ | :----------: | :----------: | :----------: | :----------: | :-----: |
| [Range 分区](/partitioned-table.md)                  | Y | Y | Y            |      Y       |      Y       |      Y       |      Y       |    Y    |
| [Hash 分区](/partitioned-table.md)                   | Y  | Y | Y            |      Y       |      Y       |      Y       |      Y       |    Y    |
| [List 分区](/partitioned-table.md)                   | Y | Y | E | E | E | E | E |    N    |
| [List COLUMNS 分区](/partitioned-table.md)           | Y | Y | E | E | E | E | E |    N    |
| [`EXCHANGE PARTITION`](/partitioned-table.md)               | Y  | E | E | E | E | E | E |    N    |
| [动态裁剪](/partitioned-table.md#动态裁剪模式) | Y | Y | E | E | E | E |      N       |    N    |
| [Range COLUMNS 分区](/partitioned-table.md#range-columns-分区) | Y | N | N | N |N | N | N |      N       |
| [Range INTERVAL 分区](/partitioned-table.md#range-interval-分区) | E | N | N | N |N | N | N |      N       |

## 统计信息

| 统计信息                                                  |   6.5   |   6.1    |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    | 4.0      |
| --------------------------------------------------------- | :------: | :------: | :------: | :------: | :------: | :------: | :------: | -------- |
...
| [随机采样约 10000 行数据来快速构建统计信息](/system-variables.md#tidb_enable_fast_analyze) | E | E | E | E | E | E | E | E |
| [锁定统计信息](/statistics.md#锁定统计信息) | E | N | N | N | N | N | N | N |

## 安全

| 安全                                                         | 6.5  | 6.1  | 5.4  | 5.3  | 5.2  | 5.1  | 5.0  | 4.0  |
| ------------------------------------------------------------ | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
...
| 数据导入和导出                                                          |  6.5  |  6.1  |  5.4   |  5.3   |  5.2   |  5.1   |  5.0   |  4.0   |
| ----------------------------------------------------------------------- | :----: | :----: | :----: | :----: | :----: | :----: | :----: | :----: |
...
| 管理，可视化和工具                                                          |   6.5    |   6.1    |   5.4    |   5.3    |   5.2    |   5.1    |   5.0    | 4.0      |
|----------------------------------------------------------------------------| :------:| :------: | :------: | :------: | :------: | :------: | :------: | :------: |
| [TiDB Dashboard 图形化展示](/dashboard/dashboard-intro.md)                  |    Y    |    Y     |    Y     |    Y     |    Y     |    Y     |    Y     | Y        |
| [TiDB Dashboard 持续性能分析功能](/dashboard/continuous-profiling.md)       |    Y    |    Y     | E | E |    N     |    N     |    N     | N        |
| [TiDB Dashboard Top SQL 功能](/dashboard/top-sql.md)                       |    Y    |    Y     | E |    N     |    N     |    N     |    N     | N        |
| [TiDB Dashboard SQL 诊断功能](/information-schema/information-schema-sql-diagnostics.md)    |    Y    | E | E | E | E | E | E | E |
| [TiDB Dashboard 集群诊断功能](/dashboard/dashboard-diagnostics-access.md)   |    Y    | E | E | E | E | E | E | E |
| [Grafana 中的 TiKV-FastTune 面板](/grafana-tikv-dashboard.md#tikv-fasttune-面板) |    E    |    E     |    E     |    E     |    E     |    E     |    E     | E        |
...
| [PITR](/br/br-pitr-guide.md)   |    Y    |    N    |    N     |    N     |    N     |    N     |    N     |  N        |
| [全局内存控制](/configure-memory-usage.md#如何配置-tidb-server-实例使用内存的阈值)   |    Y    |    N    |    N     |    N     |    N     |    N     |    N     |  N        |
| [RawKV 跨集群复制](/tikv-configuration-file.md#api-version-从-v610-版本开始引入) | E | N | N | N | N | N | N | N |
| [Green GC](/system-variables.md#tidb_gc_scan_lock_mode-从-v50-版本开始引入) | E | E | E | E | E | E | E | N |
