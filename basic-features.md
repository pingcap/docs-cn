...
| [向量数据类型](https://docs.pingcap.com/ai/vector-search-data-types) |  E |  N |  N  | N | N | N | N |
...
| [向量函数和操作符](https://docs.pingcap.com/ai/vector-search-functions-and-operators) |  E |  N |  N  | N | N | N | N |
...
| [向量索引](https://docs.pingcap.com/ai/vector-search-index) |  E |  N |  N  | N | N | N | N |
