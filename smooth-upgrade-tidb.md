...
| v7.1.0                 	| v7.1.1、v7.2.0 或 v7.3.0 	| 无需额外操作，自动支持平滑升级                                                                                                                                	|
| v7.1.1                 	| v7.2.0 或 v7.3.0         	| 无需额外操作，自动支持平滑升级                                                                                                                                	|
| v7.2.0                 	| v7.3.0                   	| 无需额外操作，自动支持平滑升级                                                                                                                                	|
| >= v7.1.2              	| >= v7.1.2                	| 通过发送 `/upgrade/start` HTTP 请求支持平滑升级，具体方式有两种：[TiUP 方式](/smooth-upgrade-tidb.md#tiup-方式)；[其它方式](/smooth-upgrade-tidb.md#其它方式) 	|
| >= v7.1.2 或 >= v7.4.0 	| >= v7.4.0                	| 通过发送 `/upgrade/start` HTTP 请求支持平滑升级，具体方式有两种：[TiUP 方式](/smooth-upgrade-tidb.md#tiup-方式)；[其它方式](/smooth-upgrade-tidb.md#其它方式) 	|
