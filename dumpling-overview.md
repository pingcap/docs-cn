...
| --tidb-mem-quota-query | 单条 dumpling 命令导出 SQL 语句的内存限制，单位为 byte。v4.0.10 及以上版本，若不设置该参数，默认使用 TiDB 中的 mem-quota-query 做为内存限制值。v4.0.10 以下版本，参数值默认为 32 GB | 34359738368 |
