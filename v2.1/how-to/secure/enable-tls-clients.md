...
- [`ssl-cert`](v2.1/reference/configuration/tidb-server/configuration-file.md#ssl-cert)：指定 SSL 证书文件路径
- [`ssl-key`](v2.1/reference/configuration/tidb-server/configuration-file.md#ssl-key)：指定证书文件对应的私钥
- [`ssl-ca`](v2.1/reference/configuration/tidb-server/configuration-file.md#ssl-ca)：可选，指定受信任的 CA 证书文件路径
