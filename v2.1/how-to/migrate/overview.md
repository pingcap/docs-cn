...
- [`mydumper`](/v2.1/reference/tools/mydumper.md) exports data from MySQL. It is recommended over using mysqldump.
- [`loader`](/v2.1/reference/tools/loader.md) imports data in Mydumper format into TiDB.
- [`syncer`](/v2.1/reference/tools/syncer.md) acts like a MySQL replication slave and pushes data from MySQL into TiDB.
- [DM](/v2.1/reference/tools/data-migration/overview.md) (Data Migration) integrates the functions of Mydumper, Loader and syncer to support the export and import of full-size data, as well as incremental replication of MySQL Binlog data, and supports data replication of a more complete pooled table scenario.
- [TiDB Lightning](/v2.1/reference/tools/tidb-lightning/overview.md) imports data to TiDB in an optimized way. For example, a 1TiB backup could take 24+ hours to import with loader, while it will typically complete at least 3 times faster in TiDB Lightning.
...
For detailed operations, follow the steps in [Migrate Data from MySQL to TiDB](/v2.1/how-to/migrate/from-mysql.md).
...
For detailed operations, follow the steps in [Incremental Migration](/v2.1/how-to/migrate/incrementally-from-mysql.md).
...
For more information, refer to [CSV support for TiDB Lightning](/v2.1/reference/tools/tidb-lightning/csv.md).
