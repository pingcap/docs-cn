...
**Cause**: [Checkpoint](/v2.1/reference/tools/tidb-lightning/checkpoints.md) is enabled, and Lightning or Importer has previously abnormally exited. To prevent accidental data corruption, Lightning will not start until the error is addressed.
...
See the [Checkpoints control](/v2.1/reference/tools/tidb-lightning/checkpoints.md#checkpoints-control) section for other options.
