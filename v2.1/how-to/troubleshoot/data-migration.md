...
2. 使用 Ansible [停止整个 DM 集群](/v2.1/how-to/deploy/data-migration-with-ansible.md#第-10-步关闭-dm-集群)。
...
5. 使用 Ansible [启动整个 DM 集群](/v2.1/how-to/deploy/data-migration-with-ansible.md#第-9-步部署-dm-集群)。
