...
> **注意：**
>
> 对于生产环境，须使用  部署 TiDB 集群。如果只是用于测试 TiDB 或体验 TiDB 的特性，建议[使用 Docker Compose 在单机上快速部署 TiDB 集群](/how-to/get-started/local-cluster/install-from-docker-compose.md)。
