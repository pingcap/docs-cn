...
See also [local deployment](/v2.1/how-to/get-started/local-cluster/install-from-binary.md) and [testing environment](/v2.1/how-to/deploy/from-tarball/testing-environment.md) deployment.
