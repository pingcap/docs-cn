...
Before you begin, see [Deploy TiDB Using Ansible (Recommended)](/v2.1/how-to/deploy/orchestrated/ansible.md) and [Deploy TiDB Using Docker](/v2.1/how-to/deploy/orchestrated/docker.md).
