...
一般来说，开启 `sync-log` 会让性能损耗 30% 左右。关闭 `sync-log` 时的性能表现，请参见 [TiDB Sysbench 性能测试报告](https://github.com/pingcap/docs-cn/blob/master/dev/benchmark/sysbench-v3.md)。
...
- 大家可以直接参考官方相关测试。官方 Sysbench 测试及 TiDB 与 MySQL 对比测试请参考 [https://github.com/pingcap/docs-cn/blob/master/dev/benchmark/sysbench-v3.md](https://github.com/pingcap/docs-cn/blob/master/dev/benchmark/sysbench-v3.md)。
