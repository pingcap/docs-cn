...
This document describes the options that are not involved in command line options. For command line options, see [Configuration Flags](/v2.1/reference/configuration/tidb-server/configuration.md).
