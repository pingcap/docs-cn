...
This statement shows various statistics about tables in TiDB. If the statistics appear out of date, it is recommended to run [`ANALYZE TABLE`](/v2.1/reference/sql/statements/analyze-table.md).
