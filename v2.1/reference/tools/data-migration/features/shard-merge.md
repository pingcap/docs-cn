...
- If you need to change the [table routing](/v2.1/reference/tools/data-migration/features/overview.md#table-routing) rule, you have to wait for the replication of all sharding DDL statements to complete.
