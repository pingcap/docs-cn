...
* 支持[不同库名或表名的数据校验](v2.1/reference/tools/sync-diff-inspector/route-diff.md)
* 支持[分库分表场景下的数据校验](v2.1/reference/tools/sync-diff-inspector/shard-diff.md)
* 支持 [TiDB 主从集群的数据校验](v2.1/reference/tools/sync-diff-inspector/tidb-diff.md)
