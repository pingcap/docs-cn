...
+ Server
    ...
    - [Add the `auto_analyze_ratio` system variables to contorl the ratio of Analyze](/v2.1/faq/tidb.md#whats-the-trigger-strategy-for-auto-analyze-in-tidb)

    - [Add the `tidb_retry_limit` system variable to control the automatic retry times of transactions](/v2.1/reference/configuration/tidb-server/tidb-specific-variables.md#tidb_retry_limit)

    - [Add the `tidb_disable_txn_auto_retry` system variable to control whether the transaction retries automatically](/v2.1/reference/configuration/tidb-server/tidb-specific-variables.md#tidb_disable_txn_auto_retry)
    ...
    - [Add the `tidb_slow_log_threshold` environment variable to set the threshold of slow log automatically](/v2.1/reference/configuration/tidb-server/tidb-specific-variables.md#tidb_slow_log_threshold)

    - [Add the `tidb_query_log_max_len` environment variable to set the length of the SQL statement to be truncated in the log dynamically](/v2.1/reference/configuration/tidb-server/tidb-specific-variables.md#tidb_query_log_max_len)
...
- Support new [TiDB Binlog](/v2.1/reference/tools/tidb-binlog/overview.md)
