...
- TiDB 支持 TiDB Binlog cluster，不兼容旧版本 TiDB Binlog [#8093](https://github.com/pingcap/tidb/pull/8093)，[使用文档](https://pingcap.com/docs-cn/v2.1/reference/tools/tidb-binlog/overview/)
