...
从 v8.0.0 开始，[`BLOB`](/data-type-string.md#blob-类型)、[`TEXT`](/data-type-string.md#text-类型) 以及 [`JSON`](/data-type-json.md#json-类型) 这 3 个数据类型也可以设置默认值，但是默认值仅支持通过表达式来设置。[表达式默认值](#表达式默认值)。
