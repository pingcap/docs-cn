...
```shell
tiup cluster deploy tidb-test v4.0.15 ./topology.yaml --user root [-p] [-i /home/root/.ssh/gcp_rsa]
```

以上部署命令中：

- 通过 TiUP cluster 部署的集群名称为 `tidb-test`
- 部署版本为 `v4.0.15`，最新版本可以通过执行 `tiup list tidb` 来查看 TiUP 支持的版本
...
----              ----  -------        ----                                                        ----------
tidb-test         tidb  v4.0.15      /home/tidb/.tiup/storage/cluster/clusters/tidb-test         /home/tidb/.tiup/storage/cluster/clusters/tidb-test/ssh/id_rsa
```
